...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:B9,depthTest:!1,depthWrite:!1})}function wK(){return new Y9({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:QQ(),fragmentShader:`
		...
		`,blending:B9,depthTest:!1,depthWrite:!1})}function TK(){return new Y9({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:QQ(),fragmentShader:`
	...
	`}class LZ extends K9{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},Z=[$,$,$,$,$,$];this.texture=new m6(Z),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},Z=new jJ(5,5,5),W=new Y9({name:"CubemapFromEquirect",uniforms:M8($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,side:dJ,blending:B9});W.uniforms.tEquirect.value=Q;let K=new i0(Z,W),Y=Q.minFilter;if(Q.minFilter===N8)Q.minFilter=cJ;return new YZ(1,10,this).update(J,K),Q.minFilter=Y,K.geometry.dispose(),K.material.dispose(),this}clear(J,Q=!0,$=!0,Z=!0){let W=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear(Q,$,Z);J.setRenderTarget(W)}}function LG(J){let Q=new WeakMap,$=new WeakMap,Z=null;function W(q,D=!1){if(q===null||q===void 0)return null;if(D)return Y(q);return K(q)}function K(q){if(q&&q.isTexture){let D=q.mapping;if(D===I6||D===A6)if(Q.has(q)){let R=Q.get(q).texture;return X(R,q.mapping)}else{let R=q.image;if(R&&R.height>0){let B=new LZ(R.height);return B.fromEquirectangularTexture(J,q),Q.set(q,B),q.addEventListener("dispose",U),X(B.texture,q.mapping)}else return null}}return q}function Y(q){if(q&&q.isTexture){let D=q.mapping,R=D===I6||D===A6,B=D===t8||D===G8;if(R||B){let E=$.get(q),F=E!==void 0?E.texture.pmremVersion:0;if(q.isRenderTargetTexture&&q.pmremVersion!==F){if(Z===null)Z=new MZ(J);return E=R?Z.fromEquirectangular(q,E):Z.fromCubemap(q,E),E.texture.pmremVersion=q.pmremVersion,$.set(q,E),E.texture}else if(E!==void 0)return E.texture;else{let O=q.image;if(R&&O&&O.height>0||B&&O&&H(O)){if(Z===null)Z=new MZ(J);return E=R?Z.fromEquirectangular(q):Z.fromCubemap(q),E.texture.pmremVersion=q.pmremVersion,$.set(q,E),q.addEventListener("dispose",N),E.texture}else return null}}}return q}function X(q,D){if(D===I6)q.mapping=t8;else if(D===A6)q.mapping=G8;return q}function H(q){let D=0,R=6;for(let B=0;B<R;B++)if(q[B]!==void 0)D++;return D===R}function U(q){let D=q.target;D.removeEventListener("dispose",U);let R=Q.get(D);if(R!==void 0)Q.delete(D),R.dispose()}function N(q){let D=q.target;D.removeEventListener("dispose",N);let R=$.get(D);if(R!==void 0)$.delete(D),R.dispose()}function G(){if(Q=new WeakMap,$=new WeakMap,Z!==null)Z.dispose(),Z=null}return{get:W,dispose:G}}function BG(J){let Q={};function $(Z){if(Q[Z]!==void 0)return Q[Z];let W=J.getExtension(Z);return Q[Z]=W,W}return{has:function(Z){return $(Z)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(Z){let W=$(Z);if(W===null)z6("WebGLRenderer: "+Z+" extension not supported.");return W}}}function zG(J,Q,$,Z){let W={},K=new WeakMap;function Y(G){let q=G.target;if(q.index!==null)Q.remove(q.index);for(let R in q.attributes)Q.remove(q.attributes[R]);q.removeEventListener("dispose",Y),delete W[q.id];let D=K.get(q);if(D)Q.remove(D),K.delete(q);if(Z.releaseStatesOfGeometry(q),q.isInstancedBufferGeometry===!0)delete q._maxInstanceCount;$.memory.geometries--}function X(G,q){if(W[q.id]===!0)return q;return q.addEventListener("dispose",Y),W[q.id]=!0,$.memory.geometries++,q}function H(G){let q=G.attributes;for(let D in q)Q.update(q[D],J.ARRAY_BUFFER)}function U(G){let q=[],D=G.index,R=G.attributes.position,B=0;if(R===void 0)return;if(D!==null){let O=D.array;B=D.version;for(let V=0,z=O.length;V<z;V+=3){let A=O[V+0],P=O[V+1],w=O[V+2];q.push(A,P,P,w,w,A)}}else{let O=R.array;B=R.version;for(let V=0,z=O.length/3-1;V<z;V+=3){let A=V+0,P=V+1,w=V+2;q.push(A,P,P,w,w,A)}}let E=new(R.count>=65535?p6:g6)(q,1);E.version=B;let F=K.get(G);if(F)Q.remove(F);K.set(G,E)}function N(G){let q=K.get(G);if(q){let D=G.index;if(D!==null){if(q.version<D.version)U(G)}}else U(G);return K.get(G)}return{get:X,update:H,getWireframeAttribute:N}}function kG(J,Q,$){let Z;function W(G){Z=G}let K,Y;function X(G){K=G.type,Y=G.bytesPerElement}function H(G,q){J.drawElements(Z,q,K,G*Y),$.update(q,Z,1)}function U(G,q,D){if(D===0)return;J.drawElementsInstanced(Z,q,K,G*Y,D),$.update(q,Z,D)}function N(G,q,D){if(D===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(Z,q,0,K,G,0,D);let B=0;for(let E=0;E<D;E++)B+=q[E];$.update(B,Z,1)}this.setMode=W,this.setIndex=X,this.render=H,this.renderInstances=U,this.renderMultiDraw=N}function IG(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function Z(K,Y,X){switch($.calls++,Y){case J.TRIANGLES:$.triangles+=X*(K/3);break;case J.LINES:$.lines+=X*(K/2);break;case J.LINE_STRIP:$.lines+=X*(K-1);break;case J.LINE_LOOP:$.lines+=X*K;break;case J.POINTS:$.points+=X*K;break;default:w0("WebGLInfo: Unknown draw mode:",Y);break}}function W(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:W,update:Z}}function AG(J,Q,$){let Z=new WeakMap,W=new EJ;function K(Y,X,H){let U=Y.morphTargetInfluences,N=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,G=N!==void 0?N.length:0,q=Z.get(X);if(q===void 0||q.count!==G){let k=function(){w.dispose(),Z.delete(X),X.removeEventListener("dispose",k)};if(q!==void 0)q.texture.dispose();let D=X.morphAttributes.position!==void 0,R=X.morphAttributes.normal!==void 0,B=X.morphAttributes.color!==void 0,E=X.morphAttributes.position||[],F=X.morphAttributes.normal||[],O=X.morphAttributes.color||[],V=0;if(D===!0)V=1;if(R===!0)V=2;if(B===!0)V=3;let z=X.attributes.position.count*V,A=1;if(z>Q.maxTextureSize)A=Math.ceil(z/Q.maxTextureSize),z=Q.maxTextureSize;let P=new Float32Array(z*A*4*G),w=new h6(P,z,A,G);w.type=g9,w.needsUpdate=!0;let _=V*4;for(let l=0;l<G;l++){let C=E[l],m=F[l],c=O[l],f=z*A*4*l;for(let d=0;d<C.count;d++){let b=d*_;if(D===!0)W.fromBufferAttribute(C,d),P[f+b+0]=W.x,P[f+b+1]=W.y,P[f+b+2]=W.z,P[f+b+3]=0;if(R===!0)W.fromBufferAttribute(m,d),P[f+b+4]=W.x,P[f+b+5]=W.y,P[f+b+6]=W.z,P[f+b+7]=0;if(B===!0)W.fromBufferAttribute(c,d),P[f+b+8]=W.x,P[f+b+9]=W.y,P[f+b+10]=W.z,P[f+b+11]=c.itemSize===4?W.w:1}}q={count:G,texture:w,size:new B0(z,A)},Z.set(X,q),X.addEventListener("dispose",k)}if(Y.isInstancedMesh===!0&&Y.morphTexture!==null)H.getUniforms().setValue(J,"morphTexture",Y.morphTexture,$);else{let D=0;for(let B=0;B<U.length;B++)D+=U[B];let R=X.morphTargetsRelative?1:1-D;H.getUniforms().setValue(J,"morphTargetBaseInfluence",R),H.getUniforms().setValue(J,"morphTargetInfluences",U)}H.getUniforms().setValue(J,"morphTargetsTexture",q.texture,$),H.getUniforms().setValue(J,"morphTargetsTextureSize",q.size)}return{update:K}}function PG(J,Q,$,Z,W){let K=new WeakMap;function Y(U){let N=W.render.frame,G=U.geometry,q=Q.get(U,G);if(K.get(q)!==N)Q.update(q),K.set(q,N);if(U.isInstancedMesh){if(U.hasEventListener("dispose",H)===!1)U.addEventListener("dispose",H);if(K.get(U)!==N){if($.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)$.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,N)}}if(U.isSkinnedMesh){let D=U.skeleton;if(K.get(D)!==N)D.update(),K.set(D,N)}return q}function X(){K=new WeakMap}function H(U){let N=U.target;if(N.removeEventListener("dispose",H),Z.releaseStatesOfObject(N),$.remove(N.instanceMatrix),N.instanceColor!==null)$.remove(N.instanceColor)}return{update:Y,dispose:X}}var CG={[uQ]:"LINEAR_TONE_MAPPING",[cQ]:"REINHARD_TONE_MAPPING",[nQ]:"CINEON_TONE_MAPPING",[sQ]:"ACES_FILMIC_TONE_MAPPING",[oQ]:"AGX_TONE_MAPPING",[aQ]:"NEUTRAL_TONE_MAPPING",[iQ]:"CUSTOM_TONE_MAPPING"};function wG(J,Q,$,Z,W){let K=new K9(Q,$,{type:J,depthBuffer:Z,stencilBuffer:W,depthTexture:Z?new Q8(Q,$):void 0}),Y=new K9(Q,$,{type:p9,depthBuffer:!1,stencilBuffer:!1}),X=new nJ;X.setAttribute("position",new zJ([-1,3,0,-1,-1,0,3,-1,0],3)),X.setAttribute("uv",new zJ([0,2,0,0,2,0],2));let H=new s$({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}var B5={[uQ]:"Linear",[cQ]:"Reinhard",[nQ]:"Cineon",[sQ]:"ACESFilmic",[oQ]:"AgX",[aQ]:"Neutral",[iQ]:"Custom"};function z5(J,Q){let $=B5[Q];if($===void 0)return A0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var JQ=new j;function k5(){c0.getLuminanceCoefficients(JQ);let J=JQ.x.toFixed(4),Q=JQ.y.toFixed(4),$=JQ.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
`)}function I5(J){return[J.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",J.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(l7).join(`
`)}function A5(J){let Q=[];for(let $ in J){let Z=J[$];if(Z===!1)continue;Q.push("#define "+$+" "+Z)}return Q.join(`
`)}function P5(J,Q){let $={},Z=J.getProgramParameter(Q,J.ACTIVE_ATTRIBUTES);for(let W=0;W<Z;W++){let K=J.getActiveAttrib(Q,W),Y=K.name,X=1;if(K.type===J.FLOAT_MAT2)X=2;if(K.type===J.FLOAT_MAT3)X=3;if(K.type===J.FLOAT_MAT4)X=4;$[Y]={type:K.type,location:J.getAttribLocation(Q,Y),locationSize:X}}return $}function l7(J){return J!==""}function pK(J,Q){let $=Q.numSpotLightShadows+Q.numSpotLightMaps-Q.numSpotLightShadowsWithMaps;return J.replace(/NUM_DIR_LIGHTS/g,Q.numDirLights).replace(/NUM_SPOT_LIGHTS/g,Q.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,Q.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,$).replace(/NUM_RECT_AREA_LIGHTS/g,Q.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,Q.numPointLights).replace(/NUM_HEMI_LIGHTS/g,Q.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,Q.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,Q.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,Q.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,Q.numPointLightShadows)}function mK(J,Q){return J.replace(/NUM_CLIPPING_PLANES/g,Q.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,Q.numClippingPlanes-Q.numClipIntersection)}var C5=/^[ \t]*#include +<([\w\d./]+)>/gm;function VZ(J){return J.replace(C5,T5)}var w5=new Map;function T5(J,Q){let $=b0[Q];if($===void 0){let Z=w5.get(Q);if(Z!==void 0)$=b0[Z],A0('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',Q,Z);else throw Error("Can not resolve #include <"+Q+">")}return VZ($)}var S5=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function lK(J){return J.replace(S5,j5)}function j5(J,Q,$,Z){let W="";for(let K=parseInt(Q);K<parseInt($);K++)W+=Z.replace(/\[\s*i\s*\]/g,"[ "+K+" ]").replace(/UNROLLED_LOOP_INDEX/g,K);return W}function dK(J){let Q=`precision ${J.precision} float;
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      <div class="prow"><span class="plabel">Recruit:</span>
        ${Y.map((U)=>H(W.kind==="recruit"&&W.arch===U,`rec:${U}`,`${U9[U]} <i>${J.costs[U]+Q.COPY_SURCHARGE*J.copies[U]}\uD83D\uDEE1</i>`)).join("")}</div>
      ${X.length?`<div class="prow"><span class="plabel">Unlock:</span>
        ${X.map((U)=>H(this.mPlan.unlocks.includes(U),`unl:${U}`,`${U9[U]} <i>${CZ(J.unlocked[$].size+this.mPlan.unlocks.indexOf(U)+(this.mPlan.unlocks.includes(U)?0:this.mPlan.unlocks.length-this.mPlan.unlocks.indexOf(U)),Q)??CZ(J.unlocked[$].size,Q)}\uD83D\uDEE1</i>`)).join("")}</div>`:""}
      ...
      <div class="prow"><button class="pbtn undo" data-act="undo">Undo last</button>
        <button class="pbtn confirm" data-act="muster-done">End Muster ▶</button></div>`}stagedSummary(){let J=[];for(let[Q]of this.mPlan.recruits)J.push(U9[Q]);for(let Q of this.mPlan.unlocks)J.push(`unlock ${U9[Q]}`);for(let Q of this.mBuild)J.push(Q[0]==="field"?`${Q[2]} field`:"palisade");for(let Q of this.mPlan.repositions)J.push("reposition");if(this.mPlan.tribute_spend)J.push(`+${this.mPlan.tribute_spend} supply`);return J.length?J.join(", "):"<i>nothing yet — pick an action, then click the board</i>"}clashPanel(){let J=this.g,Q=this.clashPlayer,$=J.onBoard(Q),Z=[...this.cOrders.keys()],W="<i>Click one of your units to give it an order.</i>";if(this.cSel!==null){let K=J.units.get(this.cSel),Y=X7(J,K),X=[];if(Y.moves.size)X.push("\uD83D\uDFE2 move (green)");if(Y.meleeTargets.length)X.push("\uD83D\uDD34 attack (red)");if(Y.shootTargets.length)X.push("\uD83D\uDFE0 shoot (orange)");if(Y.chargeTargets.length)X.push("\uD83D\uDFE3 charge (purple)");W=`<b>${U9[K.arch]}</b> selected — ${X.join(" · ")||"no targets in range"} ·
      ...
      <div class="prow staged">Orders: <b>${Z.length}/${$.length}</b> units ·
        ${Z.map((K)=>`${U9[J.units.get(K).arch]}:${this.cOrders.get(K)[0]}`).join(", ")||"<i>none</i>"}</div>
      ...
      </div>`,this.box.querySelector("#coach-next")?.addEventListener("click",()=>this.i===z8.length-1?this.finish():this.advance()),this.box.querySelector("#coach-guide")?.addEventListener("click",H7),this.box.querySelector("#coach-skip")?.addEventListener("click",()=>this.finish()),this.spotlight()}finish(){this.c.onChange=null,this.clearSpot(),this.box.remove()}}var jN=["HONEST","AGGRO","TURTLE","PROBER","SANDBAGGER","RUNNER"],yN={HONEST:"Balanced value play",AGGRO:"Relentless stake-pusher",TURTLE:"Economy & walls",PROBER:"Punishes overextension",SANDBAGGER:"Banks tribute, then strikes",RUNNER:"Cavalry cheese"},Q9=document.getElementById("app"),UJ={mode:"bot",humanSeat:0,botName:"HONEST",p0tribe:"roman",p1tribe:"viking",seed:12345};function NY(J){return a7.map((Q)=>`<option value="${Q}"${Q===J?" selected":""}>${cZ(Q)}</option>`).join("")}function XQ(){Q9.innerHTML=`
    <div class="setup">
      <h1>LIMES</h1>
    ...
    </div>`,Q9.querySelectorAll("[data-mode]").forEach((J)=>J.onclick=()=>{UJ.mode=J.dataset.mode,XQ()}),Q9.querySelectorAll("[data-seat]").forEach((J)=>J.onclick=()=>{UJ.humanSeat=Number(J.dataset.seat),XQ()}),Q9.querySelector("#bot").onchange=(J)=>UJ.botName=J.target.value,Q9.querySelector("#p0t").onchange=(J)=>UJ.p0tribe=J.target.value,Q9.querySelector("#p1t").onchange=(J)=>UJ.p1tribe=J.target.value,Q9.querySelector("#seed").onchange=(J)=>UJ.seed=Number(J.target.value)|0,Q9.querySelector("#rnd").onclick=()=>{UJ.seed=Math.floor(Math.random()*1e6),XQ()},Q9.querySelector("#start").onclick=()=>{if(UJ.p0tribe===UJ.p1tribe)UJ.p1tribe=a7.find((J)=>J!==UJ.p0tribe);new YQ(Q9).start({...UJ})},Q9.querySelector("#guide").onclick=H7,Q9.querySelector("#tut").onclick=()=>{new wZ(new YQ(Q9)).start({mode:"bot",humanSeat:0,botName:"TURTLE",p0tribe:UJ.p0tribe,p1tribe:UJ.p1tribe===UJ.p0tribe?a7.find((J)=>J!==UJ.p0tribe):UJ.p1tribe,seed:4242})}}XQ();})();
