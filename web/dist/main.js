(()=>{function mZ(J){let Q=new TextEncoder().encode(J),$=Q.length*8,Z=Q.length+1,W=Z+(56-Z%64+64)%64+8,K=new Uint8Array(W);K.set(Q),K[Q.length]=128;let Y=new DataView(K.buffer);Y.setUint32(W-4,$>>>0,!1),Y.setUint32(W-8,Math.floor($/4294967296)>>>0,!1);let X=1732584193,H=4023233417,U=2562383102,N=271733878,G=3285377520,q=new Uint32Array(80),F=(B,E)=>B<<E|B>>>32-E;for(let B=0;B<W;B+=64){for(let A=0;A<16;A++)q[A]=Y.getUint32(B+A*4,!1);for(let A=16;A<80;A++)q[A]=F(q[A-3]^q[A-8]^q[A-14]^q[A-16],1);let E=X,D=H,O=U,V=N,z=G;for(let A=0;A<80;A++){let P,w;if(A<20)P=D&O|~D&V,w=1518500249;else if(A<40)P=D^O^V,w=1859775393;else if(A<60)P=D&O|D&V|O&V,w=2400959708;else P=D^O^V,w=3395469782;let _=F(E,5)+P+z+w+q[A]|0;z=V,V=O,O=F(D,30),D=E,E=_}X=X+E|0,H=H+D|0,U=U+O|0,N=N+V|0,G=G+z|0}let R=(B)=>(B>>>0).toString(16).padStart(8,"0");return R(X)+R(H)+R(U)+R(N)+R(G)}class UQ{mt=new Uint32Array(624);mti=625;constructor(J){let Q=[],$=J>>>0,Z=Math.floor(J/4294967296);Q.push($);while(Z>0)Q.push(Z>>>0),Z=Math.floor(Z/4294967296);this.initByArray(Q.length?Q:[0])}initGenrand(J){this.mt[0]=J>>>0;for(let Q=1;Q<624;Q++){let $=this.mt[Q-1]^this.mt[Q-1]>>>30;this.mt[Q]=Math.imul(1812433253,$)+Q>>>0}this.mti=624}initByArray(J){this.initGenrand(19650218);let Q=1,$=0,Z=Math.max(624,J.length);for(;Z;Z--){let W=this.mt[Q-1]^this.mt[Q-1]>>>30;if(this.mt[Q]=(this.mt[Q]^Math.imul(W,1664525))+J[$]+$>>>0,Q++,$++,Q>=624)this.mt[0]=this.mt[623],Q=1;if($>=J.length)$=0}for(Z=623;Z;Z--){let W=this.mt[Q-1]^this.mt[Q-1]>>>30;if(this.mt[Q]=(this.mt[Q]^Math.imul(W,1566083941))-Q>>>0,Q++,Q>=624)this.mt[0]=this.mt[623],Q=1}this.mt[0]=2147483648}genrandUint32(){let J;if(this.mti>=624){let Q=0;for(;Q<227;Q++)J=this.mt[Q]&2147483648|this.mt[Q+1]&2147483647,this.mt[Q]=this.mt[Q+397]^J>>>1^(J&1?2567483615:0);for(;Q<623;Q++)J=this.mt[Q]&2147483648|this.mt[Q+1]&2147483647,this.mt[Q]=this.mt[Q+-227]^J>>>1^(J&1?2567483615:0);J=this.mt[623]&2147483648|this.mt[0]&2147483647,this.mt[623]=this.mt[396]^J>>>1^(J&1?2567483615:0),this.mti=0}return J=this.mt[this.mti++],J^=J>>>11,J^=J<<7&2636928640,J^=J<<15&4022730752,J^=J>>>18,J>>>0}getrandbits(J){return this.genrandUint32()>>>32-J}randbelow(J){if(!J)return 0;let Q=32-Math.clz32(J),$=this.getrandbits(Q);while($>=J)$=this.getrandbits(Q);return $}shuffle(J){for(let Q=J.length-1;Q>=1;Q--){let $=this.randbelow(Q+1),Z=J[Q];J[Q]=J[$],J[$]=Z}}}var BY={BOARD_COLS:8,BOARD_ROWS:8,HEARTLAND_ROWS:2,STAKE_START:4,STAKE_MIN:2,STAKE_MAX:6,STAKE_STEP_MAX:1,LONE_RUNNER_RADIUS:2,WAGON_COUNT:3,WAGON_HP:3,WAGON_BOUNTY:3,BREACH_DMG:1,BREACH_CAP:2,BREACH_CAP_LATE:3,BREACH_CAP_RISE_ROUND:13,ROUT_WAGON_DMG:2,START_SUPPLY:8,START_CROP:6,FIELD_COST:2,FIELD_YIELD:2,FARMSTEAD_SIZE:3,FARMSTEAD_BONUS:2,ANNEX_YIELD:1,RAID_GAIN:3,PALISADE_COST:3,BUILD_ACTIONS:2,UPKEEP_CROP:1,SUPPLY_STRAIN_CROP:1,EXHAUSTION_START_ROUND:12,EXHAUSTION_INITIAL:1,EXHAUSTION_ACCEL_ROUND:13,EXHAUSTION_ACCEL:2,MUSTER_COPIES:6,COPY_SURCHARGE:1,UNLOCK_3RD:6,UNLOCK_4TH:10,UNLOCK_5TH:15,COST_SPEARMAN:2,COST_SWORDSMAN:3,COST_ARCHER:3,COST_CAVALRY:4,COST_SIEGE:5,DEPLOY_MAX:2,REPOSITION_MAX:2,RUSH_RETURN_COST:1,WOUND_RETURN_DELAY:2,TRIBUTE_PER_ROW:1,TRIBUTE_SUPPLY_VALUE:1,SURGE_COST:1,SHIELDBEARER_COST:2,INTERVENTIONS_PER_WINDOW:1,PULSES_PER_CLASH:2,ATK_BONUS_CAP:2,GUARD_CAP:2,MOD_FLANK:1,MOD_SUPPORT:1,MOD_BRACE_GUARD:1,MOD_CHARGE:1,MOD_COUNTER:1,MOD_HILL:1,MOD_RIVER:1,MOD_ROAD:1,FLANK_THRESHOLD:2,FLANK_MIN_DMG:1,EXHAUST_ATK_PENALTY:1,EXHAUST_GUARD_PENALTY:1,DISPLACE_DMG:1,RIVER_PUSH_DMG:2,TRAP_PUSH_DMG:2,CHARGE_MOVE_MIN:2,PUSH_BACK:1,RANGED_RETALIATION:1,SPEAR_ATK:1,SPEAR_HP:4,SPEAR_MV:1,SPEAR_RNG:1,SWORD_ATK:2,SWORD_HP:5,SWORD_MV:1,SWORD_RNG:1,CAV_ATK:2,CAV_HP:4,CAV_MV:3,CAV_RNG:1,ARCHER_ATK:2,ARCHER_HP:3,ARCHER_MV:1,ARCHER_RNG_MAX:2,SIEGE_ATK:3,SIEGE_HP:3,SIEGE_MV:1,SIEGE_RNG_MIN:2,SIEGE_RNG_MAX:3,HERO_ATK:3,HERO_HP:7,HERO_MV:2,HERO_RNG:1,XP_PER_WOUND:1,XP_TIER1:2,XP_TIER2:4,PROMO_T1_HP:1,PROMO_T2_STAT:1,CARAVAN_ROUND_1:4,CARAVAN_ROUND_2:8,CARAVAN_ARTIFACTS:4,CARAVAN_DISCARD:1,ARTIFACT_POOL:8,ARTIFACT_SUPPLY:4,ARTIFACT_CROP:4,ARTIFACT_XP:2,ARTIFACT_TRIBUTE:2,ARTIFACT_DISCOUNT:2,GOLDEN_GOAL_ROUND:16,HARD_STOP_ROUND:20,LASTSTAND_BOONS:3,ENTRENCH_PALISADES:2,ENTRENCH_HOLD:0,FIRST_BLOOD_SUPPLY:0,TIMER_MUSTER:60,TIMER_COMMIT:15,TIMER_MUSTER_CASUAL:90,TIMER_COMMIT_CASUAL:30,TACTICA_POOL:9,TACTICA_RACK:5,TACTICA_HELD:2,TACTICA_HELD_CONTINGENCY:3,DOCTRINE_DISPLAY:8,DOCTRINE_BASE_PRICE:4,DOCTRINE_AGING:1,DOCTRINE_MIN_PRICE:1,T2_POOL:5,T2_UNLOCKABLE:3,GAUL_TRAPS:2,HUN_REPOSITIONS:2,ZOC_ENABLED:1,SIEGE_PUSH_UNITS:1,CHARGE_ADJ_OK:1,EXHAUSTED_CARRY:0,R1_REQUIRE_ENGAGE:0},GQ={SWORD_HP:6,SIEGE_PUSH_UNITS:0,CHARGE_ADJ_OK:0,EXHAUSTED_CARRY:1,R1_REQUIRE_ENGAGE:1,EXHAUSTION_ACCEL:0,WAGON_HP:2,WAGON_BOUNTY:5,GOLDEN_GOAL_ROUND:14,HARD_STOP_ROUND:18,BREACH_CAP_RISE_ROUND:11,LONE_RUNNER_RADIUS:3};function zY(J){return{...BY,...J??{}}}var lZ=["spear","sword","cav","archer","siege"],NQ={spear:"cav",cav:"archer",archer:"spear"};function kY(J){return{spear:J.COST_SPEARMAN,sword:J.COST_SWORDSMAN,archer:J.COST_ARCHER,cav:J.COST_CAVALRY,siege:J.COST_SIEGE,hero:9}}function IY(J){return{spear:[J.SPEAR_ATK,J.SPEAR_HP,J.SPEAR_MV,1,1],sword:[J.SWORD_ATK,J.SWORD_HP,J.SWORD_MV,1,1],cav:[J.CAV_ATK,J.CAV_HP,J.CAV_MV,1,1],archer:[J.ARCHER_ATK,J.ARCHER_HP,J.ARCHER_MV,2,J.ARCHER_RNG_MAX],siege:[J.SIEGE_ATK,J.SIEGE_HP,J.SIEGE_MV,J.SIEGE_RNG_MIN,J.SIEGE_RNG_MAX],hero:[J.HERO_ATK,J.HERO_HP,J.HERO_MV,1,1]}}var T0=(J)=>`${J[0]},${J[1]}`,dZ=(J,Q)=>T0(J)<=T0(Q)?`${T0(J)}|${T0(Q)}`:`${T0(Q)}|${T0(J)}`;function T9(J,Q){for(let $=0;$<Math.max(J.length,Q.length);$++){let Z=J[$],W=Q[$];if(Array.isArray(Z)&&Array.isArray(W)){let K=T9(Z,W);if(K)return K}else if(Z!==W)return Z<W?-1:1}return 0}class vJ extends Error{winner;wtype;constructor(J,Q){super("GameOver");this.winner=J;this.wtype=Q}}class X7 extends Error{constructor(){super("ClashEnd")}}class cZ{uid;owner;arch;base_atk;base_guard=0;hp;max_hp;mv;rmin;rmax;pos=null;exhausted=!1;braced=!1;xp=0;tier1=!1;tier2=!1;wounded_round=null;face_down=!1;constructor(J,Q,$,Z){this.uid=J,this.owner=Q,this.arch=$,this.base_atk=Z[0],this.hp=Z[1],this.max_hp=Z[1],this.mv=Z[2],this.rmin=Z[3],this.rmax=Z[4]}}class G9{C;seed;bots;stats;costs;units=new Map;next_uid=0;board=new Map;stakes;fields=new Map;palisades=new Map;entrench=new Map;res;wagons=[[],[]];wagon_at=new Map;komi=1;round=1;copies={spear:0,sword:0,cav:0,archer:0,siege:0};unlocked=[new Set(["sword","spear"]),new Set(["sword","spear"])];extra_deploy=[0,0];recruit_discount=[0,0];standard_bearer=[null,null];wards=[];last_stand_used=[!1,!1];last_wagon_kill_src=null;cap_dmg=[0,0];wagon_dmg_round=[0,0];rows_lost_round=[0,0];rows_taken_round=[0,0];unit_dmg_round=[0,0];terrain_on=!1;ttype=new Map;rivers=new Set;artifact_order=[];lead_trace=[];r1_winner=null;r1_rows_winner=null;constructor(J,Q,$){this.C=zY($),this.seed=Q,this.bots=J,this.stats=IY(this.C),this.costs=kY(this.C),this.stakes=Array(8).fill(this.C.STAKE_START),this.res=[{supply:this.C.START_SUPPLY,crop:this.C.START_CROP,tribute:0},{supply:this.C.START_SUPPLY,crop:this.C.START_CROP,tribute:0}],this.artifact_order=[...Array(this.C.ARTIFACT_POOL).keys()].map((Z)=>Z+1),new UQ(Q).shuffle(this.artifact_order)}heartlandRows(J){return J===0?[0,1]:[6,7]}backRow(J){return J===0?0:7}occupied(J){return this.board.has(T0(J))||this.wagon_at.has(T0(J))}inBounds(J){return J[0]>=0&&J[0]<8&&J[1]>=0&&J[1]<8}newUnit(J,Q){let $=new cZ(this.next_uid,J,Q,this.stats[Q]);return this.next_uid++,this.units.set($.uid,$),$}place(J,Q){this.board.set(T0(Q),J.uid),J.pos=Q}freeHeartlandTile(J){for(let Q=0;Q<8;Q++)for(let $ of this.heartlandRows(J))if(!this.occupied([Q,$]))return[Q,$];return null}setup(){let J=this.C;for(let Q=0;Q<2;Q++){let $=this.bots[Q].setup(this,Q),Z=this.heartlandRows(Q),W=this.backRow(Q),K=[];for(let H of $.wagons)if(H>=0&&H<8&&!K.includes(H))K.push(H);for(let H=0;H<8&&K.length<J.WAGON_COUNT;H++)if(!K.includes(H))K.push(H);K.length=Math.min(K.length,J.WAGON_COUNT),K.forEach((H,U)=>{this.wagons[Q].push({col:H,row:W,hp:J.WAGON_HP}),this.wagon_at.set(T0([H,W]),[Q,U])});let Y=["hero","spear","sword","sword"],X=$.units.slice();for(let H of Y){let U=null;for(let N=0;N<X.length;N++){let G=X[N];if(G.arch===H&&Z.includes(G.pos[1])&&this.inBounds(G.pos)&&!this.occupied(G.pos)){U=G.pos,X.splice(N,1);break}}if(U===null)U=this.freeHeartlandTile(Q);this.place(this.newUnit(Q,H),U)}}}moveUnit(J,Q){this.board.delete(T0(J.pos)),this.board.set(T0(Q),J.uid),J.pos=Q}unbroken(J){return J.pos!==null&&!J.exhausted}loneRunner(J){let Q=this.C.LONE_RUNNER_RADIUS;for(let $ of this.units.values())if($.uid!==J.uid&&$.owner===J.owner&&$.pos!==null&&s0($.pos,J.pos)<=Q)return!1;return!0}carryEligible(J){if(J.pos===null||this.loneRunner(J))return!1;return!J.exhausted||!!this.C.EXHAUSTED_CARRY}exhaustionPenalty(J){let Q=this.C,$=J??this.round;if($<Q.EXHAUSTION_START_ROUND)return 0;let Z=Q.EXHAUSTION_INITIAL;if($>=Q.EXHAUSTION_ACCEL_ROUND)Z+=Q.EXHAUSTION_ACCEL*($-Q.EXHAUSTION_ACCEL_ROUND+1);return Z}columnClaims(J){let Q=this.stakes[J],$=!1,Z=!1,W=!1,K=!1,Y=!1,X=!1;for(let H=0;H<8;H++){let U=this.board.get(T0([J,H]));if(U===void 0)continue;let N=this.units.get(U),G=this.unbroken(N),q=this.carryEligible(N);if(!G&&!q)continue;if(N.owner===0){if(H>=Q){if(G)W=!0;if(q)$=!0}else if(G)Y=!0}else if(H<Q){if(G)X=!0;if(q)Z=!0}else if(G)K=!0}return[$&&!K,Z&&!Y]}computeHarvest(J,Q){let $=this.C,Z=this.exhaustionPenalty(Q),W=0,K=0,Y=[];for(let[U,N]of this.fields.entries()){let G=U.split(",").map(Number);if((N.annexed!==null?N.annexed:N.owner)!==J||this.territoryOf(G)!==J)continue;let F=N.annexed===J?$.ANNEX_YIELD:$.FIELD_YIELD;if(N.type==="crop")K+=Math.max(0,F-Z);else W+=F;if(N.annexed===null&&N.owner===J)Y.push([G,N.type])}let X=new Set,H=new Map(Y.map(([U,N])=>[T0(U),N]));for(let[U,N]of Y){if(X.has(T0(U)))continue;let G=0,q=[U];X.add(T0(U));while(q.length){let F=q.pop();G++;for(let R of qJ(F))if(!X.has(T0(R))&&H.get(T0(R))===N)X.add(T0(R)),q.push(R)}if(G>=$.FARMSTEAD_SIZE)if(N==="crop")K+=Math.max(0,$.FARMSTEAD_BONUS-Z);else W+=$.FARMSTEAD_BONUS}return[W,K]}musterPlayer(J){let Q=this.C,$=this.bots[J],Z=this.res[J],[W,K]=this.computeHarvest(J);Z.supply+=W,Z.crop+=K;let Y=this.onBoard(J),X=[],H=new Set;for(let O of $.feedOrder(this,J)){let V=this.units.get(O);if(H.has(O)||!V||V.owner!==J||V.pos===null)continue;H.add(O),X.push(O)}for(let O of Y)if(!H.has(O.uid))X.push(O.uid);let U=Z.crop;for(let O of X){let V=this.units.get(O),z=Q.UPKEEP_CROP+(this.beyondOwn(V)?Q.SUPPLY_STRAIN_CROP:0);if(U>=z)U-=z,V.exhausted=!1;else V.exhausted=!0}Z.crop=U;for(let O of $.build(this,J).slice(0,Q.BUILD_ACTIONS)){if(!O)continue;if(O[0]==="field"){let V=O[1],z=O[2];if(S9(V)&&this.territoryOf(V)===J&&!this.fields.has(T0(V))&&!this.wagon_at.has(T0(V))&&Z.supply>=Q.FIELD_COST&&(z==="supply"||z==="crop"))Z.supply-=Q.FIELD_COST,this.fields.set(T0(V),{type:z,owner:J,annexed:null})}else if(O[0]==="palisade"){let V=O[1];if(V>=0&&V<8&&!this.palisades.has(V)&&Z.supply>=Q.PALISADE_COST)Z.supply-=Q.PALISADE_COST,this.palisades.set(V,J)}}let N=$.reinforce(this,J),G=Math.min(Math.trunc(N.tribute_spend??0),Z.tribute);if(G>0)Z.tribute-=G,Z.supply+=G*Q.TRIBUTE_SUPPLY_VALUE;for(let O of this.reserve(J))if(O.wounded_round!==null&&O.wounded_round<=this.round-Q.WOUND_RETURN_DELAY){let V=this.freeHeartlandTile(J);if(V===null)break;O.hp=O.max_hp,O.wounded_round=null,this.place(O,V)}for(let O of N.rush??[]){let V=this.units.get(O);if(V&&V.owner===J&&V.pos===null&&V.wounded_round===this.round-1&&Z.crop>=Q.RUSH_RETURN_COST){let z=this.freeHeartlandTile(J);if(z===null)break;Z.crop-=Q.RUSH_RETURN_COST,V.hp=V.max_hp,V.wounded_round=null,this.place(V,z)}}for(let O of N.unlocks??[]){if(!lZ.includes(O)||this.unlocked[J].has(O))continue;let V=this.unlocked[J].size,z={2:Q.UNLOCK_3RD,3:Q.UNLOCK_4TH,4:Q.UNLOCK_5TH}[V];if(z!==void 0&&Z.supply>=z)Z.supply-=z,this.unlocked[J].add(O)}let q=Q.DEPLOY_MAX+this.extra_deploy[J];this.extra_deploy[J]=0;let F=0,R=new Set,B=this.heartlandRows(J);for(let[O,V]of N.recruits??[]){if(F>=q||!lZ.includes(O))continue;if(!this.unlocked[J].has(O)||this.copies[O]>=Q.MUSTER_COPIES)continue;if(!S9(V)||!B.includes(V[1])||this.occupied(V))continue;let z=this.costs[O]+Q.COPY_SURCHARGE*this.copies[O];if(this.recruit_discount[J])z=Math.max(1,z-this.recruit_discount[J]);if(Z.supply<z)continue;if(Z.supply-=z,this.recruit_discount[J])this.recruit_discount[J]=0;this.copies[O]++;let A=this.newUnit(J,O);A.face_down=!0,this.place(A,V),R.add(A.uid),F++}let E=0;for(let[O,V]of N.repositions??[]){if(E>=Q.REPOSITION_MAX)break;let z=this.units.get(O);if(!z||z.owner!==J||z.pos===null||R.has(O)||!S9(V)||this.occupied(V)||this.territoryOf(V)!==J)continue;this.moveUnit(z,V),z.braced=!1,E++}let D;for(let O of this.units.values())if(O.owner===J&&O.arch==="hero"){D=O;break}if(!D||D.pos===null){let O=$.standardBearer(this,J),V=O!==null?this.units.get(O):void 0;if(!V||V.owner!==J||V.pos===null)V=this.onBoard(J).sort((A,P)=>this.costs[P.arch]-this.costs[A.arch]||A.pos[0]-P.pos[0]||A.pos[1]-P.pos[1])[0];this.standard_bearer[J]=V?V.uid:null}else this.standard_bearer[J]=null}counter(J,Q){return NQ[J]===Q?this.C.MOD_COUNTER:0}flanked(J){let Q=0;for(let $ of qJ(J.pos)){let Z=this.board.get(T0($));if(Z!==void 0&&this.units.get(Z).owner!==J.owner)Q++}return Q>=this.C.FLANK_THRESHOLD}hasAdjacentFriend(J){for(let Q of qJ(J.pos)){let $=this.board.get(T0(Q));if($!==void 0&&this.units.get($).owner===J.owner)return!0}return!1}effGuard(J,Q=!1){let $=this.C,Z=0;if(!this.beyondOwn(J)&&this.hasAdjacentFriend(J))Z+=$.MOD_SUPPORT;if(J.braced)Z+=$.MOD_BRACE_GUARD;if(this.terrain_on){let K=this.ttype.get(T0(J.pos));if(K==="hills")Z+=$.MOD_HILL;if(K==="woods"&&Q)Z+=1}let W=J.base_guard+Math.min($.GUARD_CAP,Z);if(J.exhausted)W-=$.EXHAUST_GUARD_PENALTY;return Math.max(0,W)}effAtk(J,Q,$=!1,Z=!1){let W=this.C,K=this.counter(J.arch,Q.arch);if($)K+=W.MOD_CHARGE;if(this.flanked(Q))K+=W.MOD_FLANK;let Y=J.base_atk+Math.min(W.ATK_BONUS_CAP,K);if(J.exhausted)Y-=W.EXHAUST_ATK_PENALTY;if(Z&&this.terrain_on&&this.rivers.has(dZ(J.pos,Q.pos)))Y-=W.MOD_RIVER;return Math.max(0,Y)}attackDamage(J,Q,$=!1,Z=!1){let W=this.effAtk(J,Q,$,Z)-this.effGuard(Q,!Z&&!$),K=this.flanked(Q)?this.C.FLANK_MIN_DMG:0;return Math.max(K,W)}applyDamage(J,Q){let $=(W)=>{let[K,Y]=W,X=this.units.get(Y),H=K!==null?this.units.get(K).pos??[-1,-1]:[-1,-1];return[X.pos??[-1,-1],H]},Z=J.map((W,K)=>({inst:W,i:K})).sort((W,K)=>T9($(W.inst),$(K.inst))||W.i-K.i);for(let{inst:W}of Z)this.damageUnit(this.units.get(W[1]),W[2],W[0],Q)}damageUnit(J,Q,$,Z){if(Q<=0||J.pos===null)return;let W=this.wards.find((Y)=>Y.uid===J.uid&&Y.active);if(W&&J.hp-Q<=0){W.active=!1;let Y=this.wardBearer(J);if(Y)J=Y}J.hp-=Q;let K=`${$===null?"n":$}_${J.uid}`;if(Z.set(K,(Z.get(K)??0)+Q),$!==null){let Y=this.units.get($);if(Y.owner!==J.owner)this.unit_dmg_round[Y.owner]+=Q}}wardBearer(J){let Q=[];for(let $ of qJ(J.pos)){let Z=this.board.get(T0($));if(Z===void 0)continue;let W=this.units.get(Z);if(W.owner===J.owner&&(W.arch==="spear"||W.arch==="sword"))Q.push(W)}if(!Q.length)return null;return Q.sort(($,Z)=>Z.hp-$.hp||T9($.pos,Z.pos)),Q[0]}removeDead(J){let Q=[];for(let $ of[...this.onBoard()])if($.hp<=0)this.board.delete(T0($.pos)),$.pos=null,$.braced=!1,$.exhausted=!1,$.wounded_round=this.round,Q.push($);for(let $ of Q)for(let[Z,W]of J.entries()){let[K,Y]=Z.split("_");if(Number(Y)===$.uid&&W>=1&&K!=="n"){let X=this.units.get(Number(K));if(X.owner!==$.owner)this.gainXp(X,this.C.XP_PER_WOUND)}}}gainXp(J,Q){let $=this.C;if(J.xp+=Q,!J.tier1&&J.xp>=$.XP_TIER1)this.grantTier(J);if(!J.tier2&&J.xp>=$.XP_TIER2)this.grantTier(J)}grantTier(J){let Q=this.C;if(!J.tier1)J.tier1=!0,J.max_hp+=Q.PROMO_T1_HP,J.hp=Math.min(J.hp+1,J.max_hp);else if(!J.tier2)if(J.tier2=!0,this.bots[J.owner].promoT2(this,J.owner,J)==="guard")J.base_guard+=Q.PROMO_T2_STAT;else J.base_atk+=Q.PROMO_T2_STAT}applyPushes(J,Q){let $=this.C,Z=(K)=>{return this.units.get(K.uid).pos??K.tgt_tile??[9,9]},W=J.map((K,Y)=>({p:K,i:Y})).sort((K,Y)=>T9(Z(K.p),Z(Y.p))||K.i-Y.i);for(let{p:K}of W){let Y=this.units.get(K.uid);if(Y.pos===null){if(K.kind==="charge"&&K.charger!=null){let F=this.units.get(K.charger);if(F.pos!==null&&K.tgt_tile&&!this.occupied(K.tgt_tile))this.moveUnit(F,K.tgt_tile)}continue}let[X,H]=K.dir,U=[Y.pos[0]+X,Y.pos[1]+H],N=K.pusher??null;if(!S9(U)||this.occupied(U)){this.damageUnit(Y,$.DISPLACE_DMG,N,Q);let F=this.board.get(T0(U));if(F!==void 0)this.damageUnit(this.units.get(F),$.DISPLACE_DMG,N,Q);continue}let G=Y.pos,q=this.terrain_on&&this.rivers.has(dZ(G,U));if(this.moveUnit(Y,U),Y.braced=!1,q)this.damageUnit(Y,$.RIVER_PUSH_DMG,N,Q);if(K.kind==="charge"&&K.charger!=null){let F=this.units.get(K.charger);if(F.pos!==null&&!this.occupied(G))this.moveUnit(F,G)}}}capRemaining(J){let Q=this.C;return(this.round>=Q.BREACH_CAP_RISE_ROUND?Q.BREACH_CAP_LATE:Q.BREACH_CAP)-this.cap_dmg[J]}damageWagon(J,Q,$,Z=!0){let W=this.wagons[Q][$];if(W.hp<=0)return!1;if(Z){if(this.capRemaining(J)<=0)return!1;this.cap_dmg[J]++}if(this.wagon_dmg_round[J]++,W.hp--,W.hp<=0){if(this.wagon_at.delete(T0([W.col,this.backRow(Q)])),this.res[J].supply+=this.C.WAGON_BOUNTY,this.last_wagon_kill_src="normal",!this.last_stand_used[Q]&&this.wagonsAlive(Q)>0)this.last_stand_used[Q]=!0,this.resolveLastStand(Q)}return!0}wagonWinCheck(J){let Q=this.wagonsAlive(0),$=this.wagonsAlive(1);if(Q===0&&$===0)throw new vJ(this.komi,J);if($===0)throw new vJ(0,J);if(Q===0)throw new vJ(1,J)}resolveLastStand(J){let Q=this.bots[J].lastStand(this,J);if(Q===1){for(let $ of this.reserve(J)){let Z=this.freeHeartlandTile(J);if(Z===null)break;$.hp=$.max_hp,$.exhausted=!1,$.braced=!1,$.face_down=!1,$.wounded_round=null,this.place($,Z)}this.extra_deploy[J]++}else if(Q===2){let $=this.onBoard(J).filter((Z)=>!Z.tier2).sort((Z,W)=>W.xp-Z.xp||this.costs[W.arch]-this.costs[Z.arch]||T9(Z.pos,W.pos));if($.length)this.grantTier($[0])}else{let $=this.bots[J].entrenchCols(this,J),Z=0;for(let W of $){if(Z>=this.C.ENTRENCH_PALISADES)break;if(W>=0&&W<8&&!this.palisades.has(W))this.palisades.set(W,J),Z++}}}standardUnit(J){let Q;for(let Z of this.units.values())if(Z.owner===J&&Z.arch==="hero"){Q=Z;break}if(Q&&Q.pos!==null)return Q;let $=this.standard_bearer[J];if($!==null){let Z=this.units.get($);if(Z&&Z.pos!==null)return Z}return null}validateOrder(J,Q){let $=this.C,Z=["HOLD"];if(!Q||J.pos===null)return Z;let W=Q[0];if(W==="HOLD")return Z;if(W==="BRACE")return J.arch==="spear"?Q:Z;let K=J.braced?0:J.mv,Y=(X,H)=>{let U=H;if(this.terrain_on&&H>0&&X.length===H+1&&X.every((G)=>this.ttype.get(T0(G))==="road"))U=H+1;if(X.length>U)return!1;let N=J.pos;for(let G of X){if(!S9(G)||s0(N,G)!==1)return!1;N=G}return!0};if(W==="SHOOT"){if(J.arch!=="archer"&&J.arch!=="siege")return Z;let X=Q[1];if(X[0]==="U"){let H=this.units.get(X[1]);if(!H||H.pos===null||H.owner===J.owner)return Z;if(!(J.rmin<=s0(J.pos,H.pos)&&s0(J.pos,H.pos)<=J.rmax))return Z}else if(X[0]==="W"){if(J.arch!=="siege")return Z}else if(X[0]==="P"){if(J.arch!=="siege")return Z}else return Z;return Q}if(W==="MOVE"){let X=Q[1];return X&&X.length&&Y(X,K)?Q:Z}if(W==="MELEE"){if(J.arch==="siege")return Z;let X=Q[1],H=Q[2],U=this.units.get(X);if(!U||U.owner===J.owner)return Z;if(H&&H.length&&!Y(H,K))return Z;return["MELEE",X,H&&H.length?[...H]:[]]}if(W==="CHARGE"){if(J.arch!=="cav"||J.braced)return Z;let X=Q[1],H=Q[2],U=this.units.get(X);if(!U||U.owner===J.owner)return Z;if(!this.C.CHARGE_ADJ_OK&&U.pos!==null&&s0(J.pos,U.pos)===1)return["MELEE",X,[]];if(!H||!H.length||!Y(H,K))return Z;return["CHARGE",X,[...H]]}return Z}runPulse(J){let Q=this.bots[0].orders(this,0,J),$=this.bots[1].orders(this,1,J),Z=new Map;for(let G of this.onBoard())Z.set(G.uid,this.validateOrder(G,(G.owner===0?Q:$)[G.uid]));for(let G of this.onBoard()){let q=Z.get(G.uid)[0];if(q==="BRACE")G.braced=!0;else if(G.braced&&q!=="MELEE")G.braced=!1}this.endSubphase(new Map,[]);let W=new Map,K=[],Y=[],X=[];for(let G of this.onBoard()){let q=Z.get(G.uid);if(!q||q[0]!=="SHOOT")continue;let F=q[1];if(F[0]==="U"){let R=this.units.get(F[1]);if(!R||R.pos===null||!(G.rmin<=s0(G.pos,R.pos)&&s0(G.pos,R.pos)<=G.rmax))continue;let B;if(this.terrain_on&&this.ttype.get(T0(R.pos))==="woods")B=Math.max(this.flanked(R)?this.C.FLANK_MIN_DMG:0,this.effAtk(G,R)-this.effGuard(R,!0));else B=this.attackDamage(G,R);if(K.push([G.uid,R.uid,B]),G.arch==="siege"&&this.C.SIEGE_PUSH_UNITS){let E=R.pos[0]-G.pos[0],D=R.pos[1]-G.pos[1],O=Math.abs(E)>Math.abs(D)?[E>0?1:-1,0]:[0,D>0?1:-1];Y.push({uid:R.uid,dir:O,pusher:G.uid,kind:"siege",tgt_tile:R.pos})}}else if(F[0]==="W"){let R=F[1],B=F[2];if(R===G.owner||B>=this.wagons[R].length)continue;let E=this.wagons[R][B],D=[E.col,this.backRow(R)];if(E.hp>0&&G.rmin<=s0(G.pos,D)&&s0(G.pos,D)<=G.rmax)X.push([G.owner,R,B])}else if(F[0]==="P"){let R=F[1];if(this.palisades.has(R)){let B=this.stakes[R];for(let E of[[R,B-1],[R,B]])if(G.rmin<=s0(G.pos,E)&&s0(G.pos,E)<=G.rmax){this.palisades.delete(R);break}}}}for(let[G,q,F]of X)this.damageWagon(G,q,F,!0);if(X.length)this.wagonWinCheck("wagons");this.applyDamage(K,W),this.endSubphase(W,Y),W=new Map;let H=new Map;for(let G of this.onBoard()){let q=Z.get(G.uid);if(q&&(q[0]==="MOVE"||q[0]==="MELEE"||q[0]==="CHARGE")){let F=q[0]==="MOVE"?q[1]:q[2];if(F&&F.length)H.set(G.uid,{path:F,stopped:!1,moved:0})}}let U=0;for(let G of H.values())U=Math.max(U,G.path.length);for(let G=0;G<U;G++){let q=new Map;for(let B of[...H.keys()].sort((E,D)=>E-D)){let E=H.get(B),D=this.units.get(B);if(E.stopped||G>=E.path.length||D.pos===null)continue;let O=E.path[G];if(s0(D.pos,O)!==1){E.stopped=!0;continue}if(this.occupied(O)){E.stopped=!0;continue}let V=T0(O);if(!q.has(V))q.set(V,[]);q.get(V).push(B)}let F=[],R=[...q.keys()].sort((B,E)=>T9(B.split(",").map(Number),E.split(",").map(Number)));for(let B of R){let E=q.get(B);if(E.length>=2)for(let D of E)H.get(D).stopped=!0;else F.push([E[0],B.split(",").map(Number)])}for(let[B,E]of F)this.moveUnit(this.units.get(B),E),H.get(B).moved++;if(!this.C.ZOC_ENABLED)F=[];for(let[B]of F){let E=this.units.get(B);for(let D of qJ(E.pos)){let O=this.board.get(T0(D));if(O!==void 0&&this.units.get(O).owner!==E.owner){H.get(B).stopped=!0;break}}}}K=[],Y=[];for(let G of[...H.keys()].sort((q,F)=>q-F)){let q=Z.get(G);if(!q||q[0]!=="CHARGE")continue;let F=this.units.get(G);if(F.pos===null)continue;let R=this.units.get(q[1]);if(!R||R.pos===null||H.get(G).moved<this.C.CHARGE_MOVE_MIN||s0(F.pos,R.pos)!==1)continue;if(this.terrain_on&&this.ttype.get(T0(R.pos))==="woods")continue;if(R.arch==="spear"&&R.braced){let B=Math.max(0,R.base_atk+this.counter(R.arch,F.arch)-this.effGuard(F));K.push([R.uid,F.uid,B]);let E=[F.pos[0]-R.pos[0],F.pos[1]-R.pos[1]];Y.push({uid:F.uid,dir:E,pusher:R.uid,kind:"brace",tgt_tile:F.pos})}else{let B=this.attackDamage(F,R,!0,!0);K.push([F.uid,R.uid,B]);let E=[R.pos[0]-F.pos[0],R.pos[1]-F.pos[1]];Y.push({uid:R.uid,dir:E,pusher:F.uid,kind:"charge",charger:F.uid,tgt_tile:R.pos})}}this.applyDamage(K,W),this.endSubphase(W,Y),W=new Map,K=[],Y=[];let N=[];for(let G of this.onBoard()){let q=Z.get(G.uid);if(!q||q[0]!=="MELEE")continue;let F=this.units.get(q[1]);if(!F||F.pos===null||G.pos===null||s0(G.pos,F.pos)!==1)continue;N.push([G,F])}for(let[G,q]of N){K.push([G.uid,q.uid,this.attackDamage(G,q,!1,!0)]);let F=q.arch==="archer"||q.arch==="siege"?this.C.RANGED_RETALIATION:Math.max(0,q.base_atk+this.counter(q.arch,G.arch)-this.effGuard(G));K.push([q.uid,G.uid,F])}this.applyDamage(K,W);for(let[G,q]of N)if(q.arch==="spear"&&q.braced&&q.pos!==null&&G.pos!==null&&G.hp>0&&s0(G.pos,q.pos)===1){let F=[G.pos[0]-q.pos[0],G.pos[1]-q.pos[1]];Y.push({uid:G.uid,dir:F,pusher:q.uid,kind:"brace",tgt_tile:G.pos})}this.endSubphase(W,Y)}endSubphase(J,Q){if(this.removeDead(J),Q.length)this.applyPushes(Q,J),this.removeDead(J);this.routTest()}routTest(){let J=[];for(let Q=0;Q<2;Q++){let $=this.standardUnit(Q);if($===null)continue;let Z=!1,W=!0;for(let K of qJ($.pos)){let Y=this.board.get(T0(K));if(Y!==void 0)if(this.units.get(Y).owner!==Q)Z=!0;else{W=!1;break}else if(this.wagon_at.has(T0(K)));else{W=!1;break}}if(W&&Z)J.push(Q)}if(!J.length)return;for(let Q of J){let $=1-Q,Z=this.C.ROUT_WAGON_DMG,W=this.bots[$].routAllocate,K=W?[...W.call(this.bots[$],this,$,Q,Z)]:[];for(let Y=0;Y<Z;Y++){let X=this.wagons[Q].map((U,N)=>[N,U]).filter(([,U])=>U.hp>0);if(!X.length)break;let H=null;while(K.length){let U=K.shift();if(X.some(([N])=>N===U)){H=U;break}}if(H===null)X.sort((U,N)=>U[1].hp-N[1].hp||U[0]-N[0]),H=X[0][0];this.damageWagon($,Q,H,!1)}}throw this.wagonWinCheck("rout"),new X7}interventionWindow(J){let Q=this.C;for(let $ of[this.komi,1-this.komi]){let Z=this.bots[$].intervention(this,$,J);if(!Z)continue;let W=this.res[$];if(Z[0]==="SURGE"&&W.tribute>=Q.SURGE_COST){let K=this.units.get(Z[1]),Y=Z[2];if(K&&K.owner===$&&K.pos!==null&&S9(Y)&&s0(K.pos,Y)===1&&!this.occupied(Y))W.tribute-=Q.SURGE_COST,this.moveUnit(K,Y)}else if(Z[0]==="SHIELDBEARER"&&W.tribute>=Q.SHIELDBEARER_COST){let K=this.units.get(Z[1]);if(K&&K.owner===$&&K.pos!==null)W.tribute-=Q.SHIELDBEARER_COST,this.wards.push({uid:K.uid,owner:$,active:!0})}}}clash(){this.wards=[];try{this.interventionWindow(1),this.runPulse(1),this.interventionWindow(2),this.runPulse(2),this.interventionWindow(3)}catch(J){if(!(J instanceof X7))throw J}this.wards=[]}frontier(){let J=this.C,Q=[];for(let $=0;$<8;$++){let Z=this.stakes[$],[W,K]=this.columnClaims($);if(W===K)continue;let Y=W?0:1,X=Y===0?Z+1:Z-1;if(!(J.STAKE_MIN<=X&&X<=J.STAKE_MAX))continue;let H=1-Y;if(this.palisades.get($)===H){this.palisades.delete($);continue}let U=Y===0?[$,Z]:[$,Z-1];if(J.ENTRENCH_HOLD&&(this.entrench.get(T0(U))??0)>=J.ENTRENCH_HOLD){this.entrench.set(T0(U),0);continue}this.stakes[$]=X,this.rows_lost_round[H]++,this.rows_taken_round[Y]++,Q.push([Y,Y===0?[$,Z]:[$,Z-1]])}for(let[$,Z]of Q){let W=this.fields.get(T0(Z));if(!W)continue;if(W.owner===$){if(W.annexed!==null)W.annexed=null;continue}if((W.annexed!==null?W.annexed:W.owner)===$)continue;if(this.bots[$].trampleChoice(this,$,Z,W)==="annex")W.annexed=$;else this.res[$][W.type]+=J.RAID_GAIN,this.fields.delete(T0(Z))}for(let $ of[this.komi,1-this.komi]){let Z=1-$,W=this.heartlandRows(Z),K=this.onBoard($).filter((X)=>W.includes(X.pos[1])),Y=!1;for(let X of K){if(this.capRemaining($)<=0)break;let H=this.wagons[Z].map((G,q)=>[q,G]).filter(([,G])=>G.hp>0);if(!H.length)break;let U=H.filter(([,G])=>G.col===X.pos[0]),N;if(U.length)N=U[0][0];else{let G=Math.min(...H.map(([,F])=>Math.abs(F.col-X.pos[0]))),q=H.filter(([,F])=>Math.abs(F.col-X.pos[0])===G).sort((F,R)=>F[1].col-R[1].col);if(N=q[0][0],q.length>1){let F=this.bots[$].breachTarget(this,$,X,q);if(q.some(([R])=>R===F))N=F}}Y=this.damageWagon($,Z,N,!0)||Y}if(Y)this.wagonWinCheck("wagons")}}leadHolder(){let J=($)=>[this.wagonsAlive($),this.wagonHp($),this.ownedRows($)],Q=T9(J(0),J(1));return Q>0?0:Q<0?1:null}updateEntrench(){let J=this.C;if(!J.ENTRENCH_HOLD)return;let Q=J.STAKE_START,$=new Map;for(let Z=0;Z<8;Z++){let W=this.stakes[Z],K;if(W>Q)K=[...Array(W-Q).keys()].map((Y)=>Y+Q);else if(W<Q)K=[...Array(Q-W).keys()].map((Y)=>Y+W);else continue;for(let Y of K)$.set(T0([Z,Y]),Math.min((this.entrench.get(T0([Z,Y]))??0)+1,J.ENTRENCH_HOLD))}this.entrench=$}caravan(J){let Q=this.C,$=Q.CARAVAN_ARTIFACTS,Z=J===1?0:$,W=this.artifact_order.slice(Z,Z+$),K=(X)=>[this.wagonsAlive(X),this.ownedRows(X),X===this.komi?0:1],Y=T9(K(0),K(1))<=0?0:1;for(let X of[Y,1-Y,Y]){if(!W.length)break;let H=this.bots[X].artifactPick(this,X,W.slice());if(!W.includes(H))H=W[0];W=W.filter((U)=>U!==H),this.applyArtifact(X,H)}}applyArtifact(J,Q){let $=this.C,Z=this.res[J];if(Q===1)Z.supply+=$.ARTIFACT_SUPPLY;else if(Q===2)Z.crop+=$.ARTIFACT_CROP;else if(Q===3){let W;for(let K of this.units.values())if(K.owner===J&&K.arch==="hero"){W=K;break}if(W)W.base_guard+=1}else if(Q===4){let W=this.onBoard(J).sort((K,Y)=>Y.xp-K.xp||this.costs[Y.arch]-this.costs[K.arch]||T9(K.pos,Y.pos));if(W.length)this.gainXp(W[0],$.ARTIFACT_XP)}else if(Q===5){for(let W of this.bots[J].entrenchCols(this,J))if(W>=0&&W<8&&!this.palisades.has(W)){this.palisades.set(W,J);break}}else if(Q===6)Z.tribute+=$.ARTIFACT_TRIBUTE;else if(Q===7)this.recruit_discount[J]=$.ARTIFACT_DISCOUNT;else if(Q===8){let[,W]=this.computeHarvest(J),K=W<this.onBoard(J).length?"crop":"supply";for(let Y=0;Y<8;Y++)for(let X of this.heartlandRows(J)){let H=[Y,X];if(!this.fields.has(T0(H))&&!this.wagon_at.has(T0(H))){this.fields.set(T0(H),{type:K,owner:J,annexed:null});return}}}}playRound(){let J=this.C;this.cap_dmg=[0,0],this.wagon_dmg_round=[0,0],this.rows_lost_round=[0,0],this.rows_taken_round=[0,0],this.unit_dmg_round=[0,0],this.musterPlayer(this.komi),this.musterPlayer(1-this.komi);for(let Z of this.units.values())Z.face_down=!1;this.clash(),this.frontier();let[Q,$]=this.rows_lost_round;if(Q!==$)this.komi=Q>$?0:1;if(this.round>=J.GOLDEN_GOAL_ROUND){let Z=this.rows_taken_round[0]>0||this.wagon_dmg_round[0]>0,W=this.rows_taken_round[1]>0||this.wagon_dmg_round[1]>0;if(Z||W){let K;if(Z&&W)if(this.rows_taken_round[0]!==this.rows_taken_round[1])K=this.rows_taken_round[0]>this.rows_taken_round[1]?0:1;else if(this.wagon_dmg_round[0]!==this.wagon_dmg_round[1])K=this.wagon_dmg_round[0]>this.wagon_dmg_round[1]?0:1;else K=this.komi;else K=Z?0:1;throw new vJ(K,"golden-goal")}}for(let Z=0;Z<2;Z++)this.res[Z].tribute+=J.TRIBUTE_PER_ROW*this.rows_lost_round[Z];if(this.round===J.CARAVAN_ROUND_1)this.caravan(1);else if(this.round===J.CARAVAN_ROUND_2)this.caravan(2);if(this.round===1){let[Z,W]=this.rows_taken_round;if(Z!==W)this.r1_winner=Z>W?0:1,this.r1_rows_winner=this.r1_winner;else if(this.unit_dmg_round[0]!==this.unit_dmg_round[1]&&(!J.R1_REQUIRE_ENGAGE||Math.min(...this.unit_dmg_round)>=1))this.r1_winner=this.unit_dmg_round[0]>this.unit_dmg_round[1]?0:1;if(J.FIRST_BLOOD_SUPPLY&&this.r1_winner!==null)this.res[this.r1_winner].supply+=J.FIRST_BLOOD_SUPPLY}if(this.lead_trace.push(this.leadHolder()),this.round>=J.HARD_STOP_ROUND){let Z=this.wagonsAlive(0),W=this.wagonsAlive(1);if(Z!==W)throw new vJ(Z>W?0:1,"ladder");let K=this.ownedRows(0),Y=this.ownedRows(1);if(K!==Y)throw new vJ(K>Y?0:1,"ladder");throw new vJ(this.komi,"ladder")}this.updateEntrench(),this.round++}phaseHashesR1(){let J=[];this.musterPlayer(this.komi),this.musterPlayer(1-this.komi),J.push(["muster",this.stateHash()]);for(let Z of this.units.values())Z.face_down=!1;J.push(["reveal",this.stateHash()]),this.clash(),J.push(["clash",this.stateHash()]),this.frontier();let[Q,$]=this.rows_lost_round;if(Q!==$)this.komi=Q>$?0:1;J.push(["frontier",this.stateHash()]);for(let Z=0;Z<2;Z++)this.res[Z].tribute+=this.C.TRIBUTE_PER_ROW*this.rows_lost_round[Z];return J.push(["pass",this.stateHash()]),J}snapshot(){let J=[...this.units.values()].map((Q)=>({uid:Q.uid,owner:Q.owner,arch:Q.arch,base_atk:Q.base_atk,base_guard:Q.base_guard,hp:Q.hp,max_hp:Q.max_hp,mv:Q.mv,rmin:Q.rmin,rmax:Q.rmax,pos:Q.pos===null?null:[Q.pos[0],Q.pos[1]],exhausted:Q.exhausted,braced:Q.braced,xp:Q.xp,tier1:Q.tier1,tier2:Q.tier2,wounded_round:Q.wounded_round,face_down:Q.face_down})).sort((Q,$)=>Q.uid-$.uid);return{round:this.round,komi:this.komi,stakes:[...this.stakes],res:this.res.map((Q)=>({supply:Q.supply,crop:Q.crop,tribute:Q.tribute})),units:J,wagons:this.wagons.map((Q)=>Q.map(($)=>({col:$.col,row:$.row,hp:$.hp}))),fields:[...this.fields.entries()].map(([Q,$])=>[Q.split(",").map(Number),$]).sort(uZ),palisades:[...this.palisades.entries()].sort((Q,$)=>Q[0]-$[0]),entrench:[...this.entrench.entries()].map(([Q,$])=>[Q.split(",").map(Number),$]).sort(uZ)}}stateHash(){return mZ(H7(this.snapshot())).slice(0,16)}}function uZ(J,Q){return H7(J)<H7(Q)?-1:1}function H7(J){if(J===null)return"null";if(typeof J==="boolean")return J?"true":"false";if(typeof J==="number")return String(J);if(typeof J==="string")return JSON.stringify(J);if(Array.isArray(J))return"["+J.map(H7).join(",")+"]";return"{"+Object.keys(J).sort().map(($)=>JSON.stringify($)+":"+H7(J[$])).join(",")+"}"}function s0(J,Q){return Math.abs(J[0]-Q[0])+Math.abs(J[1]-Q[1])}function S9(J){return J[0]>=0&&J[0]<8&&J[1]>=0&&J[1]<8}function qJ(J){let[Q,$]=J,Z=[];if(Q>0)Z.push([Q-1,$]);if(Q<7)Z.push([Q+1,$]);if($>0)Z.push([Q,$-1]);if($<7)Z.push([Q,$+1]);return Z}G9.prototype.territoryOf=function(J){return J[1]<this.stakes[J[0]]?0:1};G9.prototype.beyondOwn=function(J){return this.territoryOf(J.pos)!==J.owner};G9.prototype.onBoard=function(J){let Q=[...this.board.values()].map(($)=>this.units.get($));if(J!==void 0)Q=Q.filter(($)=>$.owner===J);return Q.sort(($,Z)=>$.pos[0]-Z.pos[0]||$.pos[1]-Z.pos[1])};G9.prototype.reserve=function(J){return[...this.units.values()].filter((Q)=>Q.pos===null&&Q.owner===J).sort((Q,$)=>Q.uid-$.uid)};G9.prototype.wagonsAlive=function(J){return this.wagons[J].filter((Q)=>Q.hp>0).length};G9.prototype.wagonHp=function(J){return this.wagons[J].reduce((Q,$)=>Q+Math.max(0,$.hp),0)};G9.prototype.ownedRows=function(J){return J===0?this.stakes.reduce((Q,$)=>Q+$,0):this.stakes.reduce((Q,$)=>Q+(8-$),0)};function a7(J,Q){let $=J[0],Z=Q(J[0]);for(let W=1;W<J.length;W++){let K=Q(J[W]);if(K>Z)Z=K,$=J[W]}return $}function r7(J,Q){let $=J[0],Z=Q(J[0]);for(let W=1;W<J.length;W++){let K=Q(J[W]);if(K<Z)Z=K,$=J[W]}return $}function qQ(J,Q){let $=J[0],Z=Q(J[0]);for(let W=1;W<J.length;W++){let K=Q(J[W]);if(AY(K,Z)<0)Z=K,$=J[W]}return $}function AY(J,Q){for(let $=0;$<Math.max(J.length,Q.length);$++)if(J[$]!==Q[$])return J[$]<Q[$]?-1:1;return 0}var NJ=(J)=>`${J[0]},${J[1]}`,PY=(()=>{let J=[];for(let Q=0;Q<256;Q++){let $=Q;for(let Z=0;Z<8;Z++)$=$&1?3988292384^$>>>1:$>>>1;J[Q]=$>>>0}return J})();function CY(J){let Q=new TextEncoder().encode(J),$=4294967295;for(let Z=0;Z<Q.length;Z++)$=PY[($^Q[Z])&255]^$>>>8;return($^4294967295)>>>0}function nZ(J){return Array.isArray(J)?"("+J.map(nZ).join(", ")+")":String(J)}function P8(J,Q){for(let $=0;$<Math.max(J.length,Q.length);$++){let Z=J[$],W=Q[$];if(Array.isArray(Z)&&Array.isArray(W)){let K=P8(Z,W);if(K)return K}else if(Z!==W)return Z<W?-1:1}return 0}var wY=["HONEST","AGGRO","TURTLE","PROBER","SANDBAGGER","RUNNER"];function TY(J){let Q={mode:"auto",depth:1,fields_target:9,palisades:!0,unlock_plan:["archer"],unlock_round:3,recruit_priority:["sword","spear","archer","cav","siege"],army_overshoot:0,attack_scope:"any",brace_radius:2,trample:"annex",desperation_round:11,sandbag_until:0,wagon_hunt:!1,avoid_lone:!0,feed_forward_first:!0,rush:!0,rearguard:0,push_margin:1,convert_mult:1.8,breach_round:12,force_push_round:12};if(J==="HONEST")Object.assign(Q,{rearguard:1});else if(J==="AGGRO")Object.assign(Q,{mode:"push",depth:2,fields_target:9,unlock_plan:["cav"],unlock_round:1,recruit_priority:["cav","sword","spear","archer"],army_overshoot:1,trample:"raid",wagon_hunt:!0,palisades:!1,desperation_round:1,brace_radius:1,convert_mult:1.4,breach_round:10,force_push_round:1});else if(J==="TURTLE")Object.assign(Q,{mode:"hold",fields_target:14,unlock_plan:["archer","siege"],unlock_round:2,recruit_priority:["spear","archer","sword","siege"],attack_scope:"own_half",desperation_round:12,feed_forward_first:!1,brace_radius:3,convert_mult:2,force_push_round:14,breach_round:14});else if(J==="PROBER")Object.assign(Q,{mode:"hold",fields_target:11,unlock_plan:["archer"],unlock_round:2,recruit_priority:["spear","archer","sword","cav"],attack_scope:"own_half_superior",desperation_round:11,feed_forward_first:!1,brace_radius:3,convert_mult:1.8,force_push_round:13});else if(J==="SANDBAGGER")Object.assign(Q,{mode:"sandbag",depth:2,fields_target:9,unlock_plan:["cav"],unlock_round:5,recruit_priority:["sword","cav","spear","archer"],trample:"raid",sandbag_until:5,desperation_round:6,wagon_hunt:!0,convert_mult:1.5});else if(J==="RUNNER")Object.assign(Q,{mode:"runner",depth:6,fields_target:6,unlock_plan:["cav"],unlock_round:1,recruit_priority:["cav","sword","spear"],trample:"raid",avoid_lone:!1,desperation_round:99,palisades:!1,convert_mult:99,force_push_round:99});return Q}class t7{name;cfg;seed=0;me=0;_convert=!1;constructor(J){if(!wY.includes(J))throw Error("unknown bot: "+J);this.name=J,this.cfg=TY(J)}reset(J,Q){this.seed=J,this.me=Q,this._convert=!1}clock(J,Q){return this.cfg[Q]+(J.C.GOLDEN_GOAL_ROUND-16)}tb(...J){let Q=`${this.seed}|${this.name}|${this.me}|${J.map(nZ).join("|")}`;return CY(Q)/4294967296}setup(J,Q){let $=Q===0?1:6,Z=[[1,4,6],[0,3,6],[2,4,7],[1,3,5]],W=Z[Math.floor(this.tb("wagons")*Z.length)].slice(),K=3+(this.tb("side")<0.5?0:1),Y=[{arch:"hero",pos:[K,$]},{arch:"spear",pos:[K-1,$]},{arch:"sword",pos:[K+1,$]},{arch:"sword",pos:[K-2,$]}];return{wagons:W,units:Y}}threatenedCols(J,Q){let $=[];for(let Z=0;Z<8;Z++){let[W,K]=J.columnClaims(Z);if(Q===0&&K||Q===1&&W)$.push(Z)}return $}dangerCols(J,Q){let $=[,,,,,,,,].fill(0);for(let Z of J.onBoard(1-Q)){let[W,K]=Z.pos,Y=J.stakes[W],X,H;if(Q===0)X=K<Y,H=Y<=K&&K<=Y+2;else X=K>=Y,H=Y-3<=K&&K<Y;if(X)$[W]+=3;else if(H)$[W]+=1}return $}pickPushCenter(J,Q){let $=null,Z=null,W=J.onBoard(Q);for(let K=0;K<8;K++){let Y=0,X=0;for(let U=Math.max(0,K-1);U<Math.min(8,K+2);U++){let N=U===K?1:0.5;for(let G of J.onBoard(1-Q))if(G.pos[0]===U&&J.territoryOf(G.pos)===1-Q)Y+=N;for(let G of W)if(G.pos[0]===U)X+=0.4*N}let H=-Y+X+0.3*this.tb("pushcol",K);if(Z===null||H>Z)$=K,Z=H}return $}feedOrder(J,Q){let Z=J.onBoard(Q).map((W)=>{let K=qJ(W.pos).some((U)=>{let N=J.board.get(NJ(U));return N!==void 0&&J.units.get(N).owner!==Q}),Y=J.beyondOwn(W),X=this.cfg.feed_forward_first?0:Y?1:0,H=[W.arch==="hero"?0:1,K?0:1,X,-J.costs[W.arch],W.pos];return{uid:W.uid,key:H}});return Z.sort((W,K)=>P8(W.key,K.key)),Z.map((W)=>W.uid)}_projCropIncome(J,Q){return J.computeHarvest(Q,J.round+1)[1]}build(J,Q){let $=this.cfg,Z=J.C,W=[],K=J.res[Q].supply,Y=0;for(let U of J.fields.values())if(U.owner===Q&&U.annexed===null)Y++;let X=0;for(let U of J.units.values())if(U.owner===Q)X++;if($.palisades&&K>=Z.PALISADE_COST+Z.FIELD_COST){let U=this.dangerCols(J,Q),N=[...Array(8).keys()].filter((G)=>!J.palisades.has(G)&&U[G]>=2).sort((G,q)=>P8([-U[G],this.tb("pal",G)],[-U[q],this.tb("pal",q)]));if(N.length)W.push(["palisade",N[0]]),K-=Z.PALISADE_COST}let H=[];while(W.length<Z.BUILD_ACTIONS&&K>=Z.FIELD_COST&&Y<$.fields_target){let G=this._projCropIncome(J,Q)+2*H.filter(([,F])=>F==="crop").length<X+2&&J.round<Z.EXHAUSTION_START_ROUND-2?"crop":"supply",q=this._fieldSpot(J,Q,G,new Set(H.map(([F])=>NJ(F))));if(q===null)break;W.push(["field",q,G]),H.push([q,G]),K-=Z.FIELD_COST,Y++}if($.palisades&&W.length<Z.BUILD_ACTIONS&&K>=Z.PALISADE_COST+4){let U=this.dangerCols(J,Q),N=[...Array(8).keys()].filter((G)=>!J.palisades.has(G)&&U[G]>=1).sort((G,q)=>P8([-U[G],this.tb("pal2",G)],[-U[q],this.tb("pal2",q)]));if(N.length)W.push(["palisade",N[0]])}return W}_fieldSpot(J,Q,$,Z){let W=null,K=null;for(let Y=0;Y<8;Y++)for(let X=0;X<8;X++){let H=[Y,X];if(J.territoryOf(H)!==Q||J.fields.has(NJ(H))||J.wagon_at.has(NJ(H))||Z.has(NJ(H)))continue;let U=0;for(let q of qJ(H)){let F=J.fields.get(NJ(q));if(F&&F.type===$&&F.owner===Q&&F.annexed===null)U++}let N=J.heartlandRows(Q).includes(X)?2:0,G=2*U+N+this.tb("field",H);if(K===null||G>K)W=H,K=G}return W}reinforce(J,Q){let $=this.cfg,Z=J.C,W=J.res[Q],K={unlocks:[],recruits:[],repositions:[],rush:[],tribute_spend:0},Y=W.supply,X=W.tribute,H=0;if($.mode==="sandbag"&&J.round>$.sandbag_until)H=Math.max(0,X-2);else if(J.round>=this.clock(J,"desperation_round")&&X>2)H=X-2;if(K.tribute_spend=H,Y+=H,$.rush){let D=W.crop;for(let O of J.reserve(Q))if(O.wounded_round===J.round-1&&D>J.onBoard(Q).length)K.rush.push(O.uid),D--}let U=J.unlocked[Q],N=$.unlock_plan.filter((D)=>!U.has(D));if(N.length&&J.round>=$.unlock_round){let D=U.size,O={2:Z.UNLOCK_3RD,3:Z.UNLOCK_4TH,4:Z.UNLOCK_5TH}[D]??999;if(Y>=O+3)K.unlocks.push(N[0]),Y-=O}let G=this._projCropIncome(J,Q),q=0;for(let D of J.units.values())if(D.owner===Q)q++;let F=Z.DEPLOY_MAX+J.extra_deploy[Q],R=new Set;for(let D=0;D<F;D++){let O=Math.max(4,G+Math.floor(W.crop/6)+$.army_overshoot);if(q+1>O)break;let V=null;for(let A of $.recruit_priority){if(!U.has(A)&&!K.unlocks.includes(A))continue;if(J.copies[A]>=Z.MUSTER_COPIES)continue;let P=J.costs[A]+Z.COPY_SURCHARGE*J.copies[A];if(J.recruit_discount[Q])P=Math.max(1,P-J.recruit_discount[Q]);if(Y>=P){V=A,Y-=P;break}}if(V===null)break;let z=this._deploySpot(J,Q,R);if(z===null)break;R.add(NJ(z)),K.recruits.push([V,z]),q++}let B=this.threatenedCols(J,Q),E=new Set;for(let D of B.slice(0,Z.REPOSITION_MAX)){let O=this._spareBlocker(J,Q,D,E);if(O===null)continue;let V=this._blockTile(J,Q,D);if(V===null)continue;E.add(O.uid),K.repositions.push([O.uid,V])}if(K.repositions.length<Z.REPOSITION_MAX&&($.mode==="push"||$.mode==="sandbag"||this._convert||J.round>=this.clock(J,"force_push_round"))){let D=this.pickPushCenter(J,Q);for(let O of J.onBoard(Q)){if(K.repositions.length>=Z.REPOSITION_MAX)break;if(E.has(O.uid)||J.beyondOwn(O)||O.arch==="siege")continue;if(qJ(O.pos).some((A)=>{let P=J.board.get(NJ(A));return P!==void 0&&J.units.get(P).owner!==Q})||Math.abs(O.pos[0]-D)<=1)continue;if(!(Q===0?O.pos[1]<=1:O.pos[1]>=6))continue;for(let A of[D,D-1,D+1]){if(A<0||A>=8)continue;let P=this._blockTile(J,Q,A);if(P!==null){E.add(O.uid),K.repositions.push([O.uid,P]);break}}}}return K}_deploySpot(J,Q,$){let Z=J.heartlandRows(Q),W=Q===0?Z[1]:Z[0],K=null;if(this.cfg.mode==="push"||this.cfg.mode==="runner"||this.cfg.mode==="auto")K=this.pickPushCenter(J,Q);let Y=this.threatenedCols(J,Q);if(Y.length)K=Y[0];let X=null,H=null,U=[W,Q===0?Z[0]:Z[1]];for(let N=0;N<8;N++)for(let G of U){let q=[N,G];if(J.occupied(q)||$.has(NJ(q)))continue;let F=-Math.abs(N-(K!==null?K:3))+(G===W?1:0)+this.tb("deploy",q);if(H===null||F>H)X=q,H=F}return X}_spareBlocker(J,Q,$,Z){let W=[];for(let K of J.onBoard(Q)){if(Z.has(K.uid)||K.arch==="hero"||J.beyondOwn(K))continue;if(qJ(K.pos).some((N)=>{let G=J.board.get(NJ(N));return G!==void 0&&J.units.get(G).owner!==Q}))continue;let X=K.pos[0],H=0;for(let N of J.onBoard(Q))if(N.uid!==K.uid&&N.pos[0]===X&&!J.beyondOwn(N))H++;if(J.onBoard(1-Q).some((N)=>N.pos[0]===X)&&H===0)continue;W.push(K)}if(!W.length)return null;return W.sort((K,Y)=>P8([J.costs[K.arch],Math.abs(K.pos[0]-$),this.tb("blk",K.uid)],[J.costs[Y.arch],Math.abs(Y.pos[0]-$),this.tb("blk",Y.uid)])),W[0]}_blockTile(J,Q,$){let Z=J.stakes[$],W=Q===0?[...Array(Z).keys()].reverse():[...Array(8-Z).keys()].map((K)=>K+Z);for(let K of W){let Y=[$,K];if(!J.occupied(Y))return Y}return null}standardBearer(J,Q){return null}dirn(J){return J===0?1:-1}ownFrontRow(J,Q,$){let Z=J.stakes[$];return Q===0?Z-1:Z}firstBeyondRow(J,Q,$){let Z=J.stakes[$];return Q===0?Z:Z-1}stakeAtMax(J,Q,$){let Z=J.stakes[$];return Q===0?Z===J.C.STAKE_MAX:Z===J.C.STAKE_MIN}behind(J,Q){let $=1-Q,Z=J.wagonsAlive(Q),W=J.wagonsAlive($);if(Z!==W)return Z<W;let K=J.wagonHp(Q),Y=J.wagonHp($);if(K!==Y)return K<Y;return J.ownedRows(Q)<J.ownedRows($)}pushCols(J,Q){let $=this.pickPushCenter(J,Q);return[$-1,$,$+1].filter((Z)=>Z>=0&&Z<8)}plan(J,Q){let $=this.cfg,Z=$.mode,W=0,K=0;for(let H of J.onBoard(Q))W+=J.costs[H.arch]+H.hp;for(let H of J.onBoard(1-Q))K+=J.costs[H.arch]+H.hp;let Y=W>=$.convert_mult*Math.max(1,K);if(Z==="sandbag"&&J.round>$.sandbag_until)Z="push";if((Z==="auto"||Z==="hold")&&J.round>=this.clock(J,"desperation_round")&&this.behind(J,Q))Z="push";if((Z==="auto"||Z==="hold")&&J.round>=this.clock(J,"force_push_round"))Z="push";if(Y&&Z!=="runner")Z="push";if(Z==="auto")Z=W>=$.push_margin*K?"push":"hold";this._convert=Y;let X={mode:Z,convert:Y,threats:this.threatenedCols(J,Q)};if(Z==="push"||Z==="runner"){X.push_cols=this.pushCols(J,Q);let H=J.wagons[1-Q].filter((U)=>U.hp>0);if(H.length){let U=X.push_cols[Math.floor(X.push_cols.length/2)];X.wagon_target=qQ(H,(N)=>[Math.abs(N.col-U),N.col]).col}}return X}orders(J,Q,$){let Z=this.plan(J,Q),W={},K=this._assignDefenders(J,Q,Z),Y={};for(let X of J.onBoard(Q))W[X.uid]=this._unitOrder(J,Q,X,Z,K,Y);return W}_assignDefenders(J,Q,$){let Z={},W=new Set;for(let K of $.threats){let Y=null,X=null;for(let H of J.onBoard(Q)){if(W.has(H.uid)||J.beyondOwn(H))continue;let U=Math.abs(H.pos[0]-K)+0.1*J.costs[H.arch];if(X===null||U<X)Y=H,X=U}if(Y!==null&&X!==null&&X<=3.5)Z[Y.uid]=K,W.add(Y.uid)}if(this.cfg.rearguard&&$.mode==="push"){let K=0;for(let H of J.onBoard(1-Q))if(J.territoryOf(H.pos)===1-Q)K++;let Y=[...new Set(J.wagons[Q].filter((H)=>H.hp>0).map((H)=>H.col))].sort((H,U)=>H-U),X=Math.min(this.cfg.rearguard,Math.floor(K/2),Y.length);for(let H of Y){if(X<=0)break;if(Object.values(Z).includes(H))continue;let U=null,N=null;for(let G of J.onBoard(Q)){if(W.has(G.uid)||J.beyondOwn(G))continue;let q=Math.abs(G.pos[0]-H)+0.1*J.costs[G.arch];if(N===null||q<N)U=G,N=q}if(U!==null)Z[U.uid]=H,W.add(U.uid),X--}}return Z}_targetScore(J,Q,$,Z,W=!1){let K=J.attackDamage($,Z,W,!W);return(K>=Z.hp?10:0)+2*(NQ[$.arch]===Z.arch?1:0)+(6-Z.hp)*0.5+K+(Z.uid===(J.standard_bearer[1-Q]??-1)?3:0)+(Z.arch==="hero"?2:0)+this.tb("tgt",$.uid,Z.uid)}_attackAllowed(J,Q,$){let Z=this.cfg.attack_scope;if(this._convert)Z="any";if(Z==="any")return!0;let W=J.territoryOf($.pos)===Q;if(Z==="own_half")return W;if(Z==="own_half_superior"){if(!W)return!1;let K=0,Y=0;for(let X of J.onBoard(Q))if(s0(X.pos,$.pos)<=2)K++;for(let X of J.onBoard(1-Q))if(s0(X.pos,$.pos)<=2)Y++;return K>=Y+1}return!0}bfs(J,Q,$){if($<=0)return new Map([[NJ(Q.pos),[]]]);let Z=new Set;for(let Y of J.onBoard(1-Q.owner))for(let X of qJ(Y.pos))Z.add(NJ(X));let W=new Map([[NJ(Q.pos),[]]]),K=[[Q.pos,[]]];for(let Y=0;Y<$;Y++){let X=[];for(let[H,U]of K){if(NJ(H)!==NJ(Q.pos)&&Z.has(NJ(H)))continue;for(let N of qJ(H)){if(W.has(NJ(N))||J.occupied(N))continue;let G=[...U,N];W.set(NJ(N),G),X.push([N,G])}}K=X}return W}_unitOrder(J,Q,$,Z,W,K){let Y=this.cfg,X=[];for(let N of qJ($.pos)){let G=J.board.get(NJ(N));if(G!==void 0&&J.units.get(G).owner!==Q)X.push(J.units.get(G))}if($.arch==="siege")return this._siegeOrder(J,Q,$,Z);if($.arch==="archer"){let N=J.onBoard(1-Q).filter((G)=>s0($.pos,G.pos)===2&&this._attackAllowed(J,Q,G));if(N.length)return["SHOOT",["U",a7(N,(G)=>this._targetScore(J,Q,$,G)).uid]];if(X.length){let G=a7(X,(q)=>this._targetScore(J,Q,$,q));if(this._attackAllowed(J,Q,G))return["MELEE",G.uid,[]]}return this._moveOrder(J,Q,$,Z,W,K,2)}if($.arch==="cav"&&!$.exhausted){let N=this._findCharge(J,Q,$);if(N!==null)return N}if(X.length){let N=X.filter((G)=>this._attackAllowed(J,Q,G));if(N.length)return["MELEE",a7(N,(G)=>this._targetScore(J,Q,$,G)).uid,[]]}let H=this.bfs(J,$,$.mv),U=null;for(let N of J.onBoard(1-Q)){if(!this._attackAllowed(J,Q,N))continue;for(let G of qJ(N.pos)){if(NJ(G)===NJ($.pos))continue;let q=H.get(NJ(G));if(q!==void 0){let F=this._targetScore(J,Q,$,N)-0.3*q.length;if(N.arch==="spear"&&N.braced&&$.arch==="cav")F-=6;if(U===null||F>U[0])U=[F,N,q]}}}if(U!==null&&U[0]>1.5)return["MELEE",U[1].uid,U[2]];if($.arch==="spear"&&!$.exhausted){let N=J.onBoard(1-Q).some((q)=>s0($.pos,q.pos)<=Y.brace_radius),G=Z.mode==="hold"||!J.beyondOwn($);if(N&&G&&!($.uid in W))return["BRACE"]}return this._moveOrder(J,Q,$,Z,W,K,0,H)}_findCharge(J,Q,$){let Z=this.bfs(J,$,$.mv),W=null;for(let K of J.onBoard(1-Q)){if(!this._attackAllowed(J,Q,K))continue;if(K.arch==="spear"&&K.braced)continue;if(J.terrain_on&&J.ttype.get(NJ(K.pos))==="woods")continue;for(let Y of qJ(K.pos)){let X=Z.get(NJ(Y));if(X===void 0||X.length<J.C.CHARGE_MOVE_MIN)continue;let H=this._targetScore(J,Q,$,K,!0)-0.2*X.length;if(W===null||H>W[0])W=[H,K,X]}}if(W!==null&&W[0]>2)return["CHARGE",W[1].uid,W[2]];return null}_siegeOrder(J,Q,$,Z){let W=this.cfg;if(Z.mode==="push"){for(let Y of Z.push_cols??[])if(J.palisades.get(Y)===1-Q){let X=J.stakes[Y];if([[Y,X-1],[Y,X]].some((H)=>$.rmin<=s0($.pos,H)&&s0($.pos,H)<=$.rmax))return["SHOOT",["P",Y]]}}if((W.wagon_hunt||Z.convert)&&J.capRemaining(Q)>0)for(let Y=0;Y<J.wagons[1-Q].length;Y++){let X=J.wagons[1-Q][Y];if(X.hp<=0)continue;let H=[X.col,J.backRow(1-Q)];if($.rmin<=s0($.pos,H)&&s0($.pos,H)<=$.rmax)return["SHOOT",["W",1-Q,Y]]}let K=J.onBoard(1-Q).filter((Y)=>$.rmin<=s0($.pos,Y.pos)&&s0($.pos,Y.pos)<=$.rmax&&this._attackAllowed(J,Q,Y));if(K.length)return["SHOOT",["U",a7(K,(Y)=>this._targetScore(J,Q,$,Y)).uid]];return this._moveOrder(J,Q,$,Z,{},{},2)}_moveOrder(J,Q,$,Z,W,K,Y=0,X){let H=this.cfg,U=this._goalTile(J,Q,$,Z,W,K);if(U===null)return["HOLD"];if(X===void 0)X=this.bfs(J,$,$.mv);let N=J.onBoard(1-Q),G=null,q=null;for(let[F,R]of X){let B=F.split(",").map(Number),D=-s0(B,U);if(Y&&N.length){let O=Math.min(...N.map((V)=>s0(B,V.pos)));if(O<Y)D-=(Y-O)*2}if(H.avoid_lone&&J.territoryOf(B)!==Q){if(!J.onBoard(Q).some((V)=>V.uid!==$.uid&&V.owner===Q&&s0(V.pos,B)<=J.C.LONE_RUNNER_RADIUS))D-=4}if(D+=0.1*this.tb("mv",$.uid,B),q===null||D>q)G=[B,R],q=D}if(G===null||!G[1].length)return["HOLD"];return["MOVE",G[1]]}_goalTile(J,Q,$,Z,W,K){let Y=this.cfg;if($.uid in W){let G=W[$.uid];return[G,this.ownFrontRow(J,Q,G)]}let X=Z.mode;if(X==="sandbag"){let G=[...new Set(J.wagons[Q].filter((F)=>F.hp>0).map((F)=>F.col))].sort((F,R)=>F-R);if(!G.length)G=[3];let q=r7(G,(F)=>Math.abs(F-$.pos[0]));return[q,this.ownFrontRow(J,Q,q)]}if(X==="runner"&&$.arch==="cav")return[r7([...Array(8).keys()],(q)=>J.onBoard(1-Q).filter((F)=>F.pos[0]===q).length+0.1*this.tb("run",$.uid,q)),J.backRow(1-Q)];if(X==="push"||X==="runner"){let G=Z.push_cols&&Z.push_cols.length?Z.push_cols:[3,4],q=r7(G,(B)=>Math.abs(B-$.pos[0])+0.7*(K[String(B)]??0));if(K[String(q)]=(K[String(q)]??0)+1,Z.convert||J.round>=this.clock(J,"breach_round")||this.stakeAtMax(J,Q,q)){let B=Z.wagon_target;if(B!==void 0&&B!==null){let E=K.breach??0;K.breach=E+1;let D=[0,1,-1,0,1,-1,2,-2][E%8],O=Math.max(0,Math.min(7,B+D)),V=J.backRow(1-Q)-this.dirn(Q);return[O,V]}return[q,J.backRow(1-Q)]}let F=Y.depth,R=this.firstBeyondRow(J,Q,q)+(F-1)*this.dirn(Q);return R=Math.max(0,Math.min(7,R)),[q,R]}let H=this.dangerCols(J,Q),U=[...Array(8).keys()].filter((G)=>H[G]>0);if(!U.length)U=[$.pos[0]];let N=r7(U,(G)=>Math.abs(G-$.pos[0])+0.7*(K[String(G)]??0));return K[String(N)]=(K[String(N)]??0)+1,[N,this.ownFrontRow(J,Q,N)]}intervention(J,Q,$){let Z=J.C,W=J.res[Q].tribute;if($<=2&&W>=Z.SHIELDBEARER_COST){let K=J.standardUnit(Q);if(K!==null&&K.hp<=4){let Y=0;for(let H of qJ(K.pos)){let U=J.board.get(NJ(H));if(U!==void 0&&J.units.get(U).owner!==Q)Y++}let X=qJ(K.pos).some((H)=>{let U=J.board.get(NJ(H));if(U===void 0)return!1;let N=J.units.get(U);return N.owner===Q&&(N.arch==="spear"||N.arch==="sword")});if(Y>=2&&X&&!J.wards.some((H)=>H.uid===K.uid&&H.active))return["SHIELDBEARER",K.uid]}}if($===3&&W>=Z.SURGE_COST){for(let K of this.threatenedCols(J,Q))for(let Y of J.onBoard(Q)){if(!J.unbroken(Y))continue;for(let X of qJ(Y.pos)){if(J.occupied(X)||!S9(X))continue;if(X[0]===K&&J.territoryOf(X)===Q)return["SURGE",Y.uid,X]}}for(let K=0;K<8;K++){let[Y,X]=J.columnClaims(K);if(Q===0?Y:X)continue;let U=!0;for(let N of J.onBoard(1-Q))if(N.pos[0]===K&&J.territoryOf(N.pos)===1-Q&&J.unbroken(N)){U=!1;break}if(!U)continue;for(let N of J.onBoard(Q)){if(N.exhausted||J.beyondOwn(N))continue;for(let G of qJ(N.pos)){if(J.occupied(G))continue;if(G[0]===K&&J.territoryOf(G)!==Q){if(J.onBoard(Q).some((F)=>F.uid!==N.uid&&F.owner===Q&&s0(F.pos,G)<=J.C.LONE_RUNNER_RADIUS))return["SURGE",N.uid,G]}}}}}return null}trampleChoice(J,Q,$,Z){if(this.cfg.trample==="raid")return"raid";if(this.cfg.trample==="annex"){if(Z.type==="crop"&&J.round>=J.C.EXHAUSTION_START_ROUND-2)return"raid";return"annex"}return"raid"}lastStand(J,Q){if(J.reserve(Q).length>=2)return 1;if(this.cfg.mode==="hold")return 3;return 2}entrenchCols(J,Q){let $=this.dangerCols(J,Q);return[...Array(8).keys()].filter((Z)=>!J.palisades.has(Z)).sort((Z,W)=>P8([-$[Z],this.tb("ent",Z)],[-$[W],this.tb("ent",W)]))}promoT2(J,Q,$){return $.arch==="spear"||$.arch==="hero"?"guard":"atk"}breachTarget(J,Q,$,Z){return qQ(Z,(W)=>[W[1].hp,W[1].col])[0]}artifactPick(J,Q,$){let Z=this._projCropIncome(J,Q)<J.onBoard(Q).length,W=this.cfg.mode,K;if(W==="push"||W==="runner"||W==="sandbag")K=Z?[2,1,4,7,6,3,8,5]:[1,4,7,3,6,2,8,5];else K=Z?[2,8,5,1,3,6,4,7]:[8,5,1,3,2,6,4,7];for(let Y of K)if($.includes(Y))return Y;return $[0]}routAllocate(J,Q,$,Z){let W=new Map;J.wagons[$].forEach((Y,X)=>{if(Y.hp>0)W.set(X,Y.hp)});let K=[];for(let Y=0;Y<Z;Y++){if(!W.size)break;let X=qQ([...W.keys()],(H)=>[W.get(H),H]);if(K.push(X),W.set(X,W.get(X)-1),W.get(X)<=0)W.delete(X)}return K}}function FQ(J){return new t7(J)}var SY={unlocks:[],recruits:[],repositions:[],rush:[],tribute_spend:0};class DQ extends t7{label;pendingFeed=null;pendingBuild=null;pendingReinforce=null;pendingSB=null;pendingOrders={};pendingIntervention={};tramplePref="annex";constructor(J="You"){super("HONEST");this.label=J}feedOrder(J,Q){return this.pendingFeed??super.feedOrder(J,Q)}build(J,Q){return this.pendingBuild??[]}reinforce(J,Q){return this.pendingReinforce??{...SY}}standardBearer(J,Q){return this.pendingSB}orders(J,Q,$){return this.pendingOrders[$]??{}}intervention(J,Q,$){return this.pendingIntervention[$]??null}trampleChoice(J,Q,$,Z){if(this.tramplePref==="raid")return"raid";if(Z.type==="crop"&&J.round>=J.C.EXHAUSTION_START_ROUND-2)return"raid";return"annex"}clearPhase(){this.pendingFeed=null,this.pendingBuild=null,this.pendingReinforce=null,this.pendingSB=null,this.pendingOrders={},this.pendingIntervention={}}}var V9=(J)=>`${J[0]},${J[1]}`;function jY(J,Q,$){if($<=0)return new Map([[V9(Q.pos),[]]]);let Z=new Set;for(let Y of J.onBoard(1-Q.owner))for(let X of qJ(Y.pos))Z.add(V9(X));let W=new Map([[V9(Q.pos),[]]]),K=[[Q.pos,[]]];for(let Y=0;Y<$;Y++){let X=[];for(let[H,U]of K){if(V9(H)!==V9(Q.pos)&&Z.has(V9(H)))continue;for(let N of qJ(H)){if(W.has(V9(N))||J.occupied(N))continue;let G=[...U,N];W.set(V9(N),G),X.push([N,G])}}K=X}return W}function U7(J,Q){let $=Q.braced?0:Q.mv,Z=jY(J,Q,$),W=new Map;for(let[H,U]of Z)if(U.length)W.set(H,U);let K=[],Y=[],X=[];if(Q.arch==="archer"||Q.arch==="siege"){for(let H of J.onBoard(1-Q.owner))if(Q.rmin<=s0(Q.pos,H.pos)&&s0(Q.pos,H.pos)<=Q.rmax)X.push(H.uid)}if(Q.arch!=="siege")for(let H of J.onBoard(1-Q.owner)){if(s0(Q.pos,H.pos)===1){K.push({uid:H.uid,path:[]});continue}let U=null;for(let N of qJ(H.pos)){let G=Z.get(V9(N));if(G&&(U===null||G.length<U.length))U=G}if(U)K.push({uid:H.uid,path:U})}if(Q.arch==="cav"&&!Q.exhausted)for(let H of J.onBoard(1-Q.owner)){if(H.arch==="spear"&&H.braced)continue;let U=null;for(let N of qJ(H.pos)){let G=Z.get(V9(N));if(G&&G.length>=J.C.CHARGE_MOVE_MIN&&(U===null||G.length<U.length))U=G}if(U)Y.push({uid:H.uid,path:U})}return{moves:W,meleeTargets:K,shootTargets:X,chargeTargets:Y,canBrace:Q.arch==="spear"&&!Q.braced}}var G7=["egyptian","gaul","hun","persian","roman","spartan","teuton","viking"],e7={egyptian_archer:"../art/renders/limes_roster_28_egyptian_archer_00001_.png",egyptian_cav:"../art/renders/limes_roster_27_egyptian_cavalry_00001_.png",egyptian_hero:"../art/renders/limes_roster_30_egyptian_hero_high_priest_sebek_00001_.png",egyptian_siege:"../art/renders/limes_roster_29_egyptian_siege_00001_.png",egyptian_spear:"../art/renders/limes_roster_25_egyptian_spearman_00001_.png",egyptian_sword:"../art/renders/limes_roster_26_egyptian_swordsman_00001_.png",gaul_archer:"../art/renders/limes_roster_10_gaul_archer_00001_.png",gaul_cav:"../art/renders/limes_roster_09_gaul_cavalry_00001_.png",gaul_hero:"../art/renders/limes_roster_12_gaul_hero_druidess_eponia_00001_.png",gaul_siege:"../art/renders/limes_roster_11_gaul_siege_00001_.png",gaul_spear:"../art/renders/limes_roster_07_gaul_spearman_00001_.png",gaul_sword:"../art/renders/limes_roster_08_gaul_swordsman_00001_.png",hun_archer:"../art/renders/limes_roster_22_hun_archer_00001_.png",hun_cav:"../art/renders/limes_roster_21_hun_cavalry_00001_.png",hun_hero:"../art/renders/limes_roster_24_hun_hero_khan_bayan_00001_.png",hun_siege:"../art/renders/limes_roster_23_hun_siege_00001_.png",hun_spear:"../art/renders/limes_roster_19_hun_spearman_00001_.png",hun_sword:"../art/renders/limes_roster_20_hun_swordsman_00001_.png",persian_archer:"../art/renders/limes_roster_46_persian_archer_00001_.png",persian_cav:"../art/renders/limes_roster_45_persian_cavalry_00001_.png",persian_hero:"../art/renders/limes_roster_48_persian_hero_satrap_darius_00001_.png",persian_siege:"../art/renders/limes_roster_47_persian_siege_00001_.png",persian_spear:"../art/renders/limes_roster_43_persian_spearman_00001_.png",persian_sword:"../art/renders/limes_roster_44_persian_swordsman_00001_.png",roman_archer:"../art/renders/limes_roster_04_roman_archer_00001_.png",roman_cav:"../art/renders/limes_roster_03_roman_cavalry_00001_.png",roman_hero:"../art/renders/limes_roster_06_roman_hero_legatus_marcus_00001_.png",roman_siege:"../art/renders/limes_roster_05_roman_siege_00001_.png",roman_spear:"../art/renders/limes_roster_01_roman_spearman_00001_.png",roman_sword:"../art/renders/limes_roster_02_roman_swordsman_00001_.png",spartan_archer:"../art/renders/limes_roster_40_spartan_archer_00001_.png",spartan_cav:"../art/renders/limes_roster_39_spartan_cavalry_00001_.png",spartan_hero:"../art/renders/limes_roster_42_spartan_hero_king_leonis_00001_.png",spartan_siege:"../art/renders/limes_roster_41_spartan_siege_00001_.png",spartan_spear:"../art/renders/limes_roster_37_spartan_spearman_00001_.png",spartan_sword:"../art/renders/limes_roster_38_spartan_swordsman_00001_.png",teuton_archer:"../art/renders/limes_roster_16_teuton_archer_00001_.png",teuton_cav:"../art/renders/limes_roster_15_teuton_cavalry_00001_.png",teuton_hero:"../art/renders/limes_roster_18_teuton_hero_warlord_drengr_00001_.png",teuton_siege:"../art/renders/limes_roster_17_teuton_siege_00001_.png",teuton_spear:"../art/renders/limes_roster_13_teuton_spearman_00001_.png",teuton_sword:"../art/renders/limes_roster_14_teuton_swordsman_00001_.png",viking_archer:"../art/renders/limes_roster_34_viking_archer_00001_.png",viking_cav:"../art/renders/limes_roster_33_viking_cavalry_00001_.png",viking_hero:"../art/renders/limes_roster_36_viking_hero_jarl_sigrid_00001_.png",viking_siege:"../art/renders/limes_roster_35_viking_siege_00001_.png",viking_spear:"../art/renders/limes_roster_31_viking_spearman_00001_.png",viking_sword:"../art/renders/limes_roster_32_viking_swordsman_00001_.png"};var rJ={spear:"Spearman",sword:"Swordsman",cav:"Cavalry",archer:"Archer",siege:"Siege",hero:"Hero"},w8={roman:"#a32638",spartan:"#c4622d",hun:"#d9a418",gaul:"#3e7a3a",egyptian:"#2aa198",viking:"#2b4f81",persian:"#5b3a8e",teuton:"#6e7378"},yY={p0tribe:"roman",p1tribe:"viking"},C8=(J)=>J.replace(/[&<>"]/g,(Q)=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[Q]),sZ=(J)=>J.charAt(0).toUpperCase()+J.slice(1);function fY(J,Q,$){let Z=e7[`${$}_${Q.arch}`]??"",W=Math.max(0,Math.round(Q.hp/Q.max_hp*100)),K=Q.tier2?"★★":Q.tier1?"★":"",Y=[Q.exhausted?'<span class="flag ex" title="Exhausted">∅</span>':"",Q.braced?'<span class="flag br" title="Braced">⛨</span>':"",Q.face_down?'<span class="flag fd" title="Face-down">?</span>':""].join(""),X=Z?`<img class="billboard" src="${C8(Z)}" alt="${C8(rJ[Q.arch])}" loading="lazy">`:`<div class="billboard noimg">${C8(rJ[Q.arch][0])}</div>`;return`<div class="unit owner${Q.owner}" style="--c:${w8[$]}">
  ...
  <div class="board-grid">${Y.join("")}</div>`}function N7(){if(document.getElementById("guide-ov"))return;let J=document.createElement("div");J.id="guide-ov",J.className="overlay",J.innerHTML=`<div class="modal guide"><button class="modal-x" id="guide-x">✕</button>${`
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,b0={alphahash_fragment:jX,alphahash_pars_fragment:yX,alphamap_fragment:fX,alphamap_pars_fragment:vX,alphatest_fragment:hX,alphatest_pars_fragment:xX,aomap_fragment:bX,aomap_pars_fragment:gX,batching_pars_vertex:pX,batching_vertex:mX,begin_vertex:lX,beginnormal_vertex:dX,bsdfs:uX,iridescence_fragment:cX,bumpmap_pars_fragment:nX,clipping_planes_fragment:sX,clipping_planes_pars_fragment:iX,clipping_planes_pars_vertex:oX,clipping_planes_vertex:aX,color_fragment:rX,color_pars_fragment:tX,color_pars_vertex:eX,color_vertex:JH,common:QH,cube_uv_reflection_fragment:$H,defaultnormal_vertex:ZH,displacementmap_pars_vertex:WH,displacementmap_vertex:KH,emissivemap_fragment:YH,emissivemap_pars_fragment:XH,colorspace_fragment:HH,colorspace_pars_fragment:UH,envmap_fragment:GH,envmap_common_pars_fragment:NH,envmap_pars_fragment:qH,envmap_pars_vertex:FH,envmap_physical_pars_fragment:kH,envmap_vertex:DH,fog_vertex:EH,fog_pars_vertex:RH,fog_fragment:OH,fog_pars_fragment:MH,gradientmap_pars_fragment:_H,lightmap_pars_fragment:VH,lights_lambert_fragment:LH,lights_lambert_pars_fragment:BH,lights_pars_begin:zH,lights_toon_fragment:IH,lights_toon_pars_fragment:AH,lights_phong_fragment:PH,lights_phong_pars_fragment:CH,lights_physical_fragment:wH,lights_physical_pars_fragment:TH,lights_fragment_begin:SH,lights_fragment_maps:jH,lights_fragment_end:yH,lightprobes_pars_fragment:fH,logdepthbuf_fragment:vH,logdepthbuf_pars_fragment:hH,logdepthbuf_pars_vertex:xH,logdepthbuf_vertex:bH,map_fragment:gH,map_pars_fragment:pH,map_particle_fragment:mH,map_particle_pars_fragment:lH,metalnessmap_fragment:dH,metalnessmap_pars_fragment:uH,morphinstance_vertex:cH,morphcolor_vertex:nH,morphnormal_vertex:sH,morphtarget_pars_vertex:iH,morphtarget_vertex:oH,normal_fragment_begin:aH,normal_fragment_maps:rH,normal_pars_fragment:tH,normal_pars_vertex:eH,normal_vertex:JU,normalmap_pars_fragment:QU,clearcoat_normal_fragment_begin:$U,clearcoat_normal_fragment_maps:ZU,clearcoat_pars_fragment:WU,iridescence_pars_fragment:KU,opaque_fragment:YU,packing:XU,premultiplied_alpha_fragment:HU,project_vertex:UU,dithering_fragment:GU,dithering_pars_fragment:NU,roughnessmap_fragment:qU,roughnessmap_pars_fragment:FU,shadowmap_pars_fragment:DU,shadowmap_pars_vertex:EU,shadowmap_vertex:RU,shadowmask_pars_fragment:OU,skinbase_vertex:MU,skinning_pars_vertex:_U,skinning_vertex:VU,skinnormal_vertex:LU,specularmap_fragment:BU,specularmap_pars_fragment:zU,tonemapping_fragment:kU,tonemapping_pars_fragment:IU,transmission_fragment:AU,transmission_pars_fragment:PU,uv_pars_fragment:CU,uv_pars_vertex:wU,uv_vertex:TU,worldpos_vertex:SU,background_vert:jU,background_frag:yU,backgroundCube_vert:fU,backgroundCube_frag:vU,cube_vert:hU,cube_frag:xU,depth_vert:bU,depth_frag:gU,distance_vert:pU,distance_frag:mU,equirect_vert:lU,equirect_frag:dU,linedashed_vert:uU,linedashed_frag:cU,meshbasic_vert:nU,meshbasic_frag:sU,meshlambert_vert:iU,meshlambert_frag:oU,meshmatcap_vert:aU,meshmatcap_frag:rU,meshnormal_vert:tU,meshnormal_frag:eU,meshphong_vert:J5,meshphong_frag:Q5,meshphysical_vert:$5,meshphysical_frag:Z5,meshtoon_vert:W5,meshtoon_frag:K5,points_vert:Y5,points_frag:X5,shadow_vert:H5,shadow_frag:U5,sprite_vert:G5,sprite_frag:N5},X0={common:{diffuse:{value:new x0(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new j0},alphaMap:{value:null},alphaMapTransform:{value:new j0},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new j0}},envmap:{envMap:{value:null},envMapRotation:{value:new j0},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:0.98},dfgLUT:{value:null}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new j0}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new j0}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new j0},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new j0},normalScale:{value:new B0(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new j0},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new j0}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new j0}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new j0}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:0.00025},fogNear:{value:1},fogFar:{value:2000},fogColor:{value:new x0(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null},probesSH:{value:null},probesMin:{value:new j},probesMax:{value:new j},probesResolution:{value:new j}},points:{diffuse:{value:new x0(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new j0},alphaTest:{value:0},uvTransform:{value:new j0}},sprite:{diffuse:{value:new x0(16777215)},opacity:{value:1},center:{value:new B0(0.5,0.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new j0},alphaMap:{value:null},alphaMapTransform:{value:new j0},alphaTest:{value:0}}},C9={basic:{uniforms:bJ([X0.common,X0.specularmap,X0.envmap,X0.aomap,X0.lightmap,X0.fog]),vertexShader:b0.meshbasic_vert,fragmentShader:b0.meshbasic_frag},lambert:{uniforms:bJ([X0.common,X0.specularmap,X0.envmap,X0.aomap,X0.lightmap,X0.emissivemap,X0.bumpmap,X0.normalmap,X0.displacementmap,X0.fog,X0.lights,{emissive:{value:new x0(0)},envMapIntensity:{value:1}}]),vertexShader:b0.meshlambert_vert,fragmentShader:b0.meshlambert_frag},phong:{uniforms:bJ([X0.common,X0.specularmap,X0.envmap,X0.aomap,X0.lightmap,X0.emissivemap,X0.bumpmap,X0.normalmap,X0.displacementmap,X0.fog,X0.lights,{emissive:{value:new x0(0)},specular:{value:new x0(1118481)},shininess:{value:30},envMapIntensity:{value:1}}]),vertexShader:b0.meshphong_vert,fragmentShader:b0.meshphong_frag},standard:{uniforms:bJ([X0.common,X0.envmap,X0.aomap,X0.lightmap,X0.emissivemap,X0.bumpmap,X0.normalmap,X0.displacementmap,X0.roughnessmap,X0.metalnessmap,X0.fog,X0.lights,{emissive:{value:new x0(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:b0.meshphysical_vert,fragmentShader:b0.meshphysical_frag},toon:{uniforms:bJ([X0.common,X0.aomap,X0.lightmap,X0.emissivemap,X0.bumpmap,X0.normalmap,X0.displacementmap,X0.gradientmap,X0.fog,X0.lights,{emissive:{value:new x0(0)}}]),vertexShader:b0.meshtoon_vert,fragmentShader:b0.meshtoon_frag},matcap:{uniforms:bJ([X0.common,X0.bumpmap,X0.normalmap,X0.displacementmap,X0.fog,{matcap:{value:null}}]),vertexShader:b0.meshmatcap_vert,fragmentShader:b0.meshmatcap_frag},points:{uniforms:bJ([X0.points,X0.fog]),vertexShader:b0.points_vert,fragmentShader:b0.points_frag},dashed:{uniforms:bJ([X0.common,X0.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:b0.linedashed_vert,fragmentShader:b0.linedashed_frag},depth:{uniforms:bJ([X0.common,X0.displacementmap]),vertexShader:b0.depth_vert,fragmentShader:b0.depth_frag},normal:{uniforms:bJ([X0.common,X0.bumpmap,X0.normalmap,X0.displacementmap,{opacity:{value:1}}]),vertexShader:b0.meshnormal_vert,fragmentShader:b0.meshnormal_frag},sprite:{uniforms:bJ([X0.sprite,X0.fog]),vertexShader:b0.sprite_vert,fragmentShader:b0.sprite_frag},background:{uniforms:{uvTransform:{value:new j0},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:b0.background_vert,fragmentShader:b0.background_frag},backgroundCube:{uniforms:{envMap:{value:null},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new j0}},vertexShader:b0.backgroundCube_vert,fragmentShader:b0.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:b0.cube_vert,fragmentShader:b0.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:b0.equirect_vert,fragmentShader:b0.equirect_frag},distance:{uniforms:bJ([X0.common,X0.displacementmap,{referencePosition:{value:new j},nearDistance:{value:1},farDistance:{value:1000}}]),vertexShader:b0.distance_vert,fragmentShader:b0.distance_frag},shadow:{uniforms:bJ([X0.lights,X0.fog,{color:{value:new x0(0)},opacity:{value:1}}]),vertexShader:b0.shadow_vert,fragmentShader:b0.shadow_frag}};C9.physical={uniforms:bJ([C9.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new j0},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new j0},clearcoatNormalScale:{value:new B0(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new j0},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new j0},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new j0},sheen:{value:0},sheenColor:{value:new x0(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new j0},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new j0},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new j0},transmissionSamplerSize:{value:new B0},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new j0},attenuationDistance:{value:0},attenuationColor:{value:new x0(0)},specularColor:{value:new x0(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new j0},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new j0},anisotropyVector:{value:new B0},anisotropyMap:{value:null},anisotropyMapTransform:{value:new j0}}]),vertexShader:b0.meshphysical_vert,fragmentShader:b0.meshphysical_frag};var JQ={r:0,b:0,g:0},q5=new FJ,rK=new j0;rK.set(-1,0,0,0,1,0,0,0,1);function F5(J,Q,$,Z,W,K){let Y=new x0(0),X=W===!0?0:1,H,U,N=null,G=0,q=null;function F(O){let V=O.isScene===!0?O.background:null;if(V&&V.isTexture){let z=O.backgroundBlurriness>0;V=Q.get(V,z)}return V}function R(O){let V=!1,z=F(O);if(z===null)E(Y,X);else if(z&&z.isColor)E(z,1),V=!0;let A=J.xr.getEnvironmentBlendMode();if(A==="additive")$.buffers.color.setClear(0,0,0,1,K);else if(A==="alpha-blend")$.buffers.color.setClear(0,0,0,0,K);if(J.autoClear||V)$.buffers.depth.setTest(!0),$.buffers.depth.setMask(!0),$.buffers.color.setMask(!0),J.clear(J.autoClearColor,J.autoClearDepth,J.autoClearStencil)}function B(O,V){let z=F(V);if(z&&(z.isCubeTexture||z.mapping===A7)){if(U===void 0)U=new i0(new jJ(1,1,1),new X9({name:"BackgroundCubeMaterial",uniforms:_8(C9.backgroundCube.uniforms),vertexShader:C9.backgroundCube.vertexShader,fragmentShader:C9.backgroundCube.fragmentShader,side:uJ,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),U.geometry.deleteAttribute("normal"),U.geometry.deleteAttribute("uv"),U.onBeforeRender=function(A,P,w){this.matrixWorld.copyPosition(w.matrixWorld)},Object.defineProperty(U.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),Z.update(U);if(U.material.uniforms.envMap.value=z,U.material.uniforms.backgroundBlurriness.value=V.backgroundBlurriness,U.material.uniforms.backgroundIntensity.value=V.backgroundIntensity,U.material.uniforms.backgroundRotation.value.setFromMatrix4(q5.makeRotationFromEuler(V.backgroundRotation)).transpose(),z.isCubeTexture&&z.isRenderTargetTexture===!1)U.material.uniforms.backgroundRotation.value.premultiply(rK);if(U.material.toneMapped=c0.getTransfer(z.colorSpace)!==UJ,N!==z||G!==z.version||q!==J.toneMapping)U.material.needsUpdate=!0,N=z,G=z.version,q=J.toneMapping;U.layers.enableAll(),O.unshift(U,U.geometry,U.material,0,0,null)}else if(z&&z.isTexture){if(H===void 0)H=new i0(new A9(2,2),new X9({name:"BackgroundMaterial",uniforms:_8(C9.background.uniforms),vertexShader:C9.background.vertexShader,fragmentShader:C9.background.fragmentShader,side:t8,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),H.geometry.deleteAttribute("normal"),Object.defineProperty(H.material,"map",{get:function(){return this.uniforms.t2D.value}}),Z.update(H);if(H.material.uniforms.t2D.value=z,H.material.uniforms.backgroundIntensity.value=V.backgroundIntensity,H.material.toneMapped=c0.getTransfer(z.colorSpace)!==UJ,z.matrixAutoUpdate===!0)z.updateMatrix();if(H.material.uniforms.uvTransform.value.copy(z.matrix),N!==z||G!==z.version||q!==J.toneMapping)H.material.needsUpdate=!0,N=z,G=z.version,q=J.toneMapping;H.layers.enableAll(),O.unshift(H,H.geometry,H.material,0,0,null)}}function E(O,V){O.getRGB(JQ,i$(J)),$.buffers.color.setClear(JQ.r,JQ.g,JQ.b,V,K)}function D(){if(U!==void 0)U.geometry.dispose(),U.material.dispose(),U=void 0;if(H!==void 0)H.geometry.dispose(),H.material.dispose(),H=void 0}return{getClearColor:function(){return Y},setClearColor:function(O,V=1){Y.set(O),X=V,E(Y,X)},getClearAlpha:function(){return X},setClearAlpha:function(O){X=O,E(Y,X)},render:R,addToRenderList:B,dispose:D}}function D5(J,Q){let $=J.getParameter(J.MAX_VERTEX_ATTRIBS),Z={},W=q(null),K=W,Y=!1;function X(C,m,c,f,d){let b=!1,p=G(C,f,c,m);if(K!==p)K=p,U(K.object);if(b=F(C,f,c,d),b)R(C,f,c,d);if(d!==null)Q.update(d,J.ELEMENT_ARRAY_BUFFER);if(b||Y){if(Y=!1,z(C,m,c,f),d!==null)J.bindBuffer(J.ELEMENT_ARRAY_BUFFER,Q.get(d).buffer)}}function H(){return J.createVertexArray()}function U(C){return J.bindVertexArray(C)}function N(C){return J.deleteVertexArray(C)}function G(C,m,c,f){let d=f.wireframe===!0,b=Z[m.id];if(b===void 0)b={},Z[m.id]=b;let p=C.isInstancedMesh===!0?C.id:0,a=b[p];if(a===void 0)a={},b[p]=a;let Q0=a[c.id];if(Q0===void 0)Q0={},a[c.id]=Q0;let F0=Q0[d];if(F0===void 0)F0=q(H()),Q0[d]=F0;return F0}function q(C){let m=[],c=[],f=[];for(let d=0;d<$;d++)m[d]=0,c[d]=0,f[d]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:m,enabledAttributes:c,attributeDivisors:f,object:C,attributes:{},index:null}}function F(C,m,c,f){let d=K.attributes,b=m.attributes,p=0,a=c.getAttributes();for(let Q0 in a)if(a[Q0].location>=0){let I0=d[Q0],M0=b[Q0];if(M0===void 0){if(Q0==="instanceMatrix"&&C.instanceMatrix)M0=C.instanceMatrix;if(Q0==="instanceColor"&&C.instanceColor)M0=C.instanceColor}if(I0===void 0)return!0;if(I0.attribute!==M0)return!0;if(M0&&I0.data!==M0.data)return!0;p++}if(K.attributesNum!==p)return!0;if(K.index!==f)return!0;return!1}function R(C,m,c,f){let d={},b=m.attributes,p=0,a=c.getAttributes();for(let Q0 in a)if(a[Q0].location>=0){let I0=b[Q0];if(I0===void 0){if(Q0==="instanceMatrix"&&C.instanceMatrix)I0=C.instanceMatrix;if(Q0==="instanceColor"&&C.instanceColor)I0=C.instanceColor}let M0={};if(M0.attribute=I0,I0&&I0.data)M0.data=I0.data;d[Q0]=M0,p++}K.attributes=d,K.attributesNum=p,K.index=f}function B(){let C=K.newAttributes;for(let m=0,c=C.length;m<c;m++)C[m]=0}function E(C){D(C,0)}function D(C,m){let{newAttributes:c,enabledAttributes:f,attributeDivisors:d}=K;if(c[C]=1,f[C]===0)J.enableVertexAttribArray(C),f[C]=1;if(d[C]!==m)J.vertexAttribDivisor(C,m),d[C]=m}function O(){let{newAttributes:C,enabledAttributes:m}=K;for(let c=0,f=m.length;c<f;c++)if(m[c]!==C[c])J.disableVertexAttribArray(c),m[c]=0}function V(C,m,c,f,d,b,p){if(p===!0)J.vertexAttribIPointer(C,m,c,d,b);else J.vertexAttribPointer(C,m,c,f,d,b)}function z(C,m,c,f){B();let d=f.attributes,b=c.getAttributes(),p=m.defaultAttributeValues;for(let a in b){let Q0=b[a];if(Q0.location>=0){let F0=d[a];if(F0===void 0){if(a==="instanceMatrix"&&C.instanceMatrix)F0=C.instanceMatrix;if(a==="instanceColor"&&C.instanceColor)F0=C.instanceColor}if(F0!==void 0){let{normalized:I0,itemSize:M0}=F0,e0=Q.get(F0);if(e0===void 0)continue;let{buffer:d0,type:s,bytesPerElement:N0}=e0,V0=s===J.INT||s===J.UNSIGNED_INT||F0.gpuType===eQ;if(F0.isInterleavedBufferAttribute){let q0=F0.data,P0=q0.stride,t0=F0.offset;if(q0.isInstancedInterleavedBuffer){for(let g0=0;g0<Q0.locationSize;g0++)D(Q0.location+g0,q0.meshPerAttribute);if(C.isInstancedMesh!==!0&&f._maxInstanceCount===void 0)f._maxInstanceCount=q0.meshPerAttribute*q0.count}else for(let g0=0;g0<Q0.locationSize;g0++)E(Q0.location+g0);J.bindBuffer(J.ARRAY_BUFFER,d0);for(let g0=0;g0<Q0.locationSize;g0++)V(Q0.location+g0,M0/Q0.locationSize,s,I0,P0*N0,(t0+M0/Q0.locationSize*g0)*N0,V0)}else{if(F0.isInstancedBufferAttribute){for(let q0=0;q0<Q0.locationSize;q0++)D(Q0.location+q0,F0.meshPerAttribute);if(C.isInstancedMesh!==!0&&f._maxInstanceCount===void 0)f._maxInstanceCount=F0.meshPerAttribute*F0.count}else for(let q0=0;q0<Q0.locationSize;q0++)E(Q0.location+q0);J.bindBuffer(J.ARRAY_BUFFER,d0);for(let q0=0;q0<Q0.locationSize;q0++)V(Q0.location+q0,M0/Q0.locationSize,s,I0,M0*N0,M0/Q0.locationSize*q0*N0,V0)}}else if(p!==void 0){let I0=p[a];if(I0!==void 0)switch(I0.length){case 2:J.vertexAttrib2fv(Q0.location,I0);break;case 3:J.vertexAttrib3fv(Q0.location,I0);break;case 4:J.vertexAttrib4fv(Q0.location,I0);break;default:J.vertexAttrib1fv(Q0.location,I0)}}}}O()}function A(){k();for(let C in Z){let m=Z[C];for(let c in m){let f=m[c];for(let d in f){let b=f[d];for(let p in b)N(b[p].object),delete b[p];delete f[d]}}delete Z[C]}}function P(C){if(Z[C.id]===void 0)return;let m=Z[C.id];for(let c in m){let f=m[c];for(let d in f){let b=f[d];for(let p in b)N(b[p].object),delete b[p];delete f[d]}}delete Z[C.id]}function w(C){for(let m in Z){let c=Z[m];for(let f in c){let d=c[f];if(d[C.id]===void 0)continue;let b=d[C.id];for(let p in b)N(b[p].object),delete b[p];delete d[C.id]}}}function _(C){for(let m in Z){let c=Z[m],f=C.isInstancedMesh===!0?C.id:0,d=c[f];if(d===void 0)continue;for(let b in d){let p=d[b];for(let a in p)N(p[a].object),delete p[a];delete d[b]}if(delete c[f],Object.keys(c).length===0)delete Z[m]}}function k(){if(l(),Y=!0,K===W)return;K=W,U(K.object)}function l(){W.geometry=null,W.program=null,W.wireframe=!1}return{setup:X,reset:k,resetDefaultState:l,dispose:A,releaseStatesOfGeometry:P,releaseStatesOfObject:_,releaseStatesOfProgram:w,initAttributes:B,enableAttribute:E,disableUnusedAttributes:O}}function E5(J,Q,$){let Z;function W(H){Z=H}function K(H,U){J.drawArrays(Z,H,U),$.update(U,Z,1)}function Y(H,U,N){if(N===0)return;J.drawArraysInstanced(Z,H,U,N),$.update(U,Z,N)}function X(H,U,N){if(N===0)return;Q.get("WEBGL_multi_draw").multiDrawArraysWEBGL(Z,H,0,U,0,N);let q=0;for(let F=0;F<N;F++)q+=U[F];$.update(q,Z,1)}this.setMode=W,this.render=K,this.renderInstances=Y,this.renderMultiDraw=X}function R5(J,Q,$,Z){let W;function K(){if(W!==void 0)return W;if(Q.has("EXT_texture_filter_anisotropic")===!0){let w=Q.get("EXT_texture_filter_anisotropic");W=J.getParameter(w.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else W=0;return W}function Y(w){if(w!==z9&&Z.convert(w)!==J.getParameter(J.IMPLEMENTATION_COLOR_READ_FORMAT))return!1;return!0}function X(w){let _=w===m9&&(Q.has("EXT_color_buffer_half_float")||Q.has("EXT_color_buffer_float"));if(w!==O9&&Z.convert(w)!==J.getParameter(J.IMPLEMENTATION_COLOR_READ_TYPE)&&w!==p9&&!_)return!1;return!0}function H(w){if(w==="highp"){if(J.getShaderPrecisionFormat(J.VERTEX_SHADER,J.HIGH_FLOAT).precision>0&&J.getShaderPrecisionFormat(J.FRAGMENT_SHADER,J.HIGH_FLOAT).precision>0)return"highp";w="mediump"}if(w==="mediump"){if(J.getShaderPrecisionFormat(J.VERTEX_SHADER,J.MEDIUM_FLOAT).precision>0&&J.getShaderPrecisionFormat(J.FRAGMENT_SHADER,J.MEDIUM_FLOAT).precision>0)return"mediump"}return"lowp"}let U=$.precision!==void 0?$.precision:"highp",N=H(U);if(N!==U)A0("WebGLRenderer:",U,"not supported, using",N,"instead."),U=N;let G=$.logarithmicDepthBuffer===!0,q=$.reversedDepthBuffer===!0&&Q.has("EXT_clip_control");if($.reversedDepthBuffer===!0&&q===!1)A0("WebGLRenderer: Unable to use reversed depth buffer due to missing EXT_clip_control extension. Fallback to default depth buffer.");let F=J.getParameter(J.MAX_TEXTURE_IMAGE_UNITS),R=J.getParameter(J.MAX_VERTEX_TEXTURE_IMAGE_UNITS),B=J.getParameter(J.MAX_TEXTURE_SIZE),E=J.getParameter(J.MAX_CUBE_MAP_TEXTURE_SIZE),D=J.getParameter(J.MAX_VERTEX_ATTRIBS),O=J.getParameter(J.MAX_VERTEX_UNIFORM_VECTORS),V=J.getParameter(J.MAX_VARYING_VECTORS),z=J.getParameter(J.MAX_FRAGMENT_UNIFORM_VECTORS),A=J.getParameter(J.MAX_SAMPLES),P=J.getParameter(J.SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:K,getMaxPrecision:H,textureFormatReadable:Y,textureTypeReadable:X,precision:U,logarithmicDepthBuffer:G,reversedDepthBuffer:q,maxTextures:F,maxVertexTextures:R,maxTextureSize:B,maxCubemapSize:E,maxAttributes:D,maxVertexUniforms:O,maxVaryings:V,maxFragmentUniforms:z,maxSamples:A,samples:P}}function O5(J){let Q=this,$=null,Z=0,W=!1,K=!1,Y=new D9,X=new j0,H={value:null,needsUpdate:!1};this.uniform=H,this.numPlanes=0,this.numIntersection=0,this.init=function(G,q){let F=G.length!==0||q||Z!==0||W;return W=q,Z=G.length,F},this.beginShadows=function(){K=!0,N(null)},this.endShadows=function(){K=!1},this.setGlobalState=function(G,q){$=N(G,q,0)},this.setState=function(G,q,F){let{clippingPlanes:R,clipIntersection:B,clipShadows:E}=G,D=J.get(G);if(!W||R===null||R.length===0||K&&!E)if(K)N(null);else U();else{let O=K?0:Z,V=O*4,z=D.clippingState||null;H.value=z,z=N(R,q,V,F);for(let A=0;A!==V;++A)z[A]=$[A];D.clippingState=z,this.numIntersection=B?this.numPlanes:0,this.numPlanes+=O}};function U(){if(H.value!==$)H.value=$,H.needsUpdate=Z>0;Q.numPlanes=Z,Q.numIntersection=0}function N(G,q,F,R){let B=G!==null?G.length:0,E=null;if(B!==0){if(E=H.value,R!==!0||E===null){let D=F+B*4,O=q.matrixWorldInverse;if(X.getNormalMatrix(O),E===null||E.length<D)E=new Float32Array(D);for(let V=0,z=F;V!==B;++V,z+=4)Y.copy(G[V]).applyMatrix4(O,X),Y.normal.toArray(E,z),E[z+3]=Y.constant}H.value=E,H.needsUpdate=!0}return Q.numPlanes=B,Q.numIntersection=0,E}}var W8=4,CK=[0.125,0.215,0.35,0.446,0.526,0.582],z8=20,M5=256,d7=new m7,wK=new x0,DZ=null,EZ=0,RZ=0,OZ=!1,_5=new j;class VZ{constructor(J){this._renderer=J,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._sizeLods=[],this._sigmas=[],this._lodMeshes=[],this._backgroundBox=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._blurMaterial=null,this._ggxMaterial=null}fromScene(J,Q=0,$=0.1,Z=100,W={}){let{size:K=256,position:Y=_5}=W;DZ=this._renderer.getRenderTarget(),EZ=this._renderer.getActiveCubeFace(),RZ=this._renderer.getActiveMipmapLevel(),OZ=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(K);let X=this._allocateTargets();if(X.depthBuffer=!0,this._sceneToCubeUV(J,$,Z,X,Y),Q>0)this._blur(X,0,0,Q);return this._applyPMREM(X),this._cleanup(X),X}fromEquirectangular(J,Q=null){return this._fromTexture(J,Q)}fromCubemap(J,Q=null){return this._fromTexture(J,Q)}compileCubemapShader(){if(this._cubemapMaterial===null)this._cubemapMaterial=jK(),this._compileMaterial(this._cubemapMaterial)}compileEquirectangularShader(){if(this._equirectMaterial===null)this._equirectMaterial=SK(),this._compileMaterial(this._equirectMaterial)}dispose(){if(this._dispose(),this._cubemapMaterial!==null)this._cubemapMaterial.dispose();if(this._equirectMaterial!==null)this._equirectMaterial.dispose();if(this._backgroundBox!==null)this._backgroundBox.geometry.dispose(),this._backgroundBox.material.dispose()}_setSize(J){this._lodMax=Math.floor(Math.log2(J)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){if(this._blurMaterial!==null)this._blurMaterial.dispose();if(this._ggxMaterial!==null)this._ggxMaterial.dispose();if(this._pingPongRenderTarget!==null)this._pingPongRenderTarget.dispose();for(let J=0;J<this._lodMeshes.length;J++)this._lodMeshes[J].geometry.dispose()}_cleanup(J){this._renderer.setRenderTarget(DZ,EZ,RZ),this._renderer.xr.enabled=OZ,J.scissorTest=!1,K7(J,0,0,J.width,J.height)}_fromTexture(J,Q){if(J.mapping===J7||J.mapping===N8)this._setSize(J.image.length===0?16:J.image[0].width||J.image[0].image.width);else this._setSize(J.image.width/4);DZ=this._renderer.getRenderTarget(),EZ=this._renderer.getActiveCubeFace(),RZ=this._renderer.getActiveMipmapLevel(),OZ=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;let $=Q||this._allocateTargets();return this._textureToCubeUV(J,$),this._applyPMREM($),this._cleanup($),$}_allocateTargets(){let J=3*Math.max(this._cubeSize,112),Q=4*this._cubeSize,$={magFilter:nJ,minFilter:nJ,generateMipmaps:!1,type:m9,format:z9,colorSpace:h$,depthBuffer:!1},Z=TK(J,Q,$);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==J||this._pingPongRenderTarget.height!==Q){if(this._pingPongRenderTarget!==null)this._dispose();this._pingPongRenderTarget=TK(J,Q,$);let{_lodMax:W}=this;({lodMeshes:this._lodMeshes,sizeLods:this._sizeLods,sigmas:this._sigmas}=V5(W)),this._blurMaterial=B5(W,J,Q),this._ggxMaterial=L5(W,J,Q)}return Z}_compileMaterial(J){let Q=new i0(new sJ,J);this._renderer.compile(Q,d7)}_sceneToCubeUV(J,Q,$,Z,W){let X=new mJ(90,1,Q,$),H=[1,-1,1,1,1,1],U=[1,1,1,-1,-1,-1],N=this._renderer,G=N.autoClear,q=N.toneMapping;if(N.getClearColor(wK),N.toneMapping=R9,N.autoClear=!1,N.state.buffers.depth.getReversed())N.setRenderTarget(Z),N.clearDepth(),N.setRenderTarget(null);if(this._backgroundBox===null)this._backgroundBox=new i0(new jJ,new I9({name:"PMREM.Background",side:uJ,depthWrite:!1,depthTest:!1}));let R=this._backgroundBox,B=R.material,E=!1,D=J.background;if(D){if(D.isColor)B.color.copy(D),J.background=null,E=!0}else B.color.copy(wK),E=!0;for(let O=0;O<6;O++){let V=O%3;if(V===0)X.up.set(0,H[O],0),X.position.set(W.x,W.y,W.z),X.lookAt(W.x+U[O],W.y,W.z);else if(V===1)X.up.set(0,0,H[O]),X.position.set(W.x,W.y,W.z),X.lookAt(W.x,W.y+U[O],W.z);else X.up.set(0,H[O],0),X.position.set(W.x,W.y,W.z),X.lookAt(W.x,W.y,W.z+U[O]);let z=this._cubeSize;if(K7(Z,V*z,O>2?z:0,z,z),N.setRenderTarget(Z),E)N.render(R,X);N.render(J,X)}N.toneMapping=q,N.autoClear=G,J.background=D}_textureToCubeUV(J,Q){let $=this._renderer,Z=J.mapping===J7||J.mapping===N8;if(Z){if(this._cubemapMaterial===null)this._cubemapMaterial=jK();this._cubemapMaterial.uniforms.flipEnvMap.value=J.isRenderTargetTexture===!1?-1:1}else if(this._equirectMaterial===null)this._equirectMaterial=SK();let W=Z?this._cubemapMaterial:this._equirectMaterial,K=this._lodMeshes[0];K.material=W;let Y=W.uniforms;Y.envMap.value=J;let X=this._cubeSize;K7(Q,0,0,3*X,2*X),$.setRenderTarget(Q),$.render(K,d7)}_applyPMREM(J){let Q=this._renderer,$=Q.autoClear;Q.autoClear=!1;let Z=this._lodMeshes.length;for(let W=1;W<Z;W++)this._applyGGXFilter(J,W-1,W);Q.autoClear=$}_applyGGXFilter(J,Q,$){let Z=this._renderer,W=this._pingPongRenderTarget,K=this._ggxMaterial,Y=this._lodMeshes[$];Y.material=K;let X=K.uniforms,H=$/(this._lodMeshes.length-1),U=Q/(this._lodMeshes.length-1),N=Math.sqrt(H*H-U*U),G=0+H*1.25,q=N*G,{_lodMax:F}=this,R=this._sizeLods[$],B=3*R*($>F-W8?$-F+W8:0),E=4*(this._cubeSize-R);X.envMap.value=J.texture,X.roughness.value=q,X.mipInt.value=F-Q,K7(W,B,E,3*R,2*R),Z.setRenderTarget(W),Z.render(Y,d7),X.envMap.value=W.texture,X.roughness.value=0,X.mipInt.value=F-$,K7(J,B,E,3*R,2*R),Z.setRenderTarget(J),Z.render(Y,d7)}_blur(J,Q,$,Z,W){let K=this._pingPongRenderTarget;this._halfBlur(J,K,Q,$,Z,"latitudinal",W),this._halfBlur(K,J,$,$,Z,"longitudinal",W)}_halfBlur(J,Q,$,Z,W,K,Y){let X=this._renderer,H=this._blurMaterial;if(K!=="latitudinal"&&K!=="longitudinal")w0("blur direction must be either latitudinal or longitudinal!");let U=3,N=this._lodMeshes[Z];N.material=H;let G=H.uniforms,q=this._sizeLods[$]-1,F=isFinite(W)?Math.PI/(2*q):2*Math.PI/(2*z8-1),R=W/F,B=isFinite(W)?1+Math.floor(U*R):z8;if(B>z8)A0(`sigmaRadians, ${W}, is too large and will clip, as it requested ${B} samples when the maximum is set to ${z8}`);let E=[],D=0;for(let P=0;P<z8;++P){let w=P/R,_=Math.exp(-w*w/2);if(E.push(_),P===0)D+=_;else if(P<B)D+=2*_}for(let P=0;P<E.length;P++)E[P]=E[P]/D;if(G.envMap.value=J.texture,G.samples.value=B,G.weights.value=E,G.latitudinal.value=K==="latitudinal",Y)G.poleAxis.value=Y;let{_lodMax:O}=this;G.dTheta.value=F,G.mipInt.value=O-$;let V=this._sizeLods[Z],z=3*V*(Z>O-W8?Z-O+W8:0),A=4*(this._cubeSize-V);K7(Q,z,A,3*V,2*V),X.setRenderTarget(Q),X.render(N,d7)}}function V5(J){let Q=[],$=[],Z=[],W=J,K=J-W8+1+CK.length;for(let Y=0;Y<K;Y++){let X=Math.pow(2,W);Q.push(X);let H=1/X;if(Y>J-W8)H=CK[Y-J+W8-1];else if(Y===0)H=0;$.push(H);let U=1/(X-2),N=-U,G=1+U,q=[N,N,G,N,G,G,N,N,G,G,N,G],F=6,R=6,B=3,E=2,D=1,O=new Float32Array(B*R*F),V=new Float32Array(E*R*F),z=new Float32Array(D*R*F);for(let P=0;P<F;P++){let w=P%3*2/3-1,_=P>2?0:-1,k=[w,_,0,w+0.6666666666666666,_,0,w+0.6666666666666666,_+1,0,w,_,0,w+0.6666666666666666,_+1,0,w,_+1,0];O.set(k,B*R*P),V.set(q,E*R*P);let l=[P,P,P,P,P,P];z.set(l,D*R*P)}let A=new sJ;if(A.setAttribute("position",new Q9(O,B)),A.setAttribute("uv",new Q9(V,E)),A.setAttribute("faceIndex",new Q9(z,D)),Z.push(new i0(A,null)),W>W8)W--}return{lodMeshes:Z,sizeLods:Q,sigmas:$}}function TK(J,Q,$){let Z=new Y9(J,Q,$);return Z.texture.mapping=A7,Z.texture.name="PMREM.cubeUv",Z.scissorTest=!0,Z}function K7(J,Q,$,Z,W){J.viewport.set(Q,$,Z,W),J.scissor.set(Q,$,Z,W)}function L5(J,Q,$){return new X9({name:"PMREMGGXConvolution",defines:{GGX_SAMPLES:M5,CUBEUV_TEXEL_WIDTH:1/Q,CUBEUV_TEXEL_HEIGHT:1/$,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},roughness:{value:0},mipInt:{value:0}},vertexShader:$Q(),fragmentShader:`
		...
		`,blending:B9,depthTest:!1,depthWrite:!1})}function B5(J,Q,$){let Z=new Float32Array(z8),W=new j(0,1,0);return new X9({name:"SphericalGaussianBlur",defines:{n:z8,CUBEUV_TEXEL_WIDTH:1/Q,CUBEUV_TEXEL_HEIGHT:1/$,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:Z},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:W}},vertexShader:$Q(),fragmentShader:`
		...
		`,blending:B9,depthTest:!1,depthWrite:!1})}function SK(){return new X9({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$Q(),fragmentShader:`
		...
		`,blending:B9,depthTest:!1,depthWrite:!1})}function jK(){return new X9({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$Q(),fragmentShader:`
		...
		`,blending:B9,depthTest:!1,depthWrite:!1})}function $Q(){return`
	...
	`}class zZ extends Y9{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},Z=[$,$,$,$,$,$];this.texture=new l6(Z),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},Z=new jJ(5,5,5),W=new X9({name:"CubemapFromEquirect",uniforms:_8($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,side:uJ,blending:B9});W.uniforms.tEquirect.value=Q;let K=new i0(Z,W),Y=Q.minFilter;if(Q.minFilter===q8)Q.minFilter=nJ;return new HZ(1,10,this).update(J,K),Q.minFilter=Y,K.geometry.dispose(),K.material.dispose(),this}clear(J,Q=!0,$=!0,Z=!0){let W=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear(Q,$,Z);J.setRenderTarget(W)}}function z5(J){let Q=new WeakMap,$=new WeakMap,Z=null;function W(q,F=!1){if(q===null||q===void 0)return null;if(F)return Y(q);return K(q)}function K(q){if(q&&q.isTexture){let F=q.mapping;if(F===A6||F===P6)if(Q.has(q)){let R=Q.get(q).texture;return X(R,q.mapping)}else{let R=q.image;if(R&&R.height>0){let B=new zZ(R.height);return B.fromEquirectangularTexture(J,q),Q.set(q,B),q.addEventListener("dispose",U),X(B.texture,q.mapping)}else return null}}return q}function Y(q){if(q&&q.isTexture){let F=q.mapping,R=F===A6||F===P6,B=F===J7||F===N8;if(R||B){let E=$.get(q),D=E!==void 0?E.texture.pmremVersion:0;if(q.isRenderTargetTexture&&q.pmremVersion!==D){if(Z===null)Z=new VZ(J);return E=R?Z.fromEquirectangular(q,E):Z.fromCubemap(q,E),E.texture.pmremVersion=q.pmremVersion,$.set(q,E),E.texture}else if(E!==void 0)return E.texture;else{let O=q.image;if(R&&O&&O.height>0||B&&O&&H(O)){if(Z===null)Z=new VZ(J);return E=R?Z.fromEquirectangular(q):Z.fromCubemap(q),E.texture.pmremVersion=q.pmremVersion,$.set(q,E),q.addEventListener("dispose",N),E.texture}else return null}}}return q}function X(q,F){if(F===A6)q.mapping=J7;else if(F===P6)q.mapping=N8;return q}function H(q){let F=0,R=6;for(let B=0;B<R;B++)if(q[B]!==void 0)F++;return F===R}function U(q){let F=q.target;F.removeEventListener("dispose",U);let R=Q.get(F);if(R!==void 0)Q.delete(F),R.dispose()}function N(q){let F=q.target;F.removeEventListener("dispose",N);let R=$.get(F);if(R!==void 0)$.delete(F),R.dispose()}function G(){if(Q=new WeakMap,$=new WeakMap,Z!==null)Z.dispose(),Z=null}return{get:W,dispose:G}}function k5(J){let Q={};function $(Z){if(Q[Z]!==void 0)return Q[Z];let W=J.getExtension(Z);return Q[Z]=W,W}return{has:function(Z){return $(Z)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(Z){let W=$(Z);if(W===null)k6("WebGLRenderer: "+Z+" extension not supported.");return W}}}function I5(J,Q,$,Z){let W={},K=new WeakMap;function Y(G){let q=G.target;if(q.index!==null)Q.remove(q.index);for(let R in q.attributes)Q.remove(q.attributes[R]);q.removeEventListener("dispose",Y),delete W[q.id];let F=K.get(q);if(F)Q.remove(F),K.delete(q);if(Z.releaseStatesOfGeometry(q),q.isInstancedBufferGeometry===!0)delete q._maxInstanceCount;$.memory.geometries--}function X(G,q){if(W[q.id]===!0)return q;return q.addEventListener("dispose",Y),W[q.id]=!0,$.memory.geometries++,q}function H(G){let q=G.attributes;for(let F in q)Q.update(q[F],J.ARRAY_BUFFER)}function U(G){let q=[],F=G.index,R=G.attributes.position,B=0;if(R===void 0)return;if(F!==null){let O=F.array;B=F.version;for(let V=0,z=O.length;V<z;V+=3){let A=O[V+0],P=O[V+1],w=O[V+2];q.push(A,P,P,w,w,A)}}else{let O=R.array;B=R.version;for(let V=0,z=O.length/3-1;V<z;V+=3){let A=V+0,P=V+1,w=V+2;q.push(A,P,P,w,w,A)}}let E=new(R.count>=65535?m6:p6)(q,1);E.version=B;let D=K.get(G);if(D)Q.remove(D);K.set(G,E)}function N(G){let q=K.get(G);if(q){let F=G.index;if(F!==null){if(q.version<F.version)U(G)}}else U(G);return K.get(G)}return{get:X,update:H,getWireframeAttribute:N}}function A5(J,Q,$){let Z;function W(G){Z=G}let K,Y;function X(G){K=G.type,Y=G.bytesPerElement}function H(G,q){J.drawElements(Z,q,K,G*Y),$.update(q,Z,1)}function U(G,q,F){if(F===0)return;J.drawElementsInstanced(Z,q,K,G*Y,F),$.update(q,Z,F)}function N(G,q,F){if(F===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(Z,q,0,K,G,0,F);let B=0;for(let E=0;E<F;E++)B+=q[E];$.update(B,Z,1)}this.setMode=W,this.setIndex=X,this.render=H,this.renderInstances=U,this.renderMultiDraw=N}function P5(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function Z(K,Y,X){switch($.calls++,Y){case J.TRIANGLES:$.triangles+=X*(K/3);break;case J.LINES:$.lines+=X*(K/2);break;case J.LINE_STRIP:$.lines+=X*(K-1);break;case J.LINE_LOOP:$.lines+=X*K;break;case J.POINTS:$.points+=X*K;break;default:w0("WebGLInfo: Unknown draw mode:",Y);break}}function W(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:W,update:Z}}function C5(J,Q,$){let Z=new WeakMap,W=new EJ;function K(Y,X,H){let U=Y.morphTargetInfluences,N=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,G=N!==void 0?N.length:0,q=Z.get(X);if(q===void 0||q.count!==G){let k=function(){w.dispose(),Z.delete(X),X.removeEventListener("dispose",k)};if(q!==void 0)q.texture.dispose();let F=X.morphAttributes.position!==void 0,R=X.morphAttributes.normal!==void 0,B=X.morphAttributes.color!==void 0,E=X.morphAttributes.position||[],D=X.morphAttributes.normal||[],O=X.morphAttributes.color||[],V=0;if(F===!0)V=1;if(R===!0)V=2;if(B===!0)V=3;let z=X.attributes.position.count*V,A=1;if(z>Q.maxTextureSize)A=Math.ceil(z/Q.maxTextureSize),z=Q.maxTextureSize;let P=new Float32Array(z*A*4*G),w=new b6(P,z,A,G);w.type=p9,w.needsUpdate=!0;let _=V*4;for(let l=0;l<G;l++){let C=E[l],m=D[l],c=O[l],f=z*A*4*l;for(let d=0;d<C.count;d++){let b=d*_;if(F===!0)W.fromBufferAttribute(C,d),P[f+b+0]=W.x,P[f+b+1]=W.y,P[f+b+2]=W.z,P[f+b+3]=0;if(R===!0)W.fromBufferAttribute(m,d),P[f+b+4]=W.x,P[f+b+5]=W.y,P[f+b+6]=W.z,P[f+b+7]=0;if(B===!0)W.fromBufferAttribute(c,d),P[f+b+8]=W.x,P[f+b+9]=W.y,P[f+b+10]=W.z,P[f+b+11]=c.itemSize===4?W.w:1}}q={count:G,texture:w,size:new B0(z,A)},Z.set(X,q),X.addEventListener("dispose",k)}if(Y.isInstancedMesh===!0&&Y.morphTexture!==null)H.getUniforms().setValue(J,"morphTexture",Y.morphTexture,$);else{let F=0;for(let B=0;B<U.length;B++)F+=U[B];let R=X.morphTargetsRelative?1:1-F;H.getUniforms().setValue(J,"morphTargetBaseInfluence",R),H.getUniforms().setValue(J,"morphTargetInfluences",U)}H.getUniforms().setValue(J,"morphTargetsTexture",q.texture,$),H.getUniforms().setValue(J,"morphTargetsTextureSize",q.size)}return{update:K}}function w5(J,Q,$,Z,W){let K=new WeakMap;function Y(U){let N=W.render.frame,G=U.geometry,q=Q.get(U,G);if(K.get(q)!==N)Q.update(q),K.set(q,N);if(U.isInstancedMesh){if(U.hasEventListener("dispose",H)===!1)U.addEventListener("dispose",H);if(K.get(U)!==N){if($.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)$.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,N)}}if(U.isSkinnedMesh){let F=U.skeleton;if(K.get(F)!==N)F.update(),K.set(F,N)}return q}function X(){K=new WeakMap}function H(U){let N=U.target;if(N.removeEventListener("dispose",H),Z.releaseStatesOfObject(N),$.remove(N.instanceMatrix),N.instanceColor!==null)$.remove(N.instanceColor)}return{update:Y,dispose:X}}var T5={[nQ]:"LINEAR_TONE_MAPPING",[sQ]:"REINHARD_TONE_MAPPING",[iQ]:"CINEON_TONE_MAPPING",[oQ]:"ACES_FILMIC_TONE_MAPPING",[rQ]:"AGX_TONE_MAPPING",[tQ]:"NEUTRAL_TONE_MAPPING",[aQ]:"CUSTOM_TONE_MAPPING"};function S5(J,Q,$,Z,W){let K=new Y9(Q,$,{type:J,depthBuffer:Z,stencilBuffer:W,depthTexture:Z?new $8(Q,$):void 0}),Y=new Y9(Q,$,{type:m9,depthBuffer:!1,stencilBuffer:!1}),X=new sJ;X.setAttribute("position",new zJ([-1,3,0,-1,-1,0,3,-1,0],3)),X.setAttribute("uv",new zJ([0,2,0,0,2,0],2));let H=new o$({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),U=new i0(X,H),N=new m7(-1,1,1,-1,0,1),G=null,q=null,F=!1,R,B=null,E=[],D=!1;this.setSize=function(O,V){K.setSize(O,V),Y.setSize(O,V);for(let z=0;z<E.length;z++){let A=E[z];if(A.setSize)A.setSize(O,V)}},this.setEffects=function(O){E=O,D=E.length>0&&E[0].isRenderPass===!0;let{width:V,height:z}=K;for(let A=0;A<E.length;A++){let P=E[A];if(P.setSize)P.setSize(V,z)}},this.begin=function(O,V){if(F)return!1;if(O.toneMapping===R9&&E.length===0)return!1;if(B=V,V!==null){let{width:z,height:A}=V;if(K.width!==z||K.height!==A)this.setSize(z,A)}if(D===!1)O.setRenderTarget(K);return R=O.toneMapping,O.toneMapping=R9,!0},this.hasRenderPass=function(){return D},this.end=function(O,V){O.toneMapping=R,F=!0;let z=K,A=Y;for(let P=0;P<E.length;P++){let w=E[P];if(w.enabled===!1)continue;if(w.render(O,A,z,V),w.needsSwap!==!1){let _=z;z=A,A=_}}if(G!==O.outputColorSpace||q!==O.toneMapping){if(G=O.outputColorSpace,q=O.toneMapping,H.defines={},c0.getTransfer(G)===UJ)H.defines.SRGB_TRANSFER="";let P=T5[q];if(P)H.defines[P]="";H.needsUpdate=!0}H.uniforms.tDiffuse.value=z.texture,O.setRenderTarget(B),O.render(U,N),B=null,F=!1},this.isCompositing=function(){return F},this.dispose=function(){if(K.depthTexture)K.depthTexture.dispose();K.dispose(),Y.dispose(),X.dispose(),H.dispose()}}var tK=new wJ,LZ=new $8(1,1),eK=new b6,JY=new u$,QY=new l6,yK=[],fK=[],vK=new Float32Array(16),hK=new Float32Array(9),xK=new Float32Array(4);function Y7(J,Q,$){let Z=J[0];if(Z<=0||Z>0)return J;let W=Q*$,K=yK[W];if(K===void 0)K=new Float32Array(W),yK[W]=K;if(Q!==0){Z.toArray(K,0);for(let Y=1,X=0;Y!==Q;++Y)X+=$,J[Y].toArray(K,X)}return K}function IJ(J,Q){if(J.length!==Q.length)return!1;for(let $=0,Z=J.length;$<Z;$++)if(J[$]!==Q[$])return!1;return!0}function AJ(J,Q){for(let $=0,Z=Q.length;$<Z;$++)J[$]=Q[$]}function ZQ(J,Q){let $=fK[Q];if($===void 0)$=new Int32Array(Q),fK[Q]=$;for(let Z=0;Z!==Q;++Z)$[Z]=J.allocateTextureUnit();return $}function j5(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1f(this.addr,Q),$[0]=Q}function y5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2f(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(IJ($,Q))return;J.uniform2fv(this.addr,Q),AJ($,Q)}}function f5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3f(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else if(Q.r!==void 0){if($[0]!==Q.r||$[1]!==Q.g||$[2]!==Q.b)J.uniform3f(this.addr,Q.r,Q.g,Q.b),$[0]=Q.r,$[1]=Q.g,$[2]=Q.b}else{if(IJ($,Q))return;J.uniform3fv(this.addr,Q),AJ($,Q)}}function v5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4f(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(IJ($,Q))return;J.uniform4fv(this.addr,Q),AJ($,Q)}}function h5(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(IJ($,Q))return;J.uniformMatrix2fv(this.addr,!1,Q),AJ($,Q)}else{if(IJ($,Z))return;xK.set(Z),J.uniformMatrix2fv(this.addr,!1,xK),AJ($,Z)}}function x5(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(IJ($,Q))return;J.uniformMatrix3fv(this.addr,!1,Q),AJ($,Q)}else{if(IJ($,Z))return;hK.set(Z),J.uniformMatrix3fv(this.addr,!1,hK),AJ($,Z)}}function b5(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(IJ($,Q))return;J.uniformMatrix4fv(this.addr,!1,Q),AJ($,Q)}else{if(IJ($,Z))return;vK.set(Z),J.uniformMatrix4fv(this.addr,!1,vK),AJ($,Z)}}function g5(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1i(this.addr,Q),$[0]=Q}function p5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2i(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(IJ($,Q))return;J.uniform2iv(this.addr,Q),AJ($,Q)}}function m5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3i(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(IJ($,Q))return;J.uniform3iv(this.addr,Q),AJ($,Q)}}function l5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4i(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(IJ($,Q))return;J.uniform4iv(this.addr,Q),AJ($,Q)}}function d5(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1ui(this.addr,Q),$[0]=Q}function u5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2ui(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(IJ($,Q))return;J.uniform2uiv(this.addr,Q),AJ($,Q)}}function c5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3ui(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(IJ($,Q))return;J.uniform3uiv(this.addr,Q),AJ($,Q)}}function n5(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4ui(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(IJ($,Q))return;J.uniform4uiv(this.addr,Q),AJ($,Q)}}function s5(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;let K;if(this.type===J.SAMPLER_2D_SHADOW)LZ.compareFunction=$.isReversedDepthBuffer()?x6:h6,K=LZ;else K=tK;$.setTexture2D(Q||K,W)}function i5(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTexture3D(Q||JY,W)}function o5(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTextureCube(Q||QY,W)}function a5(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTexture2DArray(Q||eK,W)}function r5(J){switch(J){case 5126:return j5;case 35664:return y5;case 35665:return f5;case 35666:return v5;case 35674:return h5;case 35675:return x5;case 35676:return b5;case 5124:case 35670:return g5;case 35667:case 35671:return p5;case 35668:case 35672:return m5;case 35669:case 35673:return l5;case 5125:return d5;case 36294:return u5;case 36295:return c5;case 36296:return n5;case 35678:case 36198:case 36298:case 36306:case 35682:return s5;case 35679:case 36299:case 36307:return i5;case 35680:case 36300:case 36308:case 36293:return o5;case 36289:case 36303:case 36311:case 36292:return a5}}function t5(J,Q){J.uniform1fv(this.addr,Q)}function e5(J,Q){let $=Y7(Q,this.size,2);J.uniform2fv(this.addr,$)}function JG(J,Q){let $=Y7(Q,this.size,3);J.uniform3fv(this.addr,$)}function QG(J,Q){let $=Y7(Q,this.size,4);J.uniform4fv(this.addr,$)}function $G(J,Q){let $=Y7(Q,this.size,4);J.uniformMatrix2fv(this.addr,!1,$)}function ZG(J,Q){let $=Y7(Q,this.size,9);J.uniformMatrix3fv(this.addr,!1,$)}function WG(J,Q){let $=Y7(Q,this.size,16);J.uniformMatrix4fv(this.addr,!1,$)}function KG(J,Q){J.uniform1iv(this.addr,Q)}function YG(J,Q){J.uniform2iv(this.addr,Q)}function XG(J,Q){J.uniform3iv(this.addr,Q)}function HG(J,Q){J.uniform4iv(this.addr,Q)}function UG(J,Q){J.uniform1uiv(this.addr,Q)}function GG(J,Q){J.uniform2uiv(this.addr,Q)}function NG(J,Q){J.uniform3uiv(this.addr,Q)}function qG(J,Q){J.uniform4uiv(this.addr,Q)}function FG(J,Q,$){let Z=this.cache,W=Q.length,K=ZQ($,W);if(!IJ(Z,K))J.uniform1iv(this.addr,K),AJ(Z,K);let Y;if(this.type===J.SAMPLER_2D_SHADOW)Y=LZ;else Y=tK;for(let X=0;X!==W;++X)$.setTexture2D(Q[X]||Y,K[X])}function DG(J,Q,$){let Z=this.cache,W=Q.length,K=ZQ($,W);if(!IJ(Z,K))J.uniform1iv(this.addr,K),AJ(Z,K);for(let Y=0;Y!==W;++Y)$.setTexture3D(Q[Y]||JY,K[Y])}function EG(J,Q,$){let Z=this.cache,W=Q.length,K=ZQ($,W);if(!IJ(Z,K))J.uniform1iv(this.addr,K),AJ(Z,K);for(let Y=0;Y!==W;++Y)$.setTextureCube(Q[Y]||QY,K[Y])}function RG(J,Q,$){let Z=this.cache,W=Q.length,K=ZQ($,W);if(!IJ(Z,K))J.uniform1iv(this.addr,K),AJ(Z,K);for(let Y=0;Y!==W;++Y)$.setTexture2DArray(Q[Y]||eK,K[Y])}function OG(J){switch(J){case 5126:return t5;case 35664:return e5;case 35665:return JG;case 35666:return QG;case 35674:return $G;case 35675:return ZG;case 35676:return WG;case 5124:case 35670:return KG;case 35667:case 35671:return YG;case 35668:case 35672:return XG;case 35669:case 35673:return HG;case 5125:return UG;case 36294:return GG;case 36295:return NG;case 36296:return qG;case 35678:case 36198:case 36298:case 36306:case 35682:return FG;case 35679:case 36299:case 36307:return DG;case 35680:case 36300:case 36308:case 36293:return EG;case 36289:case 36303:case 36311:case 36292:return RG}}class $Y{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.setValue=r5(Q.type)}}class ZY{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.size=Q.size,this.setValue=OG(Q.type)}}class WY{constructor(J){this.id=J,this.seq=[],this.map={}}setValue(J,Q,$){let Z=this.seq;for(let W=0,K=Z.length;W!==K;++W){let Y=Z[W];Y.setValue(J,Q[Y.id],$)}}}var MZ=/(\w+)(\])?(\[|\.)?/g;function bK(J,Q){J.seq.push(Q),J.map[Q.id]=Q}function MG(J,Q,$){let Z=J.name,W=Z.length;MZ.lastIndex=0;while(!0){let K=MZ.exec(Z),Y=MZ.lastIndex,X=K[1],H=K[2]==="]",U=K[3];if(H)X=X|0;if(U===void 0||U==="["&&Y+2===W){bK($,U===void 0?new $Y(X,J,Q):new ZY(X,J,Q));break}else{let G=$.map[X];if(G===void 0)G=new WY(X),bK($,G);$=G}}}class n7{constructor(J,Q){this.seq=[],this.map={};let $=J.getProgramParameter(Q,J.ACTIVE_UNIFORMS);for(let K=0;K<$;++K){let Y=J.getActiveUniform(Q,K),X=J.getUniformLocation(Q,Y.name);MG(Y,X,this)}let Z=[],W=[];for(let K of this.seq)if(K.type===J.SAMPLER_2D_SHADOW||K.type===J.SAMPLER_CUBE_SHADOW||K.type===J.SAMPLER_2D_ARRAY_SHADOW)Z.push(K);else W.push(K);if(Z.length>0)this.seq=Z.concat(W)}setValue(J,Q,$,Z){let W=this.map[Q];if(W!==void 0)W.setValue(J,$,Z)}setOptional(J,Q,$){let Z=Q[$];if(Z!==void 0)this.setValue(J,$,Z)}static upload(J,Q,$,Z){for(let W=0,K=Q.length;W!==K;++W){let Y=Q[W],X=$[Y.id];if(X.needsUpdate!==!1)Y.setValue(J,X.value,Z)}}static seqWithValue(J,Q){let $=[];for(let Z=0,W=J.length;Z!==W;++Z){let K=J[Z];if(K.id in Q)$.push(K)}return $}}function gK(J,Q,$){let Z=J.createShader(Q);return J.shaderSource(Z,$),J.compileShader(Z),Z}var _G=37297,VG=0;function LG(J,Q){let $=J.split(`
`),Z=[],W=Math.max(Q-6,0),K=Math.min(Q+6,$.length);for(let Y=W;Y<K;Y++){let X=Y+1;Z.push(`${X===Q?">":" "} ${X}: ${$[Y]}`)}return Z.join(`
`)}var pK=new j0;function BG(J){c0._getMatrix(pK,c0.workingColorSpace,J);let Q=`mat3( ${pK.elements.map(($)=>$.toFixed(4))} )`;switch(c0.getTransfer(J)){case x$:return[Q,"LinearTransferOETF"];case UJ:return[Q,"sRGBTransferOETF"];default:return A0("WebGLProgram: Unsupported color space: ",J),[Q,"LinearTransferOETF"]}}function mK(J,Q,$){let Z=J.getShaderParameter(Q,J.COMPILE_STATUS),K=(J.getShaderInfoLog(Q)||"").trim();if(Z&&K==="")return"";let Y=/ERROR: 0:(\d+)/.exec(K);if(Y){let X=parseInt(Y[1]);return $.toUpperCase()+`

`+K+`

`+LG(J.getShaderSource(Q),X)}else return K}function zG(J,Q){let $=BG(Q);return[`vec4 ${J}( vec4 value ) {`,`	return ${$[1]}( vec4( value.rgb * ${$[0]}, value.a ) );`,"}"].join(`
`)}var kG={[nQ]:"Linear",[sQ]:"Reinhard",[iQ]:"Cineon",[oQ]:"ACESFilmic",[rQ]:"AgX",[tQ]:"Neutral",[aQ]:"Custom"};function IG(J,Q){let $=kG[Q];if($===void 0)return A0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var QQ=new j;function AG(){c0.getLuminanceCoefficients(QQ);let J=QQ.x.toFixed(4),Q=QQ.y.toFixed(4),$=QQ.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
`)}function PG(J){return[J.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",J.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(c7).join(`
`)}function CG(J){let Q=[];for(let $ in J){let Z=J[$];if(Z===!1)continue;Q.push("#define "+$+" "+Z)}return Q.join(`
`)}function wG(J,Q){let $={},Z=J.getProgramParameter(Q,J.ACTIVE_ATTRIBUTES);for(let W=0;W<Z;W++){let K=J.getActiveAttrib(Q,W),Y=K.name,X=1;if(K.type===J.FLOAT_MAT2)X=2;if(K.type===J.FLOAT_MAT3)X=3;if(K.type===J.FLOAT_MAT4)X=4;$[Y]={type:K.type,location:J.getAttribLocation(Q,Y),locationSize:X}}return $}function c7(J){return J!==""}function lK(J,Q){let $=Q.numSpotLightShadows+Q.numSpotLightMaps-Q.numSpotLightShadowsWithMaps;return J.replace(/NUM_DIR_LIGHTS/g,Q.numDirLights).replace(/NUM_SPOT_LIGHTS/g,Q.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,Q.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,$).replace(/NUM_RECT_AREA_LIGHTS/g,Q.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,Q.numPointLights).replace(/NUM_HEMI_LIGHTS/g,Q.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,Q.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,Q.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,Q.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,Q.numPointLightShadows)}function dK(J,Q){return J.replace(/NUM_CLIPPING_PLANES/g,Q.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,Q.numClippingPlanes-Q.numClipIntersection)}var TG=/^[ \t]*#include +<([\w\d./]+)>/gm;function BZ(J){return J.replace(TG,jG)}var SG=new Map;function jG(J,Q){let $=b0[Q];if($===void 0){let Z=SG.get(Q);if(Z!==void 0)$=b0[Z],A0('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',Q,Z);else throw Error("Can not resolve #include <"+Q+">")}return BZ($)}var yG=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function uK(J){return J.replace(yG,fG)}function fG(J,Q,$,Z){let W="";for(let K=parseInt(Q);K<parseInt($);K++)W+=Z.replace(/\[\s*i\s*\]/g,"[ "+K+" ]").replace(/UNROLLED_LOOP_INDEX/g,K);return W}function cK(J){let Q=`precision ${J.precision} float;
...
#define LOW_PRECISION`;return Q}var vG={[z7]:"SHADOWMAP_TYPE_PCF",[r8]:"SHADOWMAP_TYPE_VSM"};function hG(J){return vG[J.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var xG={[J7]:"ENVMAP_TYPE_CUBE",[N8]:"ENVMAP_TYPE_CUBE",[A7]:"ENVMAP_TYPE_CUBE_UV"};function bG(J){if(J.envMap===!1)return"ENVMAP_TYPE_CUBE";return xG[J.envMapMode]||"ENVMAP_TYPE_CUBE"}var gG={[N8]:"ENVMAP_MODE_REFRACTION"};function pG(J){if(J.envMap===!1)return"ENVMAP_MODE_REFLECTION";return gG[J.envMapMode]||"ENVMAP_MODE_REFLECTION"}var mG={[rW]:"ENVMAP_BLENDING_MULTIPLY",[tW]:"ENVMAP_BLENDING_MIX",[eW]:"ENVMAP_BLENDING_ADD"};function lG(J){if(J.envMap===!1)return"ENVMAP_BLENDING_NONE";return mG[J.combine]||"ENVMAP_BLENDING_NONE"}function dG(J){let Q=J.envMapCubeUVHeight;if(Q===null)return null;let $=Math.log2(Q)-2,Z=1/Q;return{texelWidth:1/(3*Math.max(Math.pow(2,$),112)),texelHeight:Z,maxMip:$}}function uG(J,Q,$,Z){let W=J.getContext(),K=$.defines,Y=$.vertexShader,X=$.fragmentShader,H=hG($),U=bG($),N=pG($),G=lG($),q=dG($),F=PG($),R=CG(K),B=W.createProgram(),E,D,O=$.glslVersion?"#version "+$.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class XY{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(J,Q){if(this.texture===null){let $=new d6(J.texture);if(J.depthNear!==Q.depthNear||J.depthFar!==Q.depthFar)this.depthNear=J.depthNear,this.depthFar=J.depthFar;this.texture=$}}getMesh(J){if(this.texture!==null){if(this.mesh===null){let Q=J.cameras[0].viewport,$=new X9({vertexShader:NN,fragmentShader:qN,uniforms:{depthColor:{value:this.texture},depthWidth:{value:Q.z},depthHeight:{value:Q.w}}});this.mesh=new i0(new A9(20,20),$)}}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class HY extends k9{constructor(J,Q){super();let $=this,Z=null,W=1,K=null,Y="local-floor",X=1,H=null,U=null,N=null,G=null,q=null,F=null,R=typeof XRWebGLBinding<"u",B=new XY,E={},D=Q.getContextAttributes(),O=null,V=null,z=[],A=[],P=new B0,w=null,_=new mJ;_.viewport=new EJ;let k=new mJ;k.viewport=new EJ;let l=[_,k],C=new UZ,m=null,c=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(s){let N0=z[s];if(N0===void 0)N0=new j7,z[s]=N0;return N0.getTargetRaySpace()},this.getControllerGrip=function(s){let N0=z[s];if(N0===void 0)N0=new j7,z[s]=N0;return N0.getGripSpace()},this.getHand=function(s){let N0=z[s];if(N0===void 0)N0=new j7,z[s]=N0;return N0.getHandSpace()};function f(s){let N0=A.indexOf(s.inputSource);if(N0===-1)return;let V0=z[N0];if(V0!==void 0)V0.update(s.inputSource,s.frame,H||K),V0.dispatchEvent({type:s.type,data:s.inputSource})}function d(){Z.removeEventListener("select",f),Z.removeEventListener("selectstart",f),Z.removeEventListener("selectend",f),Z.removeEventListener("squeeze",f),Z.removeEventListener("squeezestart",f),Z.removeEventListener("squeezeend",f),Z.removeEventListener("end",d),Z.removeEventListener("inputsourceschange",b);for(let s=0;s<z.length;s++){let N0=A[s];if(N0===null)continue;A[s]=null,z[s].disconnect(N0)}m=null,c=null,B.reset();for(let s in E)delete E[s];J.setRenderTarget(O),q=null,G=null,N=null,Z=null,V=null,d0.stop(),$.isPresenting=!1,J.setPixelRatio(w),J.setSize(P.width,P.height,!1),$.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(s){if(W=s,$.isPresenting===!0)A0("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(s){if(Y=s,$.isPresenting===!0)A0("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return H||K},this.setReferenceSpace=function(s){H=s},this.getBaseLayer=function(){return G!==null?G:q},this.getBinding=function(){if(N===null&&R)N=new XRWebGLBinding(Z,Q);return N},this.getFrame=function(){return F},this.getSession=function(){return Z},this.setSession=async function(s){if(Z=s,Z!==null){if(O=J.getRenderTarget(),Z.addEventListener("select",f),Z.addEventListener("selectstart",f),Z.addEventListener("selectend",f),Z.addEventListener("squeeze",f),Z.addEventListener("squeezestart",f),Z.addEventListener("squeezeend",f),Z.addEventListener("end",d),Z.addEventListener("inputsourceschange",b),D.xrCompatible!==!0)await Q.makeXRCompatible();if(w=J.getPixelRatio(),J.getSize(P),!(R&&("createProjectionLayer"in XRWebGLBinding.prototype))){let V0={antialias:D.antialias,alpha:!0,depth:D.depth,stencil:D.stencil,framebufferScaleFactor:W};q=new XRWebGLLayer(Z,Q,V0),Z.updateRenderState({baseLayer:q}),J.setPixelRatio(1),J.setSize(q.framebufferWidth,q.framebufferHeight,!1),V=new Y9(q.framebufferWidth,q.framebufferHeight,{format:z9,type:O9,colorSpace:J.outputColorSpace,stencilBuffer:D.stencil,resolveDepthBuffer:q.ignoreDepthValues===!1,resolveStencilBuffer:q.ignoreDepthValues===!1})}else{let V0=null,q0=null,P0=null;if(D.depth)P0=D.stencil?Q.DEPTH24_STENCIL8:Q.DEPTH_COMPONENT24,V0=D.stencil?D8:F8,q0=D.stencil?Q7:J8;let t0={colorFormat:Q.RGBA8,depthFormat:P0,scaleFactor:W};N=this.getBinding(),G=N.createProjectionLayer(t0),Z.updateRenderState({layers:[G]}),J.setPixelRatio(1),J.setSize(G.textureWidth,G.textureHeight,!1),V=new Y9(G.textureWidth,G.textureHeight,{format:z9,type:O9,depthTexture:new $8(G.textureWidth,G.textureHeight,q0,void 0,void 0,void 0,void 0,void 0,void 0,V0),stencilBuffer:D.stencil,colorSpace:J.outputColorSpace,samples:D.antialias?4:0,resolveDepthBuffer:G.ignoreDepthValues===!1,resolveStencilBuffer:G.ignoreDepthValues===!1})}V.isXRRenderTarget=!0,this.setFoveation(X),H=null,K=await Z.requestReferenceSpace(Y),d0.setContext(Z),d0.start(),$.isPresenting=!0,$.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(Z!==null)return Z.environmentBlendMode},this.getDepthTexture=function(){return B.getDepthTexture()};function b(s){for(let N0=0;N0<s.removed.length;N0++){let V0=s.removed[N0],q0=A.indexOf(V0);if(q0>=0)A[q0]=null,z[q0].disconnect(V0)}for(let N0=0;N0<s.added.length;N0++){let V0=s.added[N0],q0=A.indexOf(V0);if(q0===-1){for(let t0=0;t0<z.length;t0++)if(t0>=A.length){A.push(V0),q0=t0;break}else if(A[t0]===null){A[t0]=V0,q0=t0;break}if(q0===-1)break}let P0=z[q0];if(P0)P0.connect(V0)}}let p=new j,a=new j;function Q0(s,N0,V0){p.setFromMatrixPosition(N0.matrixWorld),a.setFromMatrixPosition(V0.matrixWorld);let q0=p.distanceTo(a),P0=N0.projectionMatrix.elements,t0=V0.projectionMatrix.elements,g0=P0[14]/(P0[10]-1),u0=P0[14]/(P0[10]+1),KJ=(P0[9]+1)/P0[5],YJ=(P0[9]-1)/P0[5],h0=(P0[8]-1)/P0[0],SJ=(t0[8]+1)/t0[0],yJ=g0*h0,VJ=g0*SJ,S=q0/(-h0+SJ),gJ=S*-h0;if(N0.matrixWorld.decompose(s.position,s.quaternion,s.scale),s.translateX(gJ),s.translateZ(S),s.matrixWorld.compose(s.position,s.quaternion,s.scale),s.matrixWorldInverse.copy(s.matrixWorld).invert(),P0[10]===-1)s.projectionMatrix.copy(N0.projectionMatrix),s.projectionMatrixInverse.copy(N0.projectionMatrixInverse);else{let n0=g0+S,a0=u0+S,U0=yJ-gJ,DJ=VJ+(q0-gJ),C0=KJ*u0/a0*n0,I=YJ*u0/a0*n0;s.projectionMatrix.makePerspective(U0,DJ,C0,I,n0,a0),s.projectionMatrixInverse.copy(s.projectionMatrix).invert()}}function F0(s,N0){if(N0===null)s.matrixWorld.copy(s.matrix);else s.matrixWorld.multiplyMatrices(N0.matrixWorld,s.matrix);s.matrixWorldInverse.copy(s.matrixWorld).invert()}this.updateCamera=function(s){if(Z===null)return;let{near:N0,far:V0}=s;if(B.texture!==null){if(B.depthNear>0)N0=B.depthNear;if(B.depthFar>0)V0=B.depthFar}if(C.near=k.near=_.near=N0,C.far=k.far=_.far=V0,m!==C.near||c!==C.far)Z.updateRenderState({depthNear:C.near,depthFar:C.far}),m=C.near,c=C.far;C.layers.mask=s.layers.mask|6,_.layers.mask=C.layers.mask&-5,k.layers.mask=C.layers.mask&-3;let q0=s.parent,P0=C.cameras;F0(C,q0);for(let t0=0;t0<P0.length;t0++)F0(P0[t0],q0);if(P0.length===2)Q0(C,_,k);else C.projectionMatrix.copy(_.projectionMatrix);I0(s,C,q0)};function I0(s,N0,V0){if(V0===null)s.matrix.copy(N0.matrixWorld);else s.matrix.copy(V0.matrixWorld),s.matrix.invert(),s.matrix.multiply(N0.matrixWorld);if(s.matrix.decompose(s.position,s.quaternion,s.scale),s.updateMatrixWorld(!0),s.projectionMatrix.copy(N0.projectionMatrix),s.projectionMatrixInverse.copy(N0.projectionMatrixInverse),s.isPerspectiveCamera)s.fov=a8*2*Math.atan(1/s.projectionMatrix.elements[5]),s.zoom=1}this.getCamera=function(){return C},this.getFoveation=function(){if(G===null&&q===null)return;return X},this.setFoveation=function(s){if(X=s,G!==null)G.fixedFoveation=s;if(q!==null&&q.fixedFoveation!==void 0)q.fixedFoveation=s},this.hasDepthSensing=function(){return B.texture!==null},this.getDepthSensingMesh=function(){return B.getMesh(C)},this.getCameraTexture=function(s){return E[s]};let M0=null;function e0(s,N0){if(U=N0.getViewerPose(H||K),F=N0,U!==null){let V0=U.views;if(q!==null)J.setRenderTargetFramebuffer(V,q.framebuffer),J.setRenderTarget(V);let q0=!1;if(V0.length!==C.cameras.length)C.cameras.length=0,q0=!0;for(let u0=0;u0<V0.length;u0++){let KJ=V0[u0],YJ=null;if(q!==null)YJ=q.getViewport(KJ);else{let SJ=N.getViewSubImage(G,KJ);if(YJ=SJ.viewport,u0===0)J.setRenderTargetTextures(V,SJ.colorTexture,SJ.depthStencilTexture),J.setRenderTarget(V)}let h0=l[u0];if(h0===void 0)h0=new mJ,h0.layers.enable(u0),h0.viewport=new EJ,l[u0]=h0;if(h0.matrix.fromArray(KJ.transform.matrix),h0.matrix.decompose(h0.position,h0.quaternion,h0.scale),h0.projectionMatrix.fromArray(KJ.projectionMatrix),h0.projectionMatrixInverse.copy(h0.projectionMatrix).invert(),h0.viewport.set(YJ.x,YJ.y,YJ.width,YJ.height),u0===0)C.matrix.copy(h0.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale);if(q0===!0)C.cameras.push(h0)}let P0=Z.enabledFeatures;if(P0&&P0.includes("depth-sensing")&&Z.depthUsage=="gpu-optimized"&&R){N=$.getBinding();let u0=N.getDepthInformation(V0[0]);if(u0&&u0.isValid&&u0.texture)B.init(u0,Z.renderState)}if(P0&&P0.includes("camera-access")&&R){J.state.unbindTexture(),N=$.getBinding();for(let u0=0;u0<V0.length;u0++){let KJ=V0[u0].camera;if(KJ){let YJ=E[KJ];if(!YJ)YJ=new d6,E[KJ]=YJ;let h0=N.getCameraImage(KJ);YJ.sourceTexture=h0}}}}for(let V0=0;V0<z.length;V0++){let q0=A[V0],P0=z[V0];if(q0!==null&&P0!==void 0)P0.update(q0,N0,H||K)}if(M0)M0(s,N0);if(N0.detectedPlanes)$.dispatchEvent({type:"planesdetected",data:N0});F=null}let d0=new aK;d0.setAnimationLoop(e0),this.setAnimationLoop=function(s){M0=s},this.dispose=function(){}}}var FN=new FJ,UY=new j0;UY.set(-1,0,0,0,1,0,0,0,1);function DN(J,Q){function $(E,D){if(E.matrixAutoUpdate===!0)E.updateMatrix();D.value.copy(E.matrix)}function Z(E,D){if(D.color.getRGB(E.fogColor.value,i$(J)),D.isFog)E.fogNear.value=D.near,E.fogFar.value=D.far;else if(D.isFogExp2)E.fogDensity.value=D.density}function W(E,D,O,V,z){if(D.isNodeMaterial)D.uniformsNeedUpdate=!1;else if(D.isMeshBasicMaterial)K(E,D);else if(D.isMeshLambertMaterial){if(K(E,D),D.envMap)E.envMapIntensity.value=D.envMapIntensity}else if(D.isMeshToonMaterial)K(E,D),G(E,D);else if(D.isMeshPhongMaterial){if(K(E,D),N(E,D),D.envMap)E.envMapIntensity.value=D.envMapIntensity}else if(D.isMeshStandardMaterial){if(K(E,D),q(E,D),D.isMeshPhysicalMaterial)F(E,D,z)}else if(D.isMeshMatcapMaterial)K(E,D),R(E,D);else if(D.isMeshDepthMaterial)K(E,D);else if(D.isMeshDistanceMaterial)K(E,D),B(E,D);else if(D.isMeshNormalMaterial)K(E,D);else if(D.isLineBasicMaterial){if(Y(E,D),D.isLineDashedMaterial)X(E,D)}else if(D.isPointsMaterial)H(E,D,O,V);else if(D.isSpriteMaterial)U(E,D);else if(D.isShadowMaterial)E.color.value.copy(D.color),E.opacity.value=D.opacity;else if(D.isShaderMaterial)D.uniformsNeedUpdate=!1}function K(E,D){if(E.opacity.value=D.opacity,D.color)E.diffuse.value.copy(D.color);if(D.emissive)E.emissive.value.copy(D.emissive).multiplyScalar(D.emissiveIntensity);if(D.map)E.map.value=D.map,$(D.map,E.mapTransform);if(D.alphaMap)E.alphaMap.value=D.alphaMap,$(D.alphaMap,E.alphaMapTransform);if(D.bumpMap){if(E.bumpMap.value=D.bumpMap,$(D.bumpMap,E.bumpMapTransform),E.bumpScale.value=D.bumpScale,D.side===uJ)E.bumpScale.value*=-1}if(D.normalMap){if(E.normalMap.value=D.normalMap,$(D.normalMap,E.normalMapTransform),E.normalScale.value.copy(D.normalScale),D.side===uJ)E.normalScale.value.negate()}if(D.displacementMap)E.displacementMap.value=D.displacementMap,$(D.displacementMap,E.displacementMapTransform),E.displacementScale.value=D.displacementScale,E.displacementBias.value=D.displacementBias;if(D.emissiveMap)E.emissiveMap.value=D.emissiveMap,$(D.emissiveMap,E.emissiveMapTransform);if(D.specularMap)E.specularMap.value=D.specularMap,$(D.specularMap,E.specularMapTransform);if(D.alphaTest>0)E.alphaTest.value=D.alphaTest;let O=Q.get(D),V=O.envMap,z=O.envMapRotation;if(V){if(E.envMap.value=V,E.envMapRotation.value.setFromMatrix4(FN.makeRotationFromEuler(z)).transpose(),V.isCubeTexture&&V.isRenderTargetTexture===!1)E.envMapRotation.value.premultiply(UY);E.reflectivity.value=D.reflectivity,E.ior.value=D.ior,E.refractionRatio.value=D.refractionRatio}if(D.lightMap)E.lightMap.value=D.lightMap,E.lightMapIntensity.value=D.lightMapIntensity,$(D.lightMap,E.lightMapTransform);if(D.aoMap)E.aoMap.value=D.aoMap,E.aoMapIntensity.value=D.aoMapIntensity,$(D.aoMap,E.aoMapTransform)}function Y(E,D){if(E.diffuse.value.copy(D.color),E.opacity.value=D.opacity,D.map)E.map.value=D.map,$(D.map,E.mapTransform)}function X(E,D){E.dashSize.value=D.dashSize,E.totalSize.value=D.dashSize+D.gapSize,E.scale.value=D.scale}function H(E,D,O,V){if(E.diffuse.value.copy(D.color),E.opacity.value=D.opacity,E.size.value=D.size*O,E.scale.value=V*0.5,D.map)E.map.value=D.map,$(D.map,E.uvTransform);if(D.alphaMap)E.alphaMap.value=D.alphaMap,$(D.alphaMap,E.alphaMapTransform);if(D.alphaTest>0)E.alphaTest.value=D.alphaTest}function U(E,D){if(E.diffuse.value.copy(D.color),E.opacity.value=D.opacity,E.rotation.value=D.rotation,D.map)E.map.value=D.map,$(D.map,E.mapTransform);if(D.alphaMap)E.alphaMap.value=D.alphaMap,$(D.alphaMap,E.alphaMapTransform);if(D.alphaTest>0)E.alphaTest.value=D.alphaTest}function N(E,D){E.specular.value.copy(D.specular),E.shininess.value=Math.max(D.shininess,0.0001)}function G(E,D){if(D.gradientMap)E.gradientMap.value=D.gradientMap}function q(E,D){if(E.metalness.value=D.metalness,D.metalnessMap)E.metalnessMap.value=D.metalnessMap,$(D.metalnessMap,E.metalnessMapTransform);if(E.roughness.value=D.roughness,D.roughnessMap)E.roughnessMap.value=D.roughnessMap,$(D.roughnessMap,E.roughnessMapTransform);if(D.envMap)E.envMapIntensity.value=D.envMapIntensity}function F(E,D,O){if(E.ior.value=D.ior,D.sheen>0){if(E.sheenColor.value.copy(D.sheenColor).multiplyScalar(D.sheen),E.sheenRoughness.value=D.sheenRoughness,D.sheenColorMap)E.sheenColorMap.value=D.sheenColorMap,$(D.sheenColorMap,E.sheenColorMapTransform);if(D.sheenRoughnessMap)E.sheenRoughnessMap.value=D.sheenRoughnessMap,$(D.sheenRoughnessMap,E.sheenRoughnessMapTransform)}if(D.clearcoat>0){if(E.clearcoat.value=D.clearcoat,E.clearcoatRoughness.value=D.clearcoatRoughness,D.clearcoatMap)E.clearcoatMap.value=D.clearcoatMap,$(D.clearcoatMap,E.clearcoatMapTransform);if(D.clearcoatRoughnessMap)E.clearcoatRoughnessMap.value=D.clearcoatRoughnessMap,$(D.clearcoatRoughnessMap,E.clearcoatRoughnessMapTransform);if(D.clearcoatNormalMap){if(E.clearcoatNormalMap.value=D.clearcoatNormalMap,$(D.clearcoatNormalMap,E.clearcoatNormalMapTransform),E.clearcoatNormalScale.value.copy(D.clearcoatNormalScale),D.side===uJ)E.clearcoatNormalScale.value.negate()}}if(D.dispersion>0)E.dispersion.value=D.dispersion;if(D.iridescence>0){if(E.iridescence.value=D.iridescence,E.iridescenceIOR.value=D.iridescenceIOR,E.iridescenceThicknessMinimum.value=D.iridescenceThicknessRange[0],E.iridescenceThicknessMaximum.value=D.iridescenceThicknessRange[1],D.iridescenceMap)E.iridescenceMap.value=D.iridescenceMap,$(D.iridescenceMap,E.iridescenceMapTransform);if(D.iridescenceThicknessMap)E.iridescenceThicknessMap.value=D.iridescenceThicknessMap,$(D.iridescenceThicknessMap,E.iridescenceThicknessMapTransform)}if(D.transmission>0){if(E.transmission.value=D.transmission,E.transmissionSamplerMap.value=O.texture,E.transmissionSamplerSize.value.set(O.width,O.height),D.transmissionMap)E.transmissionMap.value=D.transmissionMap,$(D.transmissionMap,E.transmissionMapTransform);if(E.thickness.value=D.thickness,D.thicknessMap)E.thicknessMap.value=D.thicknessMap,$(D.thicknessMap,E.thicknessMapTransform);E.attenuationDistance.value=D.attenuationDistance,E.attenuationColor.value.copy(D.attenuationColor)}if(D.anisotropy>0){if(E.anisotropyVector.value.set(D.anisotropy*Math.cos(D.anisotropyRotation),D.anisotropy*Math.sin(D.anisotropyRotation)),D.anisotropyMap)E.anisotropyMap.value=D.anisotropyMap,$(D.anisotropyMap,E.anisotropyMapTransform)}if(E.specularIntensity.value=D.specularIntensity,E.specularColor.value.copy(D.specularColor),D.specularColorMap)E.specularColorMap.value=D.specularColorMap,$(D.specularColorMap,E.specularColorMapTransform);if(D.specularIntensityMap)E.specularIntensityMap.value=D.specularIntensityMap,$(D.specularIntensityMap,E.specularIntensityMapTransform)}function R(E,D){if(D.matcap)E.matcap.value=D.matcap}function B(E,D){let O=Q.get(D).light;E.referencePosition.value.setFromMatrixPosition(O.matrixWorld),E.nearDistance.value=O.shadow.camera.near,E.farDistance.value=O.shadow.camera.far}return{refreshFogUniforms:Z,refreshMaterialUniforms:W}}function EN(J,Q,$,Z){let W={},K={},Y=[],X=J.getParameter(J.MAX_UNIFORM_BUFFER_BINDINGS);function H(O,V){let z=V.program;Z.uniformBlockBinding(O,z)}function U(O,V){let z=W[O.id];if(z===void 0)R(O),z=N(O),W[O.id]=z,O.addEventListener("dispose",E);let A=V.program;Z.updateUBOMapping(O,A);let P=Q.render.frame;if(K[O.id]!==P)q(O),K[O.id]=P}function N(O){let V=G();O.__bindingPointIndex=V;let z=J.createBuffer(),A=O.__size,P=O.usage;return J.bindBuffer(J.UNIFORM_BUFFER,z),J.bufferData(J.UNIFORM_BUFFER,A,P),J.bindBuffer(J.UNIFORM_BUFFER,null),J.bindBufferBase(J.UNIFORM_BUFFER,V,z),z}function G(){for(let O=0;O<X;O++)if(Y.indexOf(O)===-1)return Y.push(O),O;return w0("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function q(O){let V=W[O.id],z=O.uniforms,A=O.__cache;J.bindBuffer(J.UNIFORM_BUFFER,V);for(let P=0,w=z.length;P<w;P++){let _=Array.isArray(z[P])?z[P]:[z[P]];for(let k=0,l=_.length;k<l;k++){let C=_[k];if(F(C,P,k,A)===!0){let m=C.__offset,c=Array.isArray(C.value)?C.value:[C.value],f=0;for(let d=0;d<c.length;d++){let b=c[d],p=B(b);if(typeof b==="number"||typeof b==="boolean")C.__data[0]=b,J.bufferSubData(J.UNIFORM_BUFFER,m+f,C.__data);else if(b.isMatrix3)C.__data[0]=b.elements[0],C.__data[1]=b.elements[1],C.__data[2]=b.elements[2],C.__data[3]=0,C.__data[4]=b.elements[3],C.__data[5]=b.elements[4],C.__data[6]=b.elements[5],C.__data[7]=0,C.__data[8]=b.elements[6],C.__data[9]=b.elements[7],C.__data[10]=b.elements[8],C.__data[11]=0;else if(ArrayBuffer.isView(b))C.__data.set(new b.constructor(b.buffer,b.byteOffset,C.__data.length));else b.toArray(C.__data,f),f+=p.storage/Float32Array.BYTES_PER_ELEMENT}J.bufferSubData(J.UNIFORM_BUFFER,m,C.__data)}}}J.bindBuffer(J.UNIFORM_BUFFER,null)}function F(O,V,z,A){let P=O.value,w=V+"_"+z;if(A[w]===void 0){if(typeof P==="number"||typeof P==="boolean")A[w]=P;else if(ArrayBuffer.isView(P))A[w]=P.slice();else A[w]=P.clone();return!0}else{let _=A[w];if(typeof P==="number"||typeof P==="boolean"){if(_!==P)return A[w]=P,!0}else if(ArrayBuffer.isView(P))return!0;else if(_.equals(P)===!1)return _.copy(P),!0}return!1}function R(O){let V=O.uniforms,z=0,A=16;for(let w=0,_=V.length;w<_;w++){let k=Array.isArray(V[w])?V[w]:[V[w]];for(let l=0,C=k.length;l<C;l++){let m=k[l],c=Array.isArray(m.value)?m.value:[m.value];for(let f=0,d=c.length;f<d;f++){let b=c[f],p=B(b),a=z%A,Q0=a%p.boundary,F0=a+Q0;if(z+=Q0,F0!==0&&A-F0<p.storage)z+=A-F0;m.__data=new Float32Array(p.storage/Float32Array.BYTES_PER_ELEMENT),m.__offset=z,z+=p.storage}}}let P=z%A;if(P>0)z+=A-P;return O.__size=z,O.__cache={},this}function B(O){let V={boundary:0,storage:0};if(typeof O==="number"||typeof O==="boolean")V.boundary=4,V.storage=4;else if(O.isVector2)V.boundary=8,V.storage=8;else if(O.isVector3||O.isColor)V.boundary=16,V.storage=12;else if(O.isVector4)V.boundary=16,V.storage=16;else if(O.isMatrix3)V.boundary=48,V.storage=48;else if(O.isMatrix4)V.boundary=64,V.storage=64;else if(O.isTexture)A0("WebGLRenderer: Texture samplers can not be part of an uniforms group.");else if(ArrayBuffer.isView(O))V.boundary=16,V.storage=O.byteLength;else A0("WebGLRenderer: Unsupported uniform value type.",O);return V}function E(O){let V=O.target;V.removeEventListener("dispose",E);let z=Y.indexOf(V.__bindingPointIndex);Y.splice(z,1),J.deleteBuffer(W[V.id]),delete W[V.id],delete K[V.id]}function D(){for(let O in W)J.deleteBuffer(W[O]);Y=[],W={},K={}}return{bind:H,update:U,dispose:D}}var RN=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),P9=null;function ON(){if(P9===null)P9=new n$(RN,16,16,E8,m9),P9.name="DFG_LUT",P9.minFilter=nJ,P9.magFilter=nJ,P9.wrapS=C6,P9.wrapT=C6,P9.generateMipmaps=!1,P9.needsUpdate=!0;return P9}class kZ{constructor(J={}){let{canvas:Q=OK(),context:$=null,depth:Z=!0,stencil:W=!1,alpha:K=!1,antialias:Y=!1,premultipliedAlpha:X=!0,preserveDrawingBuffer:H=!1,powerPreference:U="default",failIfMajorPerformanceCaveat:N=!1,reversedDepthBuffer:G=!1,outputBufferType:q=O9}=J;this.isWebGLRenderer=!0;let F;if($!==null){if(typeof WebGLRenderingContext<"u"&&$ instanceof WebGLRenderingContext)throw Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");F=$.getContextAttributes().alpha}else F=K;let R=q,B=new Set([W$,Z$,$$]),E=new Set([O9,J8,C7,Q7,J$,Q$]),D=new Uint32Array(4),O=new Int32Array(4),V=new j,z=null,A=null,P=[],w=[],_=null;this.domElement=Q,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=R9,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let k=this,l=!1,C=null;this._outputColorSpace=w7;let m=0,c=0,f=null,d=-1,b=null,p=new EJ,a=new EJ,Q0=null,F0=new x0(0),I0=0,M0=Q.width,e0=Q.height,d0=1,s=null,N0=null,V0=new EJ(0,0,M0,e0),q0=new EJ(0,0,M0,e0),P0=!1,t0=new h7,g0=!1,u0=!1,KJ=new FJ,YJ=new j,h0=new EJ,SJ={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},yJ=!1;function VJ(){return f===null?d0:1}let S=$;function gJ(L,y){return Q.getContext(L,y)}try{let L={alpha:!0,depth:Z,stencil:W,antialias:Y,premultipliedAlpha:X,preserveDrawingBuffer:H,powerPreference:U,failIfMajorPerformanceCaveat:N};if("setAttribute"in Q)Q.setAttribute("data-engine",`three.js r${LW}`);if(Q.addEventListener("webglcontextlost",O0,!1),Q.addEventListener("webglcontextrestored",t,!1),Q.addEventListener("webglcontextcreationerror",L0,!1),S===null){if(S=gJ("webgl2",L),S===null)if(gJ("webgl2"))throw Error("Error creating WebGL context with your selected attributes.");else throw Error("Error creating WebGL context.")}}catch(L){throw w0("WebGLRenderer: "+L.message),L}let n0,a0,U0,DJ,C0,I,M,v,o,r,e,K0,u,i,W0,R0,$0,Y0,S0,v0,p0,T,Z0;function n(){if(n0=new k5(S),n0.init(),p0=new GN(S,n0),a0=new R5(S,n0,J,p0),U0=new HN(S,n0),a0.reversedDepthBuffer&&G)U0.buffers.depth.setReversed(!0);DJ=new P5(S),C0=new iG,I=new UN(S,n0,U0,C0,a0,p0,DJ),M=new z5(k),v=new SX(S),T=new D5(S,v),o=new I5(S,v,DJ,T),r=new w5(S,o,v,T,DJ),Y0=new C5(S,a0,I),W0=new O5(C0),e=new sG(k,M,n0,a0,T,W0),K0=new DN(k,C0),u=new aG,i=new $N(n0),$0=new F5(k,M,U0,r,F,X),R0=new XN(k,r,a0),Z0=new EN(S,DJ,a0,U0),S0=new E5(S,n0,DJ),v0=new A5(S,n0,DJ),DJ.programs=e.programs,k.capabilities=a0,k.extensions=n0,k.properties=C0,k.renderLists=u,k.shadowMap=R0,k.state=U0,k.info=DJ}if(n(),R!==O9)_=new S5(R,Q.width,Q.height,Z,W);let J0=new HY(k,S);this.xr=J0,this.getContext=function(){return S},this.getContextAttributes=function(){return S.getContextAttributes()},this.forceContextLoss=function(){let L=n0.get("WEBGL_lose_context");if(L)L.loseContext()},this.forceContextRestore=function(){let L=n0.get("WEBGL_lose_context");if(L)L.restoreContext()},this.getPixelRatio=function(){return d0},this.setPixelRatio=function(L){if(L===void 0)return;d0=L,this.setSize(M0,e0,!1)},this.getSize=function(L){return L.set(M0,e0)},this.setSize=function(L,y,g=!0){if(J0.isPresenting){A0("WebGLRenderer: Can't change size while VR device is presenting.");return}if(M0=L,e0=y,Q.width=Math.floor(L*d0),Q.height=Math.floor(y*d0),g===!0)Q.style.width=L+"px",Q.style.height=y+"px";if(_!==null)_.setSize(Q.width,Q.height);this.setViewport(0,0,L,y)},this.getDrawingBufferSize=function(L){return L.set(M0*d0,e0*d0).floor()},this.setDrawingBufferSize=function(L,y,g){M0=L,e0=y,d0=g,Q.width=Math.floor(L*g),Q.height=Math.floor(y*g),this.setViewport(0,0,L,y)},this.setEffects=function(L){if(R===O9){w0("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(L){for(let y=0;y<L.length;y++)if(L[y].isOutputPass===!0){A0("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}_.setEffects(L||[])},this.getCurrentViewport=function(L){return L.copy(p)},this.getViewport=function(L){return L.copy(V0)},this.setViewport=function(L,y,g,h){if(L.isVector4)V0.set(L.x,L.y,L.z,L.w);else V0.set(L,y,g,h);U0.viewport(p.copy(V0).multiplyScalar(d0).round())},this.getScissor=function(L){return L.copy(q0)},this.setScissor=function(L,y,g,h){if(L.isVector4)q0.set(L.x,L.y,L.z,L.w);else q0.set(L,y,g,h);U0.scissor(a.copy(q0).multiplyScalar(d0).round())},this.getScissorTest=function(){return P0},this.setScissorTest=function(L){U0.setScissorTest(P0=L)},this.setOpaqueSort=function(L){s=L},this.setTransparentSort=function(L){N0=L},this.getClearColor=function(L){return L.copy($0.getClearColor())},this.setClearColor=function(){$0.setClearColor(...arguments)},this.getClearAlpha=function(){return $0.getClearAlpha()},this.setClearAlpha=function(){$0.setClearAlpha(...arguments)},this.clear=function(L=!0,y=!0,g=!0){let h=0;if(L){let x=!1;if(f!==null){let G0=f.texture.format;x=B.has(G0)}if(x){let G0=f.texture.type,E0=E.has(G0),H0=$0.getClearColor(),_0=$0.getClearAlpha(),z0=H0.r,f0=H0.g,m0=H0.b;if(E0)D[0]=z0,D[1]=f0,D[2]=m0,D[3]=_0,S.clearBufferuiv(S.COLOR,0,D);else O[0]=z0,O[1]=f0,O[2]=m0,O[3]=_0,S.clearBufferiv(S.COLOR,0,O)}else h|=S.COLOR_BUFFER_BIT}if(y)h|=S.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0);if(g)h|=S.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295);if(h!==0)S.clear(h)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(L){L.setRenderer(this),C=L},this.dispose=function(){Q.removeEventListener("webglcontextlost",O0,!1),Q.removeEventListener("webglcontextrestored",t,!1),Q.removeEventListener("webglcontextcreationerror",L0,!1),$0.dispose(),u.dispose(),i.dispose(),C0.dispose(),M.dispose(),r.dispose(),T.dispose(),Z0.dispose(),e.dispose(),J0.dispose(),J0.removeEventListener("sessionstart",yZ),J0.removeEventListener("sessionend",fZ),Y8.stop()};function O0(L){L.preventDefault(),L7("WebGLRenderer: Context Lost."),l=!0}function t(){L7("WebGLRenderer: Context Restored."),l=!1;let L=DJ.autoReset,y=R0.enabled,g=R0.autoUpdate,h=R0.needsUpdate,x=R0.type;n(),DJ.autoReset=L,R0.enabled=y,R0.autoUpdate=g,R0.needsUpdate=h,R0.type=x}function L0(L){w0("WebGLRenderer: A WebGL context could not be created. Reason: ",L.statusMessage)}function y0(L){let y=L.target;y.removeEventListener("dispose",y0),LJ(y)}function LJ(L){$J(L),C0.remove(L)}function $J(L){let y=C0.get(L).programs;if(y!==void 0){if(y.forEach(function(g){e.releaseProgram(g)}),L.isShaderMaterial)e.releaseShaderCache(L)}}this.renderBufferDirect=function(L,y,g,h,x,G0){if(y===null)y=SJ;let E0=x.isMesh&&x.matrixWorld.determinant()<0,H0=RY(L,y,g,h,x);U0.setMaterial(h,E0);let _0=g.index,z0=1;if(h.wireframe===!0){if(_0=o.getWireframeAttribute(g),_0===void 0)return;z0=2}let f0=g.drawRange,m0=g.attributes.position,k0=f0.start*z0,ZJ=(f0.start+f0.count)*z0;if(G0!==null)k0=Math.max(k0,G0.start*z0),ZJ=Math.min(ZJ,(G0.start+G0.count)*z0);if(_0!==null)k0=Math.max(k0,0),ZJ=Math.min(ZJ,_0.count);else if(m0!==void 0&&m0!==null)k0=Math.max(k0,0),ZJ=Math.min(ZJ,m0.count);let OJ=ZJ-k0;if(OJ<0||OJ===1/0)return;T.setup(x,h,H0,g,_0);let RJ,XJ=S0;if(_0!==null)RJ=v.get(_0),XJ=v0,XJ.setIndex(RJ);if(x.isMesh)if(h.wireframe===!0)U0.setLineWidth(h.wireframeLinewidth*VJ()),XJ.setMode(S.LINES);else XJ.setMode(S.TRIANGLES);else if(x.isLine){let fJ=h.linewidth;if(fJ===void 0)fJ=1;if(U0.setLineWidth(fJ*VJ()),x.isLineSegments)XJ.setMode(S.LINES);else if(x.isLineLoop)XJ.setMode(S.LINE_LOOP);else XJ.setMode(S.LINE_STRIP)}else if(x.isPoints)XJ.setMode(S.POINTS);else if(x.isSprite)XJ.setMode(S.TRIANGLES);if(x.isBatchedMesh)if(!n0.get("WEBGL_multi_draw")){let{_multiDrawStarts:fJ,_multiDrawCounts:D0,_multiDrawCount:aJ}=x,o0=_0?v.get(_0).bytesPerElement:1,Z9=C0.get(h).currentProgram.getUniforms();for(let _9=0;_9<aJ;_9++)Z9.setValue(S,"_gl_DrawID",_9),XJ.render(fJ[_9]/o0,D0[_9])}else XJ.renderMultiDraw(x._multiDrawStarts,x._multiDrawCounts,x._multiDrawCount);else if(x.isInstancedMesh)XJ.renderInstances(k0,OJ,x.count);else if(g.isInstancedBufferGeometry){let fJ=g._maxInstanceCount!==void 0?g._maxInstanceCount:1/0,D0=Math.min(g.instanceCount,fJ);XJ.renderInstances(k0,OJ,D0)}else XJ.render(k0,OJ)};function M9(L,y,g){if(L.transparent===!0&&L.side===cJ&&L.forceSinglePass===!1)L.side=uJ,L.needsUpdate=!0,o7(L,y,g),L.side=t8,L.needsUpdate=!0,o7(L,y,g),L.side=cJ;else o7(L,y,g)}this.compile=function(L,y,g=null){if(g===null)g=L;if(A=i.get(g),A.init(y),w.push(A),g.traverseVisible(function(x){if(x.isLight&&x.layers.test(y.layers)){if(A.pushLight(x),x.castShadow)A.pushShadow(x)}}),L!==g)L.traverseVisible(function(x){if(x.isLight&&x.layers.test(y.layers)){if(A.pushLight(x),x.castShadow)A.pushShadow(x)}});A.setupLights();let h=new Set;return L.traverse(function(x){if(!(x.isMesh||x.isPoints||x.isLine||x.isSprite))return;let G0=x.material;if(G0)if(Array.isArray(G0))for(let E0=0;E0<G0.length;E0++){let H0=G0[E0];M9(H0,g,x),h.add(H0)}else M9(G0,g,x),h.add(G0)}),A=w.pop(),h},this.compileAsync=function(L,y,g=null){let h=this.compile(L,y,g);return new Promise((x)=>{function G0(){if(h.forEach(function(E0){if(C0.get(E0).currentProgram.isReady())h.delete(E0)}),h.size===0){x(L);return}setTimeout(G0,10)}if(n0.get("KHR_parallel_shader_compile")!==null)G0();else setTimeout(G0,10)})};let U9=null;function DY(L){if(U9)U9(L)}function yZ(){Y8.stop()}function fZ(){Y8.start()}let Y8=new aK;if(Y8.setAnimationLoop(DY),typeof self<"u")Y8.setContext(self);this.setAnimationLoop=function(L){U9=L,J0.setAnimationLoop(L),L===null?Y8.stop():Y8.start()},J0.addEventListener("sessionstart",yZ),J0.addEventListener("sessionend",fZ),this.render=function(L,y){if(y!==void 0&&y.isCamera!==!0){w0("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(l===!0)return;if(C!==null)C.renderStart(L,y);let g=J0.enabled===!0&&J0.isPresenting===!0,h=_!==null&&(f===null||g)&&_.begin(k,f);if(L.matrixWorldAutoUpdate===!0)L.updateMatrixWorld();if(y.parent===null&&y.matrixWorldAutoUpdate===!0)y.updateMatrixWorld();if(J0.enabled===!0&&J0.isPresenting===!0&&(_===null||_.isCompositing()===!1)){if(J0.cameraAutoUpdate===!0)J0.updateCamera(y);y=J0.getCamera()}if(L.isScene===!0)L.onBeforeRender(k,L,y,f);if(A=i.get(L,w.length),A.init(y),A.state.textureUnits=I.getTextureUnits(),w.push(A),KJ.multiplyMatrices(y.projectionMatrix,y.matrixWorldInverse),t0.setFromProjectionMatrix(KJ,g$,y.reversedDepth),u0=this.localClippingEnabled,g0=W0.init(this.clippingPlanes,u0),z=u.get(L,P.length),z.init(),P.push(z),J0.enabled===!0&&J0.isPresenting===!0){let E0=k.xr.getDepthSensingMesh();if(E0!==null)HQ(E0,y,-1/0,k.sortObjects)}if(HQ(L,y,0,k.sortObjects),z.finish(),k.sortObjects===!0)z.sort(s,N0);if(yJ=J0.enabled===!1||J0.isPresenting===!1||J0.hasDepthSensing()===!1,yJ)$0.addToRenderList(z,L);if(this.info.render.frame++,g0===!0)W0.beginShadows();let x=A.state.shadowsArray;if(R0.render(x,L,y),g0===!0)W0.endShadows();if(this.info.autoReset===!0)this.info.reset();if((h&&_.hasRenderPass())===!1){let{opaque:E0,transmissive:H0}=z;if(A.setupLights(),y.isArrayCamera){let _0=y.cameras;if(H0.length>0)for(let z0=0,f0=_0.length;z0<f0;z0++){let m0=_0[z0];hZ(E0,H0,L,m0)}if(yJ)$0.render(L);for(let z0=0,f0=_0.length;z0<f0;z0++){let m0=_0[z0];vZ(z,L,m0,m0.viewport)}}else{if(H0.length>0)hZ(E0,H0,L,y);if(yJ)$0.render(L);vZ(z,L,y)}}if(f!==null&&c===0)I.updateMultisampleRenderTarget(f),I.updateRenderTargetMipmap(f);if(h)_.end(k);if(L.isScene===!0)L.onAfterRender(k,L,y);if(T.resetDefaultState(),d=-1,b=null,w.pop(),w.length>0){if(A=w[w.length-1],I.setTextureUnits(A.state.textureUnits),g0===!0)W0.setGlobalState(k.clippingPlanes,A.state.camera)}else A=null;if(P.pop(),P.length>0)z=P[P.length-1];else z=null;if(C!==null)C.renderEnd()};function HQ(L,y,g,h){if(L.visible===!1)return;if(L.layers.test(y.layers)){if(L.isGroup)g=L.renderOrder;else if(L.isLOD){if(L.autoUpdate===!0)L.update(y)}else if(L.isLightProbeGrid)A.pushLightProbeGrid(L);else if(L.isLight){if(A.pushLight(L),L.castShadow)A.pushShadow(L)}else if(L.isSprite){if(!L.frustumCulled||t0.intersectsSprite(L)){if(h)h0.setFromMatrixPosition(L.matrixWorld).applyMatrix4(KJ);let E0=r.update(L),H0=L.material;if(H0.visible)z.push(L,E0,H0,g,h0.z,null)}}else if(L.isMesh||L.isLine||L.isPoints){if(!L.frustumCulled||t0.intersectsObject(L)){let E0=r.update(L),H0=L.material;if(h){if(L.boundingSphere!==void 0){if(L.boundingSphere===null)L.computeBoundingSphere();h0.copy(L.boundingSphere.center)}else{if(E0.boundingSphere===null)E0.computeBoundingSphere();h0.copy(E0.boundingSphere.center)}h0.applyMatrix4(L.matrixWorld).applyMatrix4(KJ)}if(Array.isArray(H0)){let _0=E0.groups;for(let z0=0,f0=_0.length;z0<f0;z0++){let m0=_0[z0],k0=H0[m0.materialIndex];if(k0&&k0.visible)z.push(L,E0,k0,g,h0.z,m0)}}else if(H0.visible)z.push(L,E0,H0,g,h0.z,null)}}}let G0=L.children;for(let E0=0,H0=G0.length;E0<H0;E0++)HQ(G0[E0],y,g,h)}function vZ(L,y,g,h){let{opaque:x,transmissive:G0,transparent:E0}=L;if(A.setupLightsView(g),g0===!0)W0.setGlobalState(k.clippingPlanes,g);if(h)U0.viewport(p.copy(h));if(x.length>0)i7(x,y,g);if(G0.length>0)i7(G0,y,g);if(E0.length>0)i7(E0,y,g);U0.buffers.depth.setTest(!0),U0.buffers.depth.setMask(!0),U0.buffers.color.setMask(!0),U0.setPolygonOffset(!1)}function hZ(L,y,g,h){if((g.isScene===!0?g.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[h.id]===void 0){let k0=n0.has("EXT_color_buffer_half_float")||n0.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[h.id]=new Y9(1,1,{generateMipmaps:!0,type:k0?m9:O9,minFilter:q8,samples:Math.max(4,a0.samples),stencilBuffer:W,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:c0.workingColorSpace})}let G0=A.state.transmissionRenderTarget[h.id],E0=h.viewport||p;G0.setSize(E0.z*k.transmissionResolutionScale,E0.w*k.transmissionResolutionScale);let H0=k.getRenderTarget(),_0=k.getActiveCubeFace(),z0=k.getActiveMipmapLevel();if(k.setRenderTarget(G0),k.getClearColor(F0),I0=k.getClearAlpha(),I0<1)k.setClearColor(16777215,0.5);if(k.clear(),yJ)$0.render(g);let f0=k.toneMapping;k.toneMapping=R9;let m0=h.viewport;if(h.viewport!==void 0)h.viewport=void 0;if(A.setupLightsView(h),g0===!0)W0.setGlobalState(k.clippingPlanes,h);if(i7(L,g,h),I.updateMultisampleRenderTarget(G0),I.updateRenderTargetMipmap(G0),n0.has("WEBGL_multisampled_render_to_texture")===!1){let k0=!1;for(let ZJ=0,OJ=y.length;ZJ<OJ;ZJ++){let RJ=y[ZJ],{object:XJ,geometry:fJ,material:D0,group:aJ}=RJ;if(D0.side===cJ&&XJ.layers.test(h.layers)){let o0=D0.side;D0.side=uJ,D0.needsUpdate=!0,xZ(XJ,g,h,fJ,D0,aJ),D0.side=o0,D0.needsUpdate=!0,k0=!0}}if(k0===!0)I.updateMultisampleRenderTarget(G0),I.updateRenderTargetMipmap(G0)}if(k.setRenderTarget(H0,_0,z0),k.setClearColor(F0,I0),m0!==void 0)h.viewport=m0;k.toneMapping=f0}function i7(L,y,g){let h=y.isScene===!0?y.overrideMaterial:null;for(let x=0,G0=L.length;x<G0;x++){let E0=L[x],{object:H0,geometry:_0,group:z0}=E0,f0=E0.material;if(f0.allowOverride===!0&&h!==null)f0=h;if(H0.layers.test(g.layers))xZ(H0,y,g,_0,f0,z0)}}function xZ(L,y,g,h,x,G0){if(L.onBeforeRender(k,y,g,h,x,G0),L.modelViewMatrix.multiplyMatrices(g.matrixWorldInverse,L.matrixWorld),L.normalMatrix.getNormalMatrix(L.modelViewMatrix),x.onBeforeRender(k,y,g,h,L,G0),x.transparent===!0&&x.side===cJ&&x.forceSinglePass===!1)x.side=uJ,x.needsUpdate=!0,k.renderBufferDirect(g,y,h,x,L,G0),x.side=t8,x.needsUpdate=!0,k.renderBufferDirect(g,y,h,x,L,G0),x.side=cJ;else k.renderBufferDirect(g,y,h,x,L,G0);L.onAfterRender(k,y,g,h,x,G0)}function o7(L,y,g){if(y.isScene!==!0)y=SJ;let h=C0.get(L),x=A.state.lights,G0=A.state.shadowsArray,E0=x.state.version,H0=e.getParameters(L,x.state,G0,y,g,A.state.lightProbeGridArray),_0=e.getProgramCacheKey(H0),z0=h.programs;h.environment=L.isMeshStandardMaterial||L.isMeshLambertMaterial||L.isMeshPhongMaterial?y.environment:null,h.fog=y.fog;let f0=L.isMeshStandardMaterial||L.isMeshLambertMaterial&&!L.envMap||L.isMeshPhongMaterial&&!L.envMap;if(h.envMap=M.get(L.envMap||h.environment,f0),h.envMapRotation=h.environment!==null&&L.envMap===null?y.environmentRotation:L.envMapRotation,z0===void 0)L.addEventListener("dispose",y0),z0=new Map,h.programs=z0;let m0=z0.get(_0);if(m0!==void 0){if(h.currentProgram===m0&&h.lightsStateVersion===E0)return gZ(L,H0),m0}else{if(H0.uniforms=e.getUniforms(L),C!==null&&L.isNodeMaterial)C.build(L,g,H0);L.onBeforeCompile(H0,k),m0=e.acquireProgram(H0,_0),z0.set(_0,m0),h.uniforms=H0.uniforms}let k0=h.uniforms;if(!L.isShaderMaterial&&!L.isRawShaderMaterial||L.clipping===!0)k0.clippingPlanes=W0.uniform;if(gZ(L,H0),h.needsLights=MY(L),h.lightsStateVersion=E0,h.needsLights)k0.ambientLightColor.value=x.state.ambient,k0.lightProbe.value=x.state.probe,k0.directionalLights.value=x.state.directional,k0.directionalLightShadows.value=x.state.directionalShadow,k0.spotLights.value=x.state.spot,k0.spotLightShadows.value=x.state.spotShadow,k0.rectAreaLights.value=x.state.rectArea,k0.ltc_1.value=x.state.rectAreaLTC1,k0.ltc_2.value=x.state.rectAreaLTC2,k0.pointLights.value=x.state.point,k0.pointLightShadows.value=x.state.pointShadow,k0.hemisphereLights.value=x.state.hemi,k0.directionalShadowMatrix.value=x.state.directionalShadowMatrix,k0.spotLightMatrix.value=x.state.spotLightMatrix,k0.spotLightMap.value=x.state.spotLightMap,k0.pointShadowMatrix.value=x.state.pointShadowMatrix;return h.lightProbeGrid=A.state.lightProbeGridArray.length>0,h.currentProgram=m0,h.uniformsList=null,m0}function bZ(L){if(L.uniformsList===null){let y=L.currentProgram.getUniforms();L.uniformsList=n7.seqWithValue(y.seq,L.uniforms)}return L.uniformsList}function gZ(L,y){let g=C0.get(L);g.outputColorSpace=y.outputColorSpace,g.batching=y.batching,g.batchingColor=y.batchingColor,g.instancing=y.instancing,g.instancingColor=y.instancingColor,g.instancingMorph=y.instancingMorph,g.skinning=y.skinning,g.morphTargets=y.morphTargets,g.morphNormals=y.morphNormals,g.morphColors=y.morphColors,g.morphTargetsCount=y.morphTargetsCount,g.numClippingPlanes=y.numClippingPlanes,g.numIntersection=y.numClipIntersection,g.vertexAlphas=y.vertexAlphas,g.vertexTangents=y.vertexTangents,g.toneMapping=y.toneMapping}function EY(L,y){if(L.length===0)return null;if(L.length===1)return L[0].texture!==null?L[0]:null;V.setFromMatrixPosition(y.matrixWorld);for(let g=0,h=L.length;g<h;g++){let x=L[g];if(x.texture!==null&&x.boundingBox.containsPoint(V))return x}return null}function RY(L,y,g,h,x){if(y.isScene!==!0)y=SJ;I.resetTextureUnits();let G0=y.fog,E0=h.isMeshStandardMaterial||h.isMeshLambertMaterial||h.isMeshPhongMaterial?y.environment:null,H0=f===null?k.outputColorSpace:f.isXRRenderTarget===!0?f.texture.colorSpace:c0.workingColorSpace,_0=h.isMeshStandardMaterial||h.isMeshLambertMaterial&&!h.envMap||h.isMeshPhongMaterial&&!h.envMap,z0=M.get(h.envMap||E0,_0),f0=h.vertexColors===!0&&!!g.attributes.color&&g.attributes.color.itemSize===4,m0=!!g.attributes.tangent&&(!!h.normalMap||h.anisotropy>0),k0=!!g.morphAttributes.position,ZJ=!!g.morphAttributes.normal,OJ=!!g.morphAttributes.color,RJ=R9;if(h.toneMapped){if(f===null||f.isXRRenderTarget===!0)RJ=k.toneMapping}let XJ=g.morphAttributes.position||g.morphAttributes.normal||g.morphAttributes.color,fJ=XJ!==void 0?XJ.length:0,D0=C0.get(h),aJ=A.state.lights;if(g0===!0){if(u0===!0||L!==b){let GJ=L===b&&h.id===d;W0.setState(h,L,GJ)}}let o0=!1;if(h.version===D0.__version){if(D0.needsLights&&D0.lightsStateVersion!==aJ.state.version)o0=!0;else if(D0.outputColorSpace!==H0)o0=!0;else if(x.isBatchedMesh&&D0.batching===!1)o0=!0;else if(!x.isBatchedMesh&&D0.batching===!0)o0=!0;else if(x.isBatchedMesh&&D0.batchingColor===!0&&x.colorTexture===null)o0=!0;else if(x.isBatchedMesh&&D0.batchingColor===!1&&x.colorTexture!==null)o0=!0;else if(x.isInstancedMesh&&D0.instancing===!1)o0=!0;else if(!x.isInstancedMesh&&D0.instancing===!0)o0=!0;else if(x.isSkinnedMesh&&D0.skinning===!1)o0=!0;else if(!x.isSkinnedMesh&&D0.skinning===!0)o0=!0;else if(x.isInstancedMesh&&D0.instancingColor===!0&&x.instanceColor===null)o0=!0;else if(x.isInstancedMesh&&D0.instancingColor===!1&&x.instanceColor!==null)o0=!0;else if(x.isInstancedMesh&&D0.instancingMorph===!0&&x.morphTexture===null)o0=!0;else if(x.isInstancedMesh&&D0.instancingMorph===!1&&x.morphTexture!==null)o0=!0;else if(D0.envMap!==z0)o0=!0;else if(h.fog===!0&&D0.fog!==G0)o0=!0;else if(D0.numClippingPlanes!==void 0&&(D0.numClippingPlanes!==W0.numPlanes||D0.numIntersection!==W0.numIntersection))o0=!0;else if(D0.vertexAlphas!==f0)o0=!0;else if(D0.vertexTangents!==m0)o0=!0;else if(D0.morphTargets!==k0)o0=!0;else if(D0.morphNormals!==ZJ)o0=!0;else if(D0.morphColors!==OJ)o0=!0;else if(D0.toneMapping!==RJ)o0=!0;else if(D0.morphTargetsCount!==fJ)o0=!0;else if(!!D0.lightProbeGrid!==A.state.lightProbeGridArray.length>0)o0=!0}else o0=!0,D0.__version=h.version;let Z9=D0.currentProgram;if(o0===!0){if(Z9=o7(h,y,x),C&&h.isNodeMaterial)C.onUpdateProgram(h,Z9,D0)}let _9=!1,l9=!1,I8=!1,HJ=Z9.getUniforms(),MJ=D0.uniforms;if(U0.useProgram(Z9.program))_9=!0,l9=!0,I8=!0;if(h.id!==d)d=h.id,l9=!0;if(D0.needsLights){let GJ=EY(A.state.lightProbeGridArray,x);if(D0.lightProbeGrid!==GJ)D0.lightProbeGrid=GJ,l9=!0}if(_9||b!==L){if(U0.buffers.depth.getReversed()&&L.reversedDepth!==!0)L._reversedDepth=!0,L.updateProjectionMatrix();HJ.setValue(S,"projectionMatrix",L.projectionMatrix),HJ.setValue(S,"viewMatrix",L.matrixWorldInverse);let u9=HJ.map.cameraPosition;if(u9!==void 0)u9.setValue(S,YJ.setFromMatrixPosition(L.matrixWorld));if(a0.logarithmicDepthBuffer)HJ.setValue(S,"logDepthBufFC",2/(Math.log(L.far+1)/Math.LN2));if(h.isMeshPhongMaterial||h.isMeshToonMaterial||h.isMeshLambertMaterial||h.isMeshBasicMaterial||h.isMeshStandardMaterial||h.isShaderMaterial)HJ.setValue(S,"isOrthographic",L.isOrthographicCamera===!0);if(b!==L)b=L,l9=!0,I8=!0}if(D0.needsLights){if(aJ.state.directionalShadowMap.length>0)HJ.setValue(S,"directionalShadowMap",aJ.state.directionalShadowMap,I);if(aJ.state.spotShadowMap.length>0)HJ.setValue(S,"spotShadowMap",aJ.state.spotShadowMap,I);if(aJ.state.pointShadowMap.length>0)HJ.setValue(S,"pointShadowMap",aJ.state.pointShadowMap,I)}if(x.isSkinnedMesh){HJ.setOptional(S,x,"bindMatrix"),HJ.setOptional(S,x,"bindMatrixInverse");let GJ=x.skeleton;if(GJ){if(GJ.boneTexture===null)GJ.computeBoneTexture();HJ.setValue(S,"boneTexture",GJ.boneTexture,I)}}if(x.isBatchedMesh){if(HJ.setOptional(S,x,"batchingTexture"),HJ.setValue(S,"batchingTexture",x._matricesTexture,I),HJ.setOptional(S,x,"batchingIdTexture"),HJ.setValue(S,"batchingIdTexture",x._indirectTexture,I),HJ.setOptional(S,x,"batchingColorTexture"),x._colorsTexture!==null)HJ.setValue(S,"batchingColorTexture",x._colorsTexture,I)}let d9=g.morphAttributes;if(d9.position!==void 0||d9.normal!==void 0||d9.color!==void 0)Y0.update(x,g,Z9);if(l9||D0.receiveShadow!==x.receiveShadow)D0.receiveShadow=x.receiveShadow,HJ.setValue(S,"receiveShadow",x.receiveShadow);if((h.isMeshStandardMaterial||h.isMeshLambertMaterial||h.isMeshPhongMaterial)&&h.envMap===null&&y.environment!==null)MJ.envMapIntensity.value=y.environmentIntensity;if(MJ.dfgLUT!==void 0)MJ.dfgLUT.value=ON();if(l9){if(HJ.setValue(S,"toneMappingExposure",k.toneMappingExposure),D0.needsLights)OY(MJ,I8);if(G0&&h.fog===!0)K0.refreshFogUniforms(MJ,G0);if(K0.refreshMaterialUniforms(MJ,h,d0,e0,A.state.transmissionRenderTarget[L.id]),D0.needsLights&&D0.lightProbeGrid){let GJ=D0.lightProbeGrid;MJ.probesSH.value=GJ.texture,MJ.probesMin.value.copy(GJ.boundingBox.min),MJ.probesMax.value.copy(GJ.boundingBox.max),MJ.probesResolution.value.copy(GJ.resolution)}n7.upload(S,bZ(D0),MJ,I)}if(h.isShaderMaterial&&h.uniformsNeedUpdate===!0)n7.upload(S,bZ(D0),MJ,I),h.uniformsNeedUpdate=!1;if(h.isSpriteMaterial)HJ.setValue(S,"center",x.center);if(HJ.setValue(S,"modelViewMatrix",x.modelViewMatrix),HJ.setValue(S,"normalMatrix",x.normalMatrix),HJ.setValue(S,"modelMatrix",x.matrixWorld),h.uniformsGroups!==void 0){let GJ=h.uniformsGroups;for(let u9=0,A8=GJ.length;u9<A8;u9++){let pZ=GJ[u9];Z0.update(pZ,Z9),Z0.bind(pZ,Z9)}}return Z9}function OY(L,y){L.ambientLightColor.needsUpdate=y,L.lightProbe.needsUpdate=y,L.directionalLights.needsUpdate=y,L.directionalLightShadows.needsUpdate=y,L.pointLights.needsUpdate=y,L.pointLightShadows.needsUpdate=y,L.spotLights.needsUpdate=y,L.spotLightShadows.needsUpdate=y,L.rectAreaLights.needsUpdate=y,L.hemisphereLights.needsUpdate=y}function MY(L){return L.isMeshLambertMaterial||L.isMeshToonMaterial||L.isMeshPhongMaterial||L.isMeshStandardMaterial||L.isShadowMaterial||L.isShaderMaterial&&L.lights===!0}this.getActiveCubeFace=function(){return m},this.getActiveMipmapLevel=function(){return c},this.getRenderTarget=function(){return f},this.setRenderTargetTextures=function(L,y,g){let h=C0.get(L);if(h.__autoAllocateDepthBuffer=L.resolveDepthBuffer===!1,h.__autoAllocateDepthBuffer===!1)h.__useRenderToTexture=!1;C0.get(L.texture).__webglTexture=y,C0.get(L.depthTexture).__webglTexture=h.__autoAllocateDepthBuffer?void 0:g,h.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(L,y){let g=C0.get(L);g.__webglFramebuffer=y,g.__useDefaultFramebuffer=y===void 0};let _Y=S.createFramebuffer();this.setRenderTarget=function(L,y=0,g=0){f=L,m=y,c=g;let h=null,x=!1,G0=!1;if(L){let H0=C0.get(L);if(H0.__useDefaultFramebuffer!==void 0){U0.bindFramebuffer(S.FRAMEBUFFER,H0.__webglFramebuffer),p.copy(L.viewport),a.copy(L.scissor),Q0=L.scissorTest,U0.viewport(p),U0.scissor(a),U0.setScissorTest(Q0),d=-1;return}else if(H0.__webglFramebuffer===void 0)I.setupRenderTarget(L);else if(H0.__hasExternalTextures)I.rebindTextures(L,C0.get(L.texture).__webglTexture,C0.get(L.depthTexture).__webglTexture);else if(L.depthBuffer){let f0=L.depthTexture;if(H0.__boundDepthTexture!==f0){if(f0!==null&&C0.has(f0)&&(L.width!==f0.image.width||L.height!==f0.image.height))throw Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");I.setupDepthRenderbuffer(L)}}let _0=L.texture;if(_0.isData3DTexture||_0.isDataArrayTexture||_0.isCompressedArrayTexture)G0=!0;let z0=C0.get(L).__webglFramebuffer;if(L.isWebGLCubeRenderTarget){if(Array.isArray(z0[y]))h=z0[y][g];else h=z0[y];x=!0}else if(L.samples>0&&I.useMultisampledRTT(L)===!1)h=C0.get(L).__webglMultisampledFramebuffer;else if(Array.isArray(z0))h=z0[g];else h=z0;p.copy(L.viewport),a.copy(L.scissor),Q0=L.scissorTest}else p.copy(V0).multiplyScalar(d0).floor(),a.copy(q0).multiplyScalar(d0).floor(),Q0=P0;if(g!==0)h=_Y;if(U0.bindFramebuffer(S.FRAMEBUFFER,h))U0.drawBuffers(L,h);if(U0.viewport(p),U0.scissor(a),U0.setScissorTest(Q0),x){let H0=C0.get(L.texture);S.framebufferTexture2D(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_CUBE_MAP_POSITIVE_X+y,H0.__webglTexture,g)}else if(G0){let H0=y;for(let _0=0;_0<L.textures.length;_0++){let z0=C0.get(L.textures[_0]);S.framebufferTextureLayer(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0+_0,z0.__webglTexture,g,H0)}}else if(L!==null&&g!==0){let H0=C0.get(L.texture);S.framebufferTexture2D(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,H0.__webglTexture,g)}d=-1},this.readRenderTargetPixels=function(L,y,g,h,x,G0,E0,H0=0){if(!(L&&L.isWebGLRenderTarget)){w0("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let _0=C0.get(L).__webglFramebuffer;if(L.isWebGLCubeRenderTarget&&E0!==void 0)_0=_0[E0];if(_0){U0.bindFramebuffer(S.FRAMEBUFFER,_0);try{let z0=L.textures[H0],f0=z0.format,m0=z0.type;if(L.textures.length>1)S.readBuffer(S.COLOR_ATTACHMENT0+H0);if(!a0.textureFormatReadable(f0)){w0("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!a0.textureTypeReadable(m0)){w0("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}if(y>=0&&y<=L.width-h&&(g>=0&&g<=L.height-x))S.readPixels(y,g,h,x,p0.convert(f0),p0.convert(m0),G0)}finally{let z0=f!==null?C0.get(f).__webglFramebuffer:null;U0.bindFramebuffer(S.FRAMEBUFFER,z0)}}},this.readRenderTargetPixelsAsync=async function(L,y,g,h,x,G0,E0,H0=0){if(!(L&&L.isWebGLRenderTarget))throw Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let _0=C0.get(L).__webglFramebuffer;if(L.isWebGLCubeRenderTarget&&E0!==void 0)_0=_0[E0];if(_0)if(y>=0&&y<=L.width-h&&(g>=0&&g<=L.height-x)){U0.bindFramebuffer(S.FRAMEBUFFER,_0);let z0=L.textures[H0],f0=z0.format,m0=z0.type;if(L.textures.length>1)S.readBuffer(S.COLOR_ATTACHMENT0+H0);if(!a0.textureFormatReadable(f0))throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!a0.textureTypeReadable(m0))throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let k0=S.createBuffer();S.bindBuffer(S.PIXEL_PACK_BUFFER,k0),S.bufferData(S.PIXEL_PACK_BUFFER,G0.byteLength,S.STREAM_READ),S.readPixels(y,g,h,x,p0.convert(f0),p0.convert(m0),0);let ZJ=f!==null?C0.get(f).__webglFramebuffer:null;U0.bindFramebuffer(S.FRAMEBUFFER,ZJ);let OJ=S.fenceSync(S.SYNC_GPU_COMMANDS_COMPLETE,0);return S.flush(),await _K(S,OJ,4),S.bindBuffer(S.PIXEL_PACK_BUFFER,k0),S.getBufferSubData(S.PIXEL_PACK_BUFFER,0,G0),S.deleteBuffer(k0),S.deleteSync(OJ),G0}else throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(L,y=null,g=0){let h=Math.pow(2,-g),x=Math.floor(L.image.width*h),G0=Math.floor(L.image.height*h),E0=y!==null?y.x:0,H0=y!==null?y.y:0;I.setTexture2D(L,0),S.copyTexSubImage2D(S.TEXTURE_2D,g,0,0,E0,H0,x,G0),U0.unbindTexture()};let VY=S.createFramebuffer(),LY=S.createFramebuffer();if(this.copyTextureToTexture=function(L,y,g=null,h=null,x=0,G0=0){let E0,H0,_0,z0,f0,m0,k0,ZJ,OJ,RJ=L.isCompressedTexture?L.mipmaps[G0]:L.image;if(g!==null)E0=g.max.x-g.min.x,H0=g.max.y-g.min.y,_0=g.isBox3?g.max.z-g.min.z:1,z0=g.min.x,f0=g.min.y,m0=g.isBox3?g.min.z:0;else{let MJ=Math.pow(2,-x);if(E0=Math.floor(RJ.width*MJ),H0=Math.floor(RJ.height*MJ),L.isDataArrayTexture)_0=RJ.depth;else if(L.isData3DTexture)_0=Math.floor(RJ.depth*MJ);else _0=1;z0=0,f0=0,m0=0}if(h!==null)k0=h.x,ZJ=h.y,OJ=h.z;else k0=0,ZJ=0,OJ=0;let XJ=p0.convert(y.format),fJ=p0.convert(y.type),D0;if(y.isData3DTexture)I.setTexture3D(y,0),D0=S.TEXTURE_3D;else if(y.isDataArrayTexture||y.isCompressedArrayTexture)I.setTexture2DArray(y,0),D0=S.TEXTURE_2D_ARRAY;else I.setTexture2D(y,0),D0=S.TEXTURE_2D;U0.activeTexture(S.TEXTURE0),U0.pixelStorei(S.UNPACK_FLIP_Y_WEBGL,y.flipY),U0.pixelStorei(S.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),U0.pixelStorei(S.UNPACK_ALIGNMENT,y.unpackAlignment);let aJ=U0.getParameter(S.UNPACK_ROW_LENGTH),o0=U0.getParameter(S.UNPACK_IMAGE_HEIGHT),Z9=U0.getParameter(S.UNPACK_SKIP_PIXELS),_9=U0.getParameter(S.UNPACK_SKIP_ROWS),l9=U0.getParameter(S.UNPACK_SKIP_IMAGES);U0.pixelStorei(S.UNPACK_ROW_LENGTH,RJ.width),U0.pixelStorei(S.UNPACK_IMAGE_HEIGHT,RJ.height),U0.pixelStorei(S.UNPACK_SKIP_PIXELS,z0),U0.pixelStorei(S.UNPACK_SKIP_ROWS,f0),U0.pixelStorei(S.UNPACK_SKIP_IMAGES,m0);let I8=L.isDataArrayTexture||L.isData3DTexture,HJ=y.isDataArrayTexture||y.isData3DTexture;if(L.isDepthTexture){let MJ=C0.get(L),d9=C0.get(y),GJ=C0.get(MJ.__renderTarget),u9=C0.get(d9.__renderTarget);U0.bindFramebuffer(S.READ_FRAMEBUFFER,GJ.__webglFramebuffer),U0.bindFramebuffer(S.DRAW_FRAMEBUFFER,u9.__webglFramebuffer);for(let A8=0;A8<_0;A8++){if(I8)S.framebufferTextureLayer(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,C0.get(L).__webglTexture,x,m0+A8),S.framebufferTextureLayer(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,C0.get(y).__webglTexture,G0,OJ+A8);S.blitFramebuffer(z0,f0,E0,H0,k0,ZJ,E0,H0,S.DEPTH_BUFFER_BIT,S.NEAREST)}U0.bindFramebuffer(S.READ_FRAMEBUFFER,null),U0.bindFramebuffer(S.DRAW_FRAMEBUFFER,null)}else if(x!==0||L.isRenderTargetTexture||C0.has(L)){let MJ=C0.get(L),d9=C0.get(y);U0.bindFramebuffer(S.READ_FRAMEBUFFER,VY),U0.bindFramebuffer(S.DRAW_FRAMEBUFFER,LY);for(let GJ=0;GJ<_0;GJ++){if(I8)S.framebufferTextureLayer(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,MJ.__webglTexture,x,m0+GJ);else S.framebufferTexture2D(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,MJ.__webglTexture,x);if(HJ)S.framebufferTextureLayer(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,d9.__webglTexture,G0,OJ+GJ);else S.framebufferTexture2D(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,d9.__webglTexture,G0);if(x!==0)S.blitFramebuffer(z0,f0,E0,H0,k0,ZJ,E0,H0,S.COLOR_BUFFER_BIT,S.NEAREST);else if(HJ)S.copyTexSubImage3D(D0,G0,k0,ZJ,OJ+GJ,z0,f0,E0,H0);else S.copyTexSubImage2D(D0,G0,k0,ZJ,z0,f0,E0,H0)}U0.bindFramebuffer(S.READ_FRAMEBUFFER,null),U0.bindFramebuffer(S.DRAW_FRAMEBUFFER,null)}else if(HJ)if(L.isDataTexture||L.isData3DTexture)S.texSubImage3D(D0,G0,k0,ZJ,OJ,E0,H0,_0,XJ,fJ,RJ.data);else if(y.isCompressedArrayTexture)S.compressedTexSubImage3D(D0,G0,k0,ZJ,OJ,E0,H0,_0,XJ,RJ.data);else S.texSubImage3D(D0,G0,k0,ZJ,OJ,E0,H0,_0,XJ,fJ,RJ);else if(L.isDataTexture)S.texSubImage2D(S.TEXTURE_2D,G0,k0,ZJ,E0,H0,XJ,fJ,RJ.data);else if(L.isCompressedTexture)S.compressedTexSubImage2D(S.TEXTURE_2D,G0,k0,ZJ,RJ.width,RJ.height,XJ,RJ.data);else S.texSubImage2D(S.TEXTURE_2D,G0,k0,ZJ,E0,H0,XJ,fJ,RJ);if(U0.pixelStorei(S.UNPACK_ROW_LENGTH,aJ),U0.pixelStorei(S.UNPACK_IMAGE_HEIGHT,o0),U0.pixelStorei(S.UNPACK_SKIP_PIXELS,Z9),U0.pixelStorei(S.UNPACK_SKIP_ROWS,_9),U0.pixelStorei(S.UNPACK_SKIP_IMAGES,l9),G0===0&&y.generateMipmaps)S.generateMipmap(D0);U0.unbindTexture()},this.initRenderTarget=function(L){if(C0.get(L).__webglFramebuffer===void 0)I.setupRenderTarget(L)},this.initTexture=function(L){if(L.isCubeTexture)I.setTextureCube(L,0);else if(L.isData3DTexture)I.setTexture3D(L,0);else if(L.isDataArrayTexture||L.isCompressedArrayTexture)I.setTexture2DArray(L,0);else I.setTexture2D(L,0);U0.unbindTexture()},this.resetState=function(){m=0,c=0,f=null,U0.reset(),T.reset()},typeof __THREE_DEVTOOLS__<"u")__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return g$}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(J){this._outputColorSpace=J;let Q=this.getContext();Q.drawingBufferColorSpace=c0._getDrawingBufferColorSpace(J),Q.unpackColorSpace=c0._getUnpackColorSpace()}}var GY={type:"change"},AZ={type:"start"},qY={type:"end"},WQ=new Z7,NY=new D9,_N=Math.cos(70*m$.DEG2RAD),PJ=new j,iJ=2*Math.PI,WJ={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},IZ=0.000001;class PZ extends e6{constructor(J,Q=null){super(J,Q);if(this.state=WJ.NONE,this.target=new j,this.cursor=new j,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=0.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:r9.ROTATE,MIDDLE:r9.DOLLY,RIGHT:r9.PAN},this.touches={ONE:t9.ROTATE,TWO:t9.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new j,this._lastQuaternion=new K9,this._lastTargetPosition=new j,this._quat=new K9().setFromUnitVectors(J.up,new j(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new l7,this._sphericalDelta=new l7,this._scale=1,this._panOffset=new j,this._rotateStart=new B0,this._rotateEnd=new B0,this._rotateDelta=new B0,this._panStart=new B0,this._panEnd=new B0,this._panDelta=new B0,this._dollyStart=new B0,this._dollyEnd=new B0,this._dollyDelta=new B0,this._dollyDirection=new j,this._mouse=new B0,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=LN.bind(this),this._onPointerDown=VN.bind(this),this._onPointerUp=BN.bind(this),this._onContextMenu=wN.bind(this),this._onMouseWheel=IN.bind(this),this._onKeyDown=AN.bind(this),this._onTouchStart=PN.bind(this),this._onTouchMove=CN.bind(this),this._onMouseDown=zN.bind(this),this._onMouseMove=kN.bind(this),this._interceptControlDown=TN.bind(this),this._interceptControlUp=SN.bind(this),this.domElement!==null)this.connect(this.domElement);this.update()}set cursorStyle(J){if(this._cursorStyle=J,J==="grab")this.domElement.style.cursor="grab";else this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(J){super.connect(J),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=""}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(J){J.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=J}stopListenToKeyEvents(){if(this._domElementKeyEvents!==null)this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(GY),this.update(),this.state=WJ.NONE}pan(J,Q){this._pan(J,Q),this.update()}dollyIn(J){this._dollyIn(J),this.update()}dollyOut(J){this._dollyOut(J),this.update()}rotateLeft(J){this._rotateLeft(J),this.update()}rotateUp(J){this._rotateUp(J),this.update()}update(J=null){let Q=this.object.position;if(PJ.copy(Q).sub(this.target),PJ.applyQuaternion(this._quat),this._spherical.setFromVector3(PJ),this.autoRotate&&this.state===WJ.NONE)this._rotateLeft(this._getAutoRotationAngle(J));if(this.enableDamping)this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor;else this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi;let $=this.minAzimuthAngle,Z=this.maxAzimuthAngle;if(isFinite($)&&isFinite(Z)){if($<-Math.PI)$+=iJ;else if($>Math.PI)$-=iJ;if(Z<-Math.PI)Z+=iJ;else if(Z>Math.PI)Z-=iJ;if($<=Z)this._spherical.theta=Math.max($,Math.min(Z,this._spherical.theta));else this._spherical.theta=this._spherical.theta>($+Z)/2?Math.max($,this._spherical.theta):Math.min(Z,this._spherical.theta)}if(this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0)this.target.addScaledVector(this._panOffset,this.dampingFactor);else this.target.add(this._panOffset);this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let W=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let K=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),W=K!=this._spherical.radius}if(PJ.setFromSpherical(this._spherical),PJ.applyQuaternion(this._quatInverse),Q.copy(this.target).add(PJ),this.object.lookAt(this.target),this.enableDamping===!0)this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor);else this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0);if(this.zoomToCursor&&this._performCursorZoom){let K=null;if(this.object.isPerspectiveCamera){let Y=PJ.length();K=this._clampDistance(Y*this._scale);let X=Y-K;this.object.position.addScaledVector(this._dollyDirection,X),this.object.updateMatrixWorld(),W=!!X}else if(this.object.isOrthographicCamera){let Y=new j(this._mouse.x,this._mouse.y,0);Y.unproject(this.object);let X=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),W=X!==this.object.zoom;let H=new j(this._mouse.x,this._mouse.y,0);H.unproject(this.object),this.object.position.sub(H).add(Y),this.object.updateMatrixWorld(),K=PJ.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;if(K!==null)if(this.screenSpacePanning)this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(K).add(this.object.position);else if(WQ.origin.copy(this.object.position),WQ.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(WQ.direction))<_N)this.object.lookAt(this.target);else NY.setFromNormalAndCoplanarPoint(this.object.up,this.target),WQ.intersectPlane(NY,this.target)}else if(this.object.isOrthographicCamera){let K=this.object.zoom;if(this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),K!==this.object.zoom)this.object.updateProjectionMatrix(),W=!0}if(this._scale=1,this._performCursorZoom=!1,W||this._lastPosition.distanceToSquared(this.object.position)>IZ||8*(1-this._lastQuaternion.dot(this.object.quaternion))>IZ||this._lastTargetPosition.distanceToSquared(this.target)>IZ)return this.dispatchEvent(GY),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0;return!1}_getAutoRotationAngle(J){if(J!==null)return iJ/60*this.autoRotateSpeed*J;else return iJ/60/60*this.autoRotateSpeed}_getZoomScale(J){let Q=Math.abs(J*0.01);return Math.pow(0.95,this.zoomSpeed*Q)}_rotateLeft(J){this._sphericalDelta.theta-=J}_rotateUp(J){this._sphericalDelta.phi-=J}_panLeft(J,Q){PJ.setFromMatrixColumn(Q,0),PJ.multiplyScalar(-J),this._panOffset.add(PJ)}_panUp(J,Q){if(this.screenSpacePanning===!0)PJ.setFromMatrixColumn(Q,1);else PJ.setFromMatrixColumn(Q,0),PJ.crossVectors(this.object.up,PJ);PJ.multiplyScalar(J),this._panOffset.add(PJ)}_pan(J,Q){let $=this.domElement;if(this.object.isPerspectiveCamera){let Z=this.object.position;PJ.copy(Z).sub(this.target);let W=PJ.length();W*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*J*W/$.clientHeight,this.object.matrix),this._panUp(2*Q*W/$.clientHeight,this.object.matrix)}else if(this.object.isOrthographicCamera)this._panLeft(J*(this.object.right-this.object.left)/this.object.zoom/$.clientWidth,this.object.matrix),this._panUp(Q*(this.object.top-this.object.bottom)/this.object.zoom/$.clientHeight,this.object.matrix);else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1}_dollyOut(J){if(this.object.isPerspectiveCamera||this.object.isOrthographicCamera)this._scale/=J;else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1}_dollyIn(J){if(this.object.isPerspectiveCamera||this.object.isOrthographicCamera)this._scale*=J;else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1}_updateZoomParameters(J,Q){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let $=this.domElement.getBoundingClientRect(),Z=J-$.left,W=Q-$.top,K=$.width,Y=$.height;this._mouse.x=Z/K*2-1,this._mouse.y=-(W/Y)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(J){return Math.max(this.minDistance,Math.min(this.maxDistance,J))}_handleMouseDownRotate(J){this._rotateStart.set(J.clientX,J.clientY)}_handleMouseDownDolly(J){this._updateZoomParameters(J.clientX,J.clientX),this._dollyStart.set(J.clientX,J.clientY)}_handleMouseDownPan(J){this._panStart.set(J.clientX,J.clientY)}_handleMouseMoveRotate(J){this._rotateEnd.set(J.clientX,J.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let Q=this.domElement;this._rotateLeft(iJ*this._rotateDelta.x/Q.clientHeight),this._rotateUp(iJ*this._rotateDelta.y/Q.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(J){if(this._dollyEnd.set(J.clientX,J.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0)this._dollyOut(this._getZoomScale(this._dollyDelta.y));else if(this._dollyDelta.y<0)this._dollyIn(this._getZoomScale(this._dollyDelta.y));this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(J){this._panEnd.set(J.clientX,J.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(J){if(this._updateZoomParameters(J.clientX,J.clientY),J.deltaY<0)this._dollyIn(this._getZoomScale(J.deltaY));else if(J.deltaY>0)this._dollyOut(this._getZoomScale(J.deltaY));this.update()}_handleKeyDown(J){let Q=!1;switch(J.code){case this.keys.UP:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate)this._rotateUp(iJ*this.keyRotateSpeed/this.domElement.clientHeight)}else if(this.enablePan)this._pan(0,this.keyPanSpeed);Q=!0;break;case this.keys.BOTTOM:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate)this._rotateUp(-iJ*this.keyRotateSpeed/this.domElement.clientHeight)}else if(this.enablePan)this._pan(0,-this.keyPanSpeed);Q=!0;break;case this.keys.LEFT:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate)this._rotateLeft(iJ*this.keyRotateSpeed/this.domElement.clientHeight)}else if(this.enablePan)this._pan(this.keyPanSpeed,0);Q=!0;break;case this.keys.RIGHT:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate)this._rotateLeft(-iJ*this.keyRotateSpeed/this.domElement.clientHeight)}else if(this.enablePan)this._pan(-this.keyPanSpeed,0);Q=!0;break}if(Q)J.preventDefault(),this.update()}_handleTouchStartRotate(J){if(this._pointers.length===1)this._rotateStart.set(J.pageX,J.pageY);else{let Q=this._getSecondPointerPosition(J),$=0.5*(J.pageX+Q.x),Z=0.5*(J.pageY+Q.y);this._rotateStart.set($,Z)}}_handleTouchStartPan(J){if(this._pointers.length===1)this._panStart.set(J.pageX,J.pageY);else{let Q=this._getSecondPointerPosition(J),$=0.5*(J.pageX+Q.x),Z=0.5*(J.pageY+Q.y);this._panStart.set($,Z)}}_handleTouchStartDolly(J){let Q=this._getSecondPointerPosition(J),$=J.pageX-Q.x,Z=J.pageY-Q.y,W=Math.sqrt($*$+Z*Z);this._dollyStart.set(0,W)}_handleTouchStartDollyPan(J){if(this.enableZoom)this._handleTouchStartDolly(J);if(this.enablePan)this._handleTouchStartPan(J)}_handleTouchStartDollyRotate(J){if(this.enableZoom)this._handleTouchStartDolly(J);if(this.enableRotate)this._handleTouchStartRotate(J)}_handleTouchMoveRotate(J){if(this._pointers.length==1)this._rotateEnd.set(J.pageX,J.pageY);else{let $=this._getSecondPointerPosition(J),Z=0.5*(J.pageX+$.x),W=0.5*(J.pageY+$.y);this._rotateEnd.set(Z,W)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let Q=this.domElement;this._rotateLeft(iJ*this._rotateDelta.x/Q.clientHeight),this._rotateUp(iJ*this._rotateDelta.y/Q.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(J){if(this._pointers.length===1)this._panEnd.set(J.pageX,J.pageY);else{let Q=this._getSecondPointerPosition(J),$=0.5*(J.pageX+Q.x),Z=0.5*(J.pageY+Q.y);this._panEnd.set($,Z)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(J){let Q=this._getSecondPointerPosition(J),$=J.pageX-Q.x,Z=J.pageY-Q.y,W=Math.sqrt($*$+Z*Z);this._dollyEnd.set(0,W),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let K=(J.pageX+Q.x)*0.5,Y=(J.pageY+Q.y)*0.5;this._updateZoomParameters(K,Y)}_handleTouchMoveDollyPan(J){if(this.enableZoom)this._handleTouchMoveDolly(J);if(this.enablePan)this._handleTouchMovePan(J)}_handleTouchMoveDollyRotate(J){if(this.enableZoom)this._handleTouchMoveDolly(J);if(this.enableRotate)this._handleTouchMoveRotate(J)}_addPointer(J){this._pointers.push(J.pointerId)}_removePointer(J){delete this._pointerPositions[J.pointerId];for(let Q=0;Q<this._pointers.length;Q++)if(this._pointers[Q]==J.pointerId){this._pointers.splice(Q,1);return}}_isTrackingPointer(J){for(let Q=0;Q<this._pointers.length;Q++)if(this._pointers[Q]==J.pointerId)return!0;return!1}_trackPointer(J){let Q=this._pointerPositions[J.pointerId];if(Q===void 0)Q=new B0,this._pointerPositions[J.pointerId]=Q;Q.set(J.pageX,J.pageY)}_getSecondPointerPosition(J){let Q=J.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[Q]}_customWheelEvent(J){let Q=J.deltaMode,$={clientX:J.clientX,clientY:J.clientY,deltaY:J.deltaY};switch(Q){case 1:$.deltaY*=16;break;case 2:$.deltaY*=100;break}if(J.ctrlKey&&!this._controlActive)$.deltaY*=10;return $}}function VN(J){if(this.enabled===!1)return;if(this._pointers.length===0)this.domElement.setPointerCapture(J.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp);if(this._isTrackingPointer(J))return;if(this._addPointer(J),J.pointerType==="touch")this._onTouchStart(J);else this._onMouseDown(J);if(this._cursorStyle==="grab")this.domElement.style.cursor="grabbing"}function LN(J){if(this.enabled===!1)return;if(J.pointerType==="touch")this._onTouchMove(J);else this._onMouseMove(J)}function BN(J){switch(this._removePointer(J),this._pointers.length){case 0:if(this.domElement.releasePointerCapture(J.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(qY),this.state=WJ.NONE,this._cursorStyle==="grab")this.domElement.style.cursor="grab";break;case 1:let Q=this._pointers[0],$=this._pointerPositions[Q];this._onTouchStart({pointerId:Q,pageX:$.x,pageY:$.y});break}}function zN(J){let Q;switch(J.button){case 0:Q=this.mouseButtons.LEFT;break;case 1:Q=this.mouseButtons.MIDDLE;break;case 2:Q=this.mouseButtons.RIGHT;break;default:Q=-1}switch(Q){case r9.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(J),this.state=WJ.DOLLY;break;case r9.ROTATE:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(J),this.state=WJ.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(J),this.state=WJ.ROTATE}break;case r9.PAN:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(J),this.state=WJ.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(J),this.state=WJ.PAN}break;default:this.state=WJ.NONE}if(this.state!==WJ.NONE)this.dispatchEvent(AZ)}function kN(J){switch(this.state){case WJ.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(J);break;case WJ.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(J);break;case WJ.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(J);break}}function IN(J){if(this.enabled===!1||this.enableZoom===!1||this.state!==WJ.NONE)return;J.preventDefault(),this.dispatchEvent(AZ),this._handleMouseWheel(this._customWheelEvent(J)),this.dispatchEvent(qY)}function AN(J){if(this.enabled===!1)return;this._handleKeyDown(J)}function PN(J){switch(this._trackPointer(J),this._pointers.length){case 1:switch(this.touches.ONE){case t9.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(J),this.state=WJ.TOUCH_ROTATE;break;case t9.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(J),this.state=WJ.TOUCH_PAN;break;default:this.state=WJ.NONE}break;case 2:switch(this.touches.TWO){case t9.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(J),this.state=WJ.TOUCH_DOLLY_PAN;break;case t9.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(J),this.state=WJ.TOUCH_DOLLY_ROTATE;break;default:this.state=WJ.NONE}break;default:this.state=WJ.NONE}if(this.state!==WJ.NONE)this.dispatchEvent(AZ)}function CN(J){switch(this._trackPointer(J),this.state){case WJ.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(J),this.update();break;case WJ.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(J),this.update();break;case WJ.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(J),this.update();break;case WJ.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(J),this.update();break;default:this.state=WJ.NONE}}function wN(J){if(this.enabled===!1)return;J.preventDefault()}function TN(J){if(J.key==="Control")this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0})}function SN(J){if(J.key==="Control")this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0})}var $9=1,jN=0.06,oJ=$9+jN,YQ=8*oJ/2,KQ=0.13,CZ={roman:10692152,spartan:12870189,hun:14263320,gaul:4094522,egyptian:2793880,viking:2838401,persian:5978766,teuton:7238520};function K8(J,Q){return[J*oJ-YQ+oJ/2,(7-Q)*oJ-YQ+oJ/2]}class wZ{container;opts;scene=new g6;renderer;camera;controls;texLoader=new n6;texCache=new Map;props=new lJ;hiGroup=new lJ;pulseTiles=[];unitG=new lJ;fxG=new lJ;units=new Map;dmg=[];raycaster=new r6;pickPlane;clickCb;hoverCb;clock=new t6;downXY={x:0,y:0};constructor(J,Q){this.container=J;this.opts=Q;let $=J.clientWidth||640,Z=J.clientHeight||520;this.renderer=new kZ({antialias:!0}),this.renderer.setSize($,Z),this.renderer.setPixelRatio(Math.min(devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=I6,this.renderer.outputColorSpace=w7,J.appendChild(this.renderer.domElement),this.scene.background=new x0(1906707),this.scene.fog=new y7(1906707,16,30),this.camera=new mJ(42,$/Z,0.1,100),this.camera.position.set(0,9.5,9.2),this.controls=new PZ(this.camera,this.renderer.domElement),this.controls.target.set(0,0,-0.3),this.controls.enableDamping=!0,this.controls.dampingFactor=0.08,this.controls.minDistance=7,this.controls.maxDistance=20,this.controls.maxPolarAngle=Math.PI*0.46,this.controls.enablePan=!1,this.controls.update(),this.scene.add(new a6(12167562,0.7)),this.scene.add(new s6(16773584,2760984,0.5));let W=new o6(16773336,1.5);W.position.set(-6,12,6),W.castShadow=!0,W.shadow.mapSize.set(2048,2048);let K=8;Object.assign(W.shadow.camera,{left:-K,right:K,top:K,bottom:-K,near:1,far:40}),this.scene.add(W);let Y=new i0(new A9(120,120),new _J({color:2371642,roughness:0.85,metalness:0.1}));Y.rotation.x=-Math.PI/2,Y.position.y=-1.6,Y.receiveShadow=!0,this.scene.add(Y),this.buildScenery(),this.scene.add(this.props,this.unitG,this.hiGroup,this.fxG),this.pickPlane=new i0(new A9(8*oJ,8*oJ),new I9({visible:!1})),this.pickPlane.rotation.x=-Math.PI/2,this.pickPlane.position.y=0.14,this.scene.add(this.pickPlane);let X=this.renderer.domElement;X.addEventListener("pointerdown",(H)=>{this.downXY={x:H.clientX,y:H.clientY}}),X.addEventListener("pointerup",(H)=>{if(Math.hypot(H.clientX-this.downXY.x,H.clientY-this.downXY.y)<5)this.handleClick(H)}),X.addEventListener("pointermove",(H)=>this.handleHover(H)),X.addEventListener("pointerleave",(H)=>this.hoverCb?.(null,H)),window.addEventListener("resize",()=>this.onResize()),this.animate()}onClick(J){this.clickCb=J}onHover(J){this.hoverCb=J}pointerTile(J){let Q=this.renderer.domElement.getBoundingClientRect(),$=new B0((J.clientX-Q.left)/Q.width*2-1,-((J.clientY-Q.top)/Q.height)*2+1);this.raycaster.setFromCamera($,this.camera);let Z=this.raycaster.intersectObject(this.pickPlane)[0];if(!Z)return null;let W=Math.round((Z.point.x+YQ-oJ/2)/oJ),K=7-Math.round((Z.point.z+YQ-oJ/2)/oJ);return W>=0&&W<8&&K>=0&&K<8?[W,K]:null}handleHover(J){this.hoverCb?.(this.pointerTile(J),J)}onResize(){let J=this.container.clientWidth,Q=this.container.clientHeight;if(!J||!Q)return;this.renderer.setSize(J,Q),this.camera.aspect=J/Q,this.camera.updateProjectionMatrix()}tex(J){let Q=this.texCache.get(J);if(!Q)Q=this.texLoader.load(J),Q.colorSpace=w7,Q.anisotropy=4,this.texCache.set(J,Q);return Q}tribeOf(J){return J===0?this.opts.p0tribe:this.opts.p1tribe}handleClick(J){if(!this.clickCb)return;let Q=this.pointerTile(J);if(Q)this.clickCb(Q)}buildScenery(){let J=8*oJ,$=new i0(new jJ(J+2,0.16,J+2),new _J({color:6257207,roughness:1}));$.position.y=-0.09,$.receiveShadow=!0,this.scene.add($);let Z=new i0(new jJ(J+2-0.3,1.5,J+2-0.3),new _J({color:4863266,roughness:1}));Z.position.y=-0.92,Z.castShadow=!0,Z.receiveShadow=!0,this.scene.add(Z);let W=new i0(new jJ(J+2-0.15,0.25,J+2-0.15),new _J({color:5984328,roughness:1,flatShading:!0}));W.position.y=-0.34,this.scene.add(W);let K=()=>{let Y=J/2,X=(J+2)/2-0.25,H=Math.floor(Math.random()*4),U=(Math.random()*2-1)*X,N=Y+0.1+Math.random()*(X-Y-0.1);return H===0?[U,N]:H===1?[U,-N]:H===2?[N,U]:[-N,U]};for(let Y=0;Y<26;Y++){let X=this.makeTree(),[H,U]=K();X.position.set(H,-0.01,U),X.rotation.y=Math.random()*6.28;let N=0.8+Math.random()*0.6;X.scale.setScalar(N),this.scene.add(X)}for(let Y=0;Y<34;Y++){let X=this.makeRock(),[H,U]=K();X.position.set(H,0,U),this.scene.add(X)}for(let Y=0;Y<40;Y++){let X=this.makeGrass(),[H,U]=K();X.position.set(H,0,U),this.scene.add(X)}}makeTree(){let J=new lJ,Q=new i0(new Z8(0.06,0.09,0.4,6),new _J({color:5914405,roughness:1}));Q.position.y=0.2,Q.castShadow=!0,J.add(Q);let $=new i0(new M8(0.32,0.5,7),new _J({color:4090676,roughness:1,flatShading:!0}));$.position.y=0.58,$.castShadow=!0,J.add($);let Z=new i0(new M8(0.24,0.42,7),new _J({color:4880954,roughness:1,flatShading:!0}));return Z.position.y=0.86,Z.castShadow=!0,J.add(Z),J}makeRock(){let J=new i0(new b7(0.14+Math.random()*0.14,0),new _J({color:7038560,roughness:1,flatShading:!0}));return J.position.y=0.06,J.castShadow=!0,J.receiveShadow=!0,J.rotation.set(Math.random(),Math.random(),Math.random()),J}makeGrass(){let J=new lJ,Q=new _J({color:7312450,roughness:1,side:cJ});for(let $=0;$<4;$++){let Z=new i0(new M8(0.03,0.22,3),Q);Z.position.set((Math.random()-0.5)*0.18,0.11,(Math.random()-0.5)*0.18),Z.rotation.z=(Math.random()-0.5)*0.5,J.add(Z)}return J}standee(J){let Q=this.tribeOf(J.owner),$=e7[`${Q}_${J.arch}`],Z=new lJ,W=0.74,K=0.92,Y=new i0(new jJ(0.74,0.92,0.05),[0,1,2,3,4,5].map((U)=>new _J({color:U===4?16777215:CZ[Q],roughness:0.6,map:U===4&&$?this.tex($):null})));Y.position.y=0.54,Y.castShadow=!0,Z.add(Y);let X=new i0(new jJ(0.82,1,0.04),new _J({color:CZ[Q],roughness:0.5,metalness:0.2}));X.position.set(0,0.54,-0.03),X.castShadow=!0,Z.add(X);let H=new i0(new Z8(0.34,0.4,0.12,16),new _J({color:CZ[Q],roughness:0.4,metalness:0.3}));return H.position.y=0.06,H.castShadow=!0,H.receiveShadow=!0,Z.add(H),{group:Z,card:Y}}wagon(){let J=new lJ,Q=new i0(new jJ(0.55,0.4,0.7),new _J({color:7031333,roughness:0.9}));Q.position.y=0.3,Q.castShadow=!0,J.add(Q);for(let $ of[-0.32,0.32])for(let Z of[-0.3,0.3]){let W=new i0(new Z8(0.16,0.16,0.06,14),new _J({color:2759952,roughness:0.8}));W.rotation.z=Math.PI/2,W.position.set($,0.16,Z),W.castShadow=!0,J.add(W)}return J}buildProps(J){this.props.clear();let Q=new jJ($9,0.25,$9);for(let $=0;$<8;$++)for(let Z=0;Z<8;Z++){let W=Z<J.stakes[$]?0:1,K=new x0(W===0?7306554:5595962),Y=(($*7+Z*13)%6-2.5)*0.012;K.offsetHSL(Y*0.3,0,Y);let X=new i0(Q,new _J({color:K,roughness:0.95})),[H,U]=K8($,Z);if(X.position.set(H,0,U),X.receiveShadow=!0,this.props.add(X),Z===J.stakes[$]-1){let N=new i0(new jJ($9,0.04,0.08),new _J({color:14401642,emissive:3813136,roughness:0.5}));N.position.set(H,0.15,U-oJ/2),this.props.add(N)}}for(let $=0;$<2;$++)for(let Z of J.wagons[$]){if(Z.hp<=0)continue;let W=this.wagon(),[K,Y]=K8(Z.col,Z.row);W.position.set(K,KQ,Y),this.props.add(W)}for(let[$,Z]of J.fields.entries()){let[W,K]=$.split(",").map(Number),Y=new i0(new jJ(0.7,0.06,0.7),new _J({color:Z.type==="crop"?13148730:8219466,roughness:1})),[X,H]=K8(W,K);Y.position.set(X,0.15,H),Y.receiveShadow=!0,this.props.add(Y)}for(let[$]of J.palisades.entries()){let Z=J.stakes[$],W=new i0(new jJ($9,0.5,0.12),new _J({color:5915430,roughness:0.9})),[K,Y]=K8($,Z-1);W.position.set(K,0.32,Y-oJ/2),W.castShadow=!0,this.props.add(W)}}makeBar(){let J=document.createElement("canvas");J.width=192,J.height=56;let Q=J.getContext("2d"),$=new x7(J),Z=new v7(new $7({map:$,transparent:!0,depthWrite:!1,depthTest:!1}));return Z.scale.set(0.8,0.235,1),Z.renderOrder=10,{spr:Z,tex:$,ctx:Q}}syncBar(J,Q){if(!J.bar||!J.barCtx||!J.barTex)return;let $=[Q.tier2?"★★":Q.tier1?"★":"",Q.braced?"⛨":"",Q.exhausted?"∅":""].filter(Boolean).join(" "),Z=`${Q.hp}/${Q.max_hp}|${$}`;if(Z===J.barKey)return;J.barKey=Z;let W=J.barCtx,K=192,Y=56;if(W.clearRect(0,0,K,Y),$)W.font="bold 28px sans-serif",W.textAlign="center",W.textBaseline="top",W.lineWidth=5,W.strokeStyle="rgba(0,0,0,0.9)",W.strokeText($,K/2,-1),W.fillStyle="#ffd24a",W.fillText($,K/2,-1);let X=Math.max(0,Math.min(1,Q.hp/Q.max_hp)),H=8,U=27,N=K-16,G=22,q=7,F=(R,B,E,D,O)=>{W.beginPath(),W.moveTo(R+O,B),W.arcTo(R+E,B,R+E,B+D,O),W.arcTo(R+E,B+D,R,B+D,O),W.arcTo(R,B+D,R,B,O),W.arcTo(R,B,R+E,B,O),W.closePath()};if(W.fillStyle="rgba(8,6,4,0.9)",F(H,U,N,G,q),W.fill(),W.fillStyle=X>0.5?"#5fbf4a":X>0.25?"#d8b53a":"#c8463a",X>0)F(H+3,U+3,Math.max(2,(N-6)*X),G-6,q-3),W.fill();W.fillStyle="#fff",W.font="bold 16px sans-serif",W.textAlign="center",W.textBaseline="middle",W.fillText(`${Q.hp}/${Q.max_hp}`,K/2,U+G/2+1),J.barTex.needsUpdate=!0}update(J){this.buildProps(J);let Q=new Set;for(let $ of J.units.values()){if(!$.pos)continue;Q.add($.uid);let[Z,W]=K8($.pos[0],$.pos[1]),K=this.units.get($.uid);if(!K){let{group:Y,card:X}=this.standee($);Y.position.set(Z,KQ,W),this.unitG.add(Y),K={group:Y,card:X,hp:$.hp,max:$.max_hp,tile:[$.pos[0],$.pos[1]],bob:Math.random()*6.28};let H=this.makeBar();H.spr.position.set(0,1.22,0),Y.add(H.spr),K.bar=H.spr,K.barTex=H.tex,K.barCtx=H.ctx,this.units.set($.uid,K)}else{if(K.tile[0]!==$.pos[0]||K.tile[1]!==$.pos[1])K.tween={fx:K.group.position.x,fz:K.group.position.z,tx:Z,tz:W,t0:this.clock.elapsedTime,dur:0.34},K.tile=[$.pos[0],$.pos[1]];if($.hp<K.hp)this.spawnDamage(Z,W,K.hp-$.hp),this.flash(K);K.hp=$.hp}this.syncBar(K,$)}for(let[$,Z]of[...this.units])if(!Q.has($)&&!Z.dying)Z.dying={t0:this.clock.elapsedTime}}setHighlights(J){this.hiGroup.clear(),this.pulseTiles=[];let Q=(W,K)=>{for(let Y of W??[]){let[X,H]=K8(Y[0],Y[1]),U=new i0(new A9($9*0.9,$9*0.9),new I9({color:K,transparent:!0,opacity:0.5,depthWrite:!1,blending:I7}));U.rotation.x=-Math.PI/2,U.position.set(X,0.15,H),this.hiGroup.add(U),this.pulseTiles.push(U);let N=new i0(new W7($9*0.4,$9*0.49,4),new I9({color:K,transparent:!0,opacity:0.9,depthWrite:!1,side:cJ}));N.rotation.x=-Math.PI/2,N.rotation.z=Math.PI/4,N.position.set(X,0.155,H),this.hiGroup.add(N),this.pulseTiles.push(N)}},$=(W,K,Y)=>{for(let X of W??[]){let H=new i0(new A9($9*0.92,$9*0.92),new I9({color:K,transparent:!0,opacity:Y,depthWrite:!1}));H.rotation.x=-Math.PI/2;let[U,N]=K8(X[0],X[1]);H.position.set(U,0.145,N),this.hiGroup.add(H)}},Z=(W,K,Y=0.42,X=0.5)=>{for(let H of W??[]){let U=new i0(new W7($9*Y,$9*X,28),new I9({color:K,transparent:!0,opacity:0.95,depthWrite:!1,side:cJ}));U.rotation.x=-Math.PI/2;let[N,G]=K8(H[0],H[1]);U.position.set(N,0.16,G),this.hiGroup.add(U)}};if(Q(J.valid,15910473),$(J.move,7315274,0.5),$(J.stage,13214247,0.55),Z(J.melee,12603466),Z(J.shoot,14257978),Z(J.charge,10120384),J.selected)Z([J.selected],14401642,0.5,0.6)}spawnDamage(J,Q,$){let Z=document.createElement("canvas");Z.width=128,Z.height=64;let W=Z.getContext("2d");W.font="bold 48px Cinzel, serif",W.textAlign="center",W.textBaseline="middle",W.fillStyle="#1a1408",W.fillText(`-${$}`,65,34),W.fillStyle="#ff5a4a",W.fillText(`-${$}`,64,32);let K=new x7(Z),Y=new v7(new $7({map:K,transparent:!0,depthTest:!1}));Y.scale.set(0.8,0.4,1),Y.position.set(J,1.2,Q),this.fxG.add(Y),this.dmg.push({spr:Y,t0:this.clock.elapsedTime})}flash(J){for(let Q of J.card.material)Q.emissive=new x0(16724000),Q.__flash=1}animate=()=>{requestAnimationFrame(this.animate);let J=this.clock.getDelta(),Q=this.clock.elapsedTime;this.controls.update();for(let[$,Z]of[...this.units]){if(Z.dying){let K=(Q-Z.dying.t0)/0.5;if(Z.group.position.y=KQ-K*0.6,Z.group.scale.setScalar(Math.max(0.01,1-K)),Z.group.traverse((Y)=>{let X=Y.material;if(X)X.transparent=!0,X.opacity=Math.max(0,1-K)}),K>=1)this.unitG.remove(Z.group),this.units.delete($);continue}let W=KQ;if(Z.tween){let K=Math.min(1,(Q-Z.tween.t0)/Z.tween.dur),Y=K<0.5?2*K*K:1-(-2*K+2)**2/2;if(Z.group.position.x=Z.tween.fx+(Z.tween.tx-Z.tween.fx)*Y,Z.group.position.z=Z.tween.fz+(Z.tween.tz-Z.tween.fz)*Y,W+=Math.sin(K*Math.PI)*0.28,K>=1)Z.tween=void 0}Z.group.position.y=W+Math.sin(Q*2+Z.bob)*0.02;for(let K of Z.card.material)if(K.__flash>0)K.__flash=Math.max(0,K.__flash-J*3),K.emissive.setScalar(K.__flash*0.6),K.emissive.r=K.__flash,K.emissive.g=K.__flash*0.2,K.emissive.b=K.__flash*0.12}if(this.pulseTiles.length){let $=0.5+0.5*Math.sin(Q*3.2);for(let Z of this.pulseTiles)Z.material.opacity=0.3+$*0.45,Z.scale.setScalar(0.95+$*0.08)}for(let $ of[...this.dmg]){let Z=(Q-$.t0)/1;if($.spr.position.y=1.2+Z*0.8,$.spr.material.opacity=1-Z,Z>=1)this.fxG.remove($.spr),this.dmg.splice(this.dmg.indexOf($),1)}this.renderer.render(this.scene,this.camera)}}var TJ=(J)=>`${J[0]},${J[1]}`,w9=(J)=>J[0].toUpperCase()+J.slice(1);class SZ extends Error{}var TZ=(J,Q)=>({2:Q.UNLOCK_3RD,3:Q.UNLOCK_4TH,4:Q.UNLOCK_5TH})[J];class s7{root;g;policies;cfg;banner="";log=[];mBuild=[];mPlan;mMode={kind:null};cOrders=new Map;cSel=null;onChange=null;board3d;shell;get use3d(){return this.cfg.view!=="2d"}constructor(J){this.root=J}get phaseKind(){if(this.banner.includes("Muster"))return"muster";if(this.banner.includes("Clash"))return"clash";if(this.banner.includes("Intervention"))return"iv";return"other"}get round(){return this.g.round}get bannerText(){return this.banner}get musterModeKind(){return this.mMode.kind}get stagedRecruitCount(){return this.mPlan?.recruits.length??0}get stagedBuildCount(){return this.mBuild?.length??0}get selectedUid(){return this.cSel}get orderCount(){return this.cOrders.size}isHuman(J){if(this.cfg.demo)return!1;return this.cfg.mode==="hotseat"||J===this.cfg.humanSeat}demoSpeed=1;demoPaused=!1;demoSeek=null;async demoStep(J=1){if(!this.cfg.demo)return;this.render();let Q=0,$=820*J/this.demoSpeed;do{if(this.demoSeek!==null)throw new SZ;await this.pause(90),Q+=90}while(this.demoPaused||Q<$)}demoGoTo(J){let Q=[0,1].map((Z)=>FQ(this.cfg.botName));Q.forEach((Z,W)=>Z.reset(this.cfg.seed,W));let $=new G9(Q,this.cfg.seed,GQ);$.setup();try{while($.round<J)$.playRound()}catch(Z){if(!(Z instanceof vJ))throw Z}this.policies=Q,this.g=$,this.log=[`Round ${$.round} — ${w9(this.tribe(0))} vs ${w9(this.tribe(1))}.`]}async demoLoop(){for(;;)try{await this.playRoundInteractive()}catch(J){if(J instanceof vJ){this.winScreen(J.winner,J.wtype);return}if(J instanceof SZ){let Q=this.demoSeek??1;this.demoSeek=null,this.demoGoTo(Math.max(1,Q)),this.demoPaused=!0,this.render();continue}throw J}}onDemo(J){if(J==="exit"){location.reload();return}if(J==="restart"){this.demoSeek=1;return}if(J==="back"){this.demoSeek=Math.max(1,this.g.round-1);return}if(J==="pause"){this.demoPaused=!this.demoPaused,this.render();return}let Q=Number(J);if(Q)this.demoSpeed=Q,this.render()}demoPanel(){let J=(Q)=>`<button class="pbtn${this.demoSpeed===Q?" on":""}" data-act="demo:${Q}">${Q}×</button>`;return`<div class="prow"><span class="plabel">\uD83E\uDD16 Watch AI</span>
      ...
      ${this.log.length?`<div class="prow staged">${this.log.slice(-1)[0]}</div>`:""}`}tribe(J){return J===0?this.cfg.p0tribe:this.cfg.p1tribe}human(J){return this.policies[J]}start(J){this.init(J),this.g.setup(),this.begin()}startScenario(J,Q){this.init(J),this.g.setup(),Q(this.g),this.begin()}init(J){this.cfg=J,this.policies=[0,1].map((Q)=>this.isHuman(Q)?new DQ(J.mode==="hotseat"?`Player ${Q+1}`:"You"):FQ(J.botName)),this.policies.forEach((Q,$)=>Q.reset(J.seed,$)),this.g=new G9(this.policies,J.seed,GQ)}begin(){this.log=[`Round 1 — ${w9(this.tribe(0))} vs ${w9(this.tribe(1))}.`],this.mountTooltip(),this.loop()}get stagedFieldCount(){return this.mBuild?.filter((J)=>J[0]==="field").length??0}get hasAttackOrder(){for(let J of this.cOrders.values())if(J[0]==="MELEE"||J[0]==="CHARGE"||J[0]==="SHOOT")return!0;return!1}tip;mountTooltip(){if(this.tip)return;if(this.tip=document.createElement("div"),this.tip.className="utip",this.tip.style.display="none",document.body.appendChild(this.tip),this.use3d)return;this.root.addEventListener("mousemove",(J)=>{let Q=J.target.closest?.(".cell[data-uid]");if(!Q){this.tip.style.display="none";return}let $=this.g.units.get(Number(Q.dataset.uid));if(!$){this.tip.style.display="none";return}this.tip.innerHTML=this.unitTooltip($),this.tip.style.display="block",this.tip.style.left=Math.min(J.clientX+14,window.innerWidth-210)+"px",this.tip.style.top=J.clientY+14+"px"}),this.root.addEventListener("mouseleave",()=>{if(this.tip)this.tip.style.display="none"})}unitTooltip(J){let Q=this.g.C,$={spear:"Cavalry",cav:"Archers",archer:"Spearmen"}[J.arch],Z=J.rmin===J.rmax?`${J.rmax}`:`${J.rmin}–${J.rmax}`,W=J.tier2?' <span class="utr">★★</span>':J.tier1?' <span class="utr">★</span>':"",K=[J.exhausted?"∅ exhausted — fights weaker":"",J.braced?"⛨ braced — stops a charge":""].filter(Boolean).join(" · "),Y=J.tier2?"★★ max rank":`XP ${J.xp}/${J.tier1?Q.XP_TIER2:Q.XP_TIER1} → ${J.tier1?"★★":"★"} (wound enemies to rank up)`;return`<b>${rJ[J.arch]}</b>${W}
      <div class="utstats">
      ...
      ${K?`<span class="uts">${K}</span>`:""}`}async loop(){if(this.cfg.demo)return this.demoLoop();try{for(;;)await this.playRoundInteractive()}catch(J){if(J instanceof vJ)this.winScreen(J.winner,J.wtype);else throw J}}async playRoundInteractive(){let J=this.g,Q=J.C;if(J.cap_dmg=[0,0],J.wagon_dmg_round=[0,0],J.rows_lost_round=[0,0],J.rows_taken_round=[0,0],J.unit_dmg_round=[0,0],this.cfg.demo)this.banner="\uD83E\uDD16 Demo — Muster",await this.demoStep(0.8);for(let X of[J.komi,1-J.komi]){if(this.isHuman(X))await this.humanMuster(X);J.musterPlayer(X)}if(this.cfg.demo)await this.demoStep(1.1);for(let X of J.units.values())X.face_down=!1;J.wards=[];try{if(this.cfg.demo)this.banner="\uD83E\uDD16 Demo — Clash, pulse 1";if(await this.doWindow(1),await this.doPulse(1),this.cfg.demo)this.banner="\uD83E\uDD16 Demo — Clash, pulse 2";await this.doWindow(2),await this.doPulse(2),await this.doWindow(3)}catch(X){if(!(X instanceof X7))throw X}J.wards=[],J.frontier();let[$,Z]=J.rows_lost_round;if($!==Z)J.komi=$>Z?0:1;let W=this.cfg.mode==="bot"?this.cfg.humanSeat:0,K=1-W,Y=[];if(J.rows_taken_round[W])Y.push(`you pushed ${J.rows_taken_round[W]} row(s) forward`);if(J.rows_lost_round[W])Y.push(`you lost ${J.rows_lost_round[W]} row(s)`);if(J.wagon_dmg_round[W])Y.push("\uD83D\uDCA5 you breached an enemy wagon!");if(J.wagon_dmg_round[K])Y.push("⚠ the enemy breached your wagon!");if(this.log.push(`Round ${J.round} frontier: ${Y.length?Y.join(", "):"the lines held — no ground changed."}`),this.cfg.demo)this.banner="\uD83E\uDD16 Demo — Frontier",await this.demoStep(1.2);if(J.round>=Q.GOLDEN_GOAL_ROUND){let X=J.rows_taken_round[0]>0||J.wagon_dmg_round[0]>0,H=J.rows_taken_round[1]>0||J.wagon_dmg_round[1]>0;if(X||H){let U;if(X&&H)if(J.rows_taken_round[0]!==J.rows_taken_round[1])U=J.rows_taken_round[0]>J.rows_taken_round[1]?0:1;else if(J.wagon_dmg_round[0]!==J.wagon_dmg_round[1])U=J.wagon_dmg_round[0]>J.wagon_dmg_round[1]?0:1;else U=J.komi;else U=X?0:1;throw new vJ(U,"golden-goal")}}for(let X=0;X<2;X++)J.res[X].tribute+=Q.TRIBUTE_PER_ROW*J.rows_lost_round[X];if(J.round===Q.CARAVAN_ROUND_1||J.round===Q.CARAVAN_ROUND_2){let X=[0,1].map((H)=>({...J.res[H]}));if(J.caravan(J.round===Q.CARAVAN_ROUND_1?1:2),this.cfg.demo){let H=(U)=>{let N=J.res[U],G=X[U],q=[];if(N.supply>G.supply)q.push(`+${N.supply-G.supply}\uD83D\uDEE1`);if(N.crop>G.crop)q.push(`+${N.crop-G.crop}\uD83C\uDF3E`);if(N.tribute>G.tribute)q.push(`+${N.tribute-G.tribute}◆`);return q.length?q.join(" "):"a battlefield boost"};this.log.push(`◆ Caravan! ${w9(this.tribe(0))} drafted ${H(0)} · ${w9(this.tribe(1))} drafted ${H(1)}.`),this.banner="\uD83E\uDD16 Demo — ◆ Caravan",await this.demoStep(2.2)}}if(J.round===1){let[X,H]=J.rows_taken_round;if(X!==H)J.r1_winner=X>H?0:1;else if(J.unit_dmg_round[0]!==J.unit_dmg_round[1]&&(!Q.R1_REQUIRE_ENGAGE||Math.min(...J.unit_dmg_round)>=1))J.r1_winner=J.unit_dmg_round[0]>J.unit_dmg_round[1]?0:1}if(J.lead_trace.push(J.leadHolder()),J.round>=Q.HARD_STOP_ROUND){let X=J.wagonsAlive(0),H=J.wagonsAlive(1);if(X!==H)throw new vJ(X>H?0:1,"ladder");let U=J.ownedRows(0),N=J.ownedRows(1);if(U!==N)throw new vJ(U>N?0:1,"ladder");throw new vJ(J.komi,"ladder")}J.updateEntrench(),J.round++,this.policies.forEach((X)=>X.clearPhase?.())}async doWindow(J){for(let Q of[this.g.komi,1-this.g.komi])if(this.isHuman(Q))await this.humanIntervention(Q,J);this.g.interventionWindow(J),this.policies.forEach((Q)=>{let $=Q;if($.pendingIntervention)$.pendingIntervention={}})}async doPulse(J){for(let $ of[0,1])if(this.isHuman($))await this.humanClash($,J);this.g.runPulse(J);let Q=[...this.g.units.values()].filter(($)=>$.pos===null&&$.wounded_round===this.g.round);if(Q.length)this.log.push(`Pulse ${J}: ${Q.length} unit(s) fell.`);if(this.cfg.demo){await this.demoStep(0.8);return}this.render(),await this.pause(550)}pause(J){return new Promise((Q)=>setTimeout(Q,J))}humanMuster(J){return this.banner=`${this.seatName(J)} — Muster`,this.mBuild=[],this.mPlan={unlocks:[],recruits:[],repositions:[],rush:[],tribute_spend:0},this.mMode={kind:null},new Promise((Q)=>{let $=()=>{this.human(J).pendingBuild=this.mBuild,this.human(J).pendingReinforce=this.mPlan,Q()};this.musterDone=$,this.musterPlayer=J,this.render()})}musterDone=null;musterPlayer=0;musterBudget(J){let Q=this.g,$=Q.C,[Z,W]=Q.computeHarvest(J),K=0;for(let H of Q.onBoard(J))K+=$.UPKEEP_CROP+(Q.beyondOwn(H)?$.SUPPLY_STRAIN_CROP:0);let Y=Q.res[J].supply+Z-this.spentSupply(J),X=Q.res[J].crop+W-K;return{supply:Y,crop:X}}spentSupply(J){let Q=this.g,$=Q.C,Z=0;for(let K of this.mBuild)Z+=K[0]==="field"?$.FIELD_COST:$.PALISADE_COST;for(let K of this.mPlan.unlocks){let Y=Q.unlocked[J].size+this.mPlan.unlocks.indexOf(K);Z+=TZ(Y,$)??0}let W=0;for(let[K]of this.mPlan.recruits)Z+=Q.costs[K]+$.COPY_SURCHARGE*(Q.copies[K]+W++);return Z-this.mPlan.tribute_spend}onCell(J,Q){let $=this.g,Z=this.banner.includes("Muster")?this.musterPlayer:-1;if(Z>=0)return this.musterCell(Z,J,Q);return this.clashCell(J,Q)}musterCell(J,Q,$){let Z=this.g,W=Z.C,K=this.mMode;if(K.kind==="palisade"){this.musterPalisade(Q[0]);return}if(K.kind==="recruit"&&K.arch){if(Z.heartlandRows(J).includes(Q[1])&&!Z.occupied(Q)&&!this.staged(Q)&&this.mPlan.recruits.length<W.DEPLOY_MAX+Z.extra_deploy[J])this.mPlan.recruits.push([K.arch,Q])}else if(K.kind==="field"&&K.ftype){if(Z.territoryOf(Q)===J&&!Z.fields.has(TJ(Q))&&!Z.wagon_at.has(TJ(Q))&&!this.staged(Q)&&this.mBuild.filter((Y)=>Y[0]==="field"||Y[0]==="palisade").length<W.BUILD_ACTIONS)this.mBuild.push(["field",Q,K.ftype])}else if(K.kind==="reposition"){if(K.uid===void 0){if($!==void 0&&Z.units.get($).owner===J&&Z.units.get($).pos)K.uid=$}else if(Z.territoryOf(Q)===J&&!Z.occupied(Q)&&!this.staged(Q)&&this.mPlan.repositions.length<W.REPOSITION_MAX)this.mPlan.repositions.push([K.uid,Q]),K.uid=void 0}this.render()}staged(J){return this.mBuild.some((Q)=>Q[0]==="field"&&TJ(Q[1])===TJ(J))||this.mPlan.recruits.some((Q)=>TJ(Q[1])===TJ(J))||this.mPlan.repositions.some((Q)=>TJ(Q[1])===TJ(J))}humanClash(J,Q){return this.banner=`${this.seatName(J)} — Clash, pulse ${Q}`,this.cOrders=new Map,this.cSel=null,this.clashPlayer=J,new Promise(($)=>{this.clashDone=()=>{let Z={};for(let[W,K]of this.cOrders)Z[W]=K;this.human(J).pendingOrders[Q]=Z,$()},this.render()})}clashDone=null;clashPlayer=0;clashCell(J,Q){let $=this.g,Z=this.clashPlayer;if(this.cSel===null){if(Q!==void 0&&$.units.get(Q).owner===Z)this.cSel=Q}else{let W=$.units.get(this.cSel),K=U7($,W);if(Q!==void 0&&$.units.get(Q).owner!==Z){let Y=K.chargeTargets.find((U)=>U.uid===Q),X=K.shootTargets.includes(Q),H=K.meleeTargets.find((U)=>U.uid===Q);if(X)this.cOrders.set(W.uid,["SHOOT",["U",Q]]);else if(Y)this.cOrders.set(W.uid,["CHARGE",Q,Y.path]);else if(H)this.cOrders.set(W.uid,["MELEE",Q,H.path]);this.cSel=null}else if(Q===this.cSel)this.cSel=null;else if(K.moves.has(TJ(J)))this.cOrders.set(W.uid,["MOVE",K.moves.get(TJ(J))]),this.cSel=null;else if(Q!==void 0&&$.units.get(Q).owner===Z)this.cSel=Q}this.render()}humanIntervention(J,Q){let $=this.g,Z=$.C,W=$.res[J].tribute,K=Q===3&&W>=Z.SURGE_COST,Y=Q<=2&&W>=Z.SHIELDBEARER_COST;if(!K&&!Y)return Promise.resolve();return this.banner=`${this.seatName(J)} — Intervention window ${Q}`,new Promise((X)=>{this.ivResolve=X,this.ivPlayer=J,this.ivWno=Q,this.ivSel=null,this.render()})}ivResolve=null;ivPlayer=0;ivWno=0;ivSel=null;render(){if(this.use3d)return this.render3d();let J=this.g;this.root.innerHTML=`
      <div class="topbar"><div class="phase-banner">${this.banner}</div>${RQ()}</div>
      <div class="phasebar">${this.phaseStepper()}</div>
      <div class="phase-hint">${this.phaseHint()}</div>
      ${EQ(J,{p0tribe:this.cfg.p0tribe,p1tribe:this.cfg.p1tribe})}
      <div class="panel">${this.panelHTML()}</div>
      <div class="gamelog">${this.log.slice(-4).map((Q)=>`<div>${Q}</div>`).join("")}</div>`,this.wireCells(),this.wirePanel(),OQ(this.root),this.paintOverlays(),this.onChange?.()}mountShell(){this.root.innerHTML=`
      <div class="topbar"><div class="phase-banner"></div>${RQ()}</div>
      <div class="phasebar"></div>
      <div class="reshud"></div>
      <div class="phase-hint"></div>
      <div id="board3d" class="board3d-wrap"></div>
      <div class="panel"></div>
      <div class="gamelog"></div>`,this.shell={banner:this.root.querySelector(".phase-banner"),phasebar:this.root.querySelector(".phasebar"),hud:this.root.querySelector(".reshud"),hint:this.root.querySelector(".phase-hint"),panel:this.root.querySelector(".panel"),log:this.root.querySelector(".gamelog")},this.board3d=new wZ(this.root.querySelector("#board3d"),{p0tribe:this.cfg.p0tribe,p1tribe:this.cfg.p1tribe}),this.board3d.onClick((J)=>this.onBoardClick(J)),this.board3d.onHover((J,Q)=>{let $=J?this.g.board.get(TJ(J)):void 0,Z=$!==void 0?this.g.units.get($):void 0;if(!Z||!this.tip){if(this.tip)this.tip.style.display="none";return}this.tip.innerHTML=this.unitTooltip(Z),this.tip.style.display="block",this.tip.style.left=Math.min(Q.clientX+14,window.innerWidth-210)+"px",this.tip.style.top=Q.clientY+14+"px"}),OQ(this.root)}render3d(){if(!this.board3d)this.mountShell();let J=this.shell;J.banner.innerHTML=this.banner,J.phasebar.innerHTML=this.phaseStepper(),J.hud.innerHTML=this.resourceHUD(),J.hint.innerHTML=this.phaseHint(),J.panel.innerHTML=this.panelHTML(),J.log.innerHTML=this.log.slice(-4).map((Q)=>`<div>${Q}</div>`).join(""),this.wirePanel(),this.board3d.update(this.g),this.board3d.setHighlights(this.computeHighlights()),this.onChange?.()}onBoardClick(J){if(this.cfg.demo)return;let Q=this.g.board.get(TJ(J));if(this.banner.includes("Intervention"))this.ivCell(J,Q);else this.onCell(J,Q)}computeHighlights(){let J=this.g,Q={};if(this.cfg.demo)return Q;if(this.banner.includes("Clash")&&this.cSel!==null){let $=J.units.get(this.cSel);Q.selected=$.pos;let Z=U7(J,$);Q.move=[...Z.moves.keys()].map((W)=>W.split(",").map(Number)),Q.melee=Z.meleeTargets.map((W)=>J.units.get(W.uid).pos),Q.shoot=Z.shootTargets.map((W)=>J.units.get(W).pos),Q.charge=Z.chargeTargets.map((W)=>J.units.get(W.uid).pos)}if(this.banner.includes("Muster")){let $=this.musterPlayer;Q.stage=[...this.mPlan.recruits.map((K)=>K[1]),...this.mBuild.filter((K)=>K[0]==="field").map((K)=>K[1]),...this.mPlan.repositions.map((K)=>K[1])];let Z=this.mMode,W=[];if(Z.kind==="recruit")for(let K=0;K<8;K++)for(let Y of J.heartlandRows($)){let X=[K,Y];if(!J.occupied(X)&&!this.staged(X))W.push(X)}if(Z.kind==="field")for(let K=0;K<8;K++)for(let Y=0;Y<8;Y++){let X=[K,Y];if(J.territoryOf(X)===$&&!J.fields.has(TJ(X))&&!J.wagon_at.has(TJ(X))&&!this.staged(X))W.push(X)}Q.valid=W}return Q}seatName(J){return this.cfg.mode==="hotseat"?`Player ${J+1} (${w9(this.tribe(J))})`:`You (${w9(this.tribe(J))})`}phaseStepper(){return`<div class="rtrack">${this.roundTrack()}</div><div class="psteps">${this.phaseChips()}</div>`}roundTrack(){let J=this.g.C,Q=this.round,$=J.HARD_STOP_ROUND,Z=[J.CARAVAN_ROUND_1,J.CARAVAN_ROUND_2],W="";for(let X=1;X<=$;X++){let H=Z.includes(X),U=X===J.GOLDEN_GOAL_ROUND,N=X===$,G=X===Q?"cur":X<Q?"past":"future",q=H?"◆":N?"\uD83C\uDFC1":U?"⚡":String(X),F=H?`Round ${X}: Caravan — draft an Artifact (free boost)`:N?`Round ${X}: final round — the leader wins`:U?`Round ${X}+: golden goal — one uncontested push can win outright`:`Round ${X}`;W+=`<span class="rdot ${G}${H?" cara":""}${U?" gold":""}${N?" stop":""}" title="${F}">${q}</span>`}let K=Z.find((X)=>X>=Q),Y=K?K===Q?'<span class="rnote">◆ Caravan now — draft an Artifact!</span>':`<span class="rnote">◆ next Artifact in ${K-Q} round${K-Q>1?"s":""}</span>`:"";return`<span class="rlbl">Round ${Q}/${$}</span>${W}${Y}`}phaseChips(){let J=this.banner,Q=0,$=0;if(J.includes("Muster"))Q=0;else if(J.includes("Clash")||J.includes("Intervention")){Q=2;let W=J.match(/pulse (\d)/);$=W?+W[1]:0}else if(J.includes("Frontier"))Q=3;else if(J.includes("Caravan")||J.includes("Tribute"))Q=4;return[{k:"Muster",i:"\uD83C\uDFF0",auto:!1},{k:"Reveal",i:"\uD83D\uDC41",auto:!0},{k:"Clash",i:"⚔",auto:!1},{k:"Frontier",i:"\uD83D\uDEA9",auto:!0},{k:"Tribute",i:"◆",auto:!0}].map((W,K)=>{let Y=K===Q?"active":K<Q?"done":"soon",X=K===2&&$?` <i>${$}/2</i>`:"";return`<span class="pchip ${Y}${W.auto?" auto":""}"><b>${W.i}</b> ${W.k}${X}</span>`}).join('<span class="parr">›</span>')}phaseHint(){if(this.banner.includes("Muster"))return"Spend \uD83D\uDEE1 <b>Supply</b> to recruit units (deploy in your back rows), unlock new types, or build fields & palisades. \uD83C\uDF3E <b>Crop</b> feeds your army each round — keep it above your unit count or they get exhausted and fight worse.";if(this.banner.includes("Clash"))return"Click a unit, then a \uD83D\uDFE2 tile to <b>move</b> or a \uD83D\uDD34 enemy to <b>attack</b>. Get units past the enemy's gold stake line and hold there to push it back next phase. Two pulses per round.";if(this.banner.includes("Intervention"))return"Optional: spend ◆ <b>Tribute</b> on a <b>Surge</b> (move one of <i>your</i> units one tile to an empty square) or <b>Shieldbearer</b> (shield your Hero from a killing blow) — or just Skip.";return""}resourceHUD(){let J=this.g,Q=this.cfg.mode==="bot"&&!this.cfg.demo?this.cfg.humanSeat:-1,$=(Z)=>{let W=J.res[Z],K=[...J.units.values()].filter((H)=>H.owner===Z&&H.pos).length,Y=W.crop<K,X=Z===Q?"You":w9(this.tribe(Z));return`<div class="hud-side${Z===Q?" me":""}" style="--c:${w8[this.tribe(Z)]||"#c9a227"}">
      ...
      <div class="prow"><span class="plabel">Recruit:</span>
        ${Y.map((F)=>q(W.kind==="recruit"&&W.arch===F,`rec:${F}`,`${rJ[F]} <i>${J.costs[F]+Q.COPY_SURCHARGE*J.copies[F]}\uD83D\uDEE1</i>`)).join("")}</div>
      ${X.length?`<div class="prow"><span class="plabel">Unlock:</span>
        ${X.map((F)=>q(this.mPlan.unlocks.includes(F),`unl:${F}`,`${rJ[F]} <i>${TZ(J.unlocked[$].size+this.mPlan.unlocks.indexOf(F)+(this.mPlan.unlocks.includes(F)?0:this.mPlan.unlocks.length-this.mPlan.unlocks.indexOf(F)),Q)??TZ(J.unlocked[$].size,Q)}\uD83D\uDEE1</i>`)).join("")}</div>`:""}
      ...
      <div class="prow"><button class="pbtn undo" data-act="undo">Undo last</button>
        <button class="pbtn confirm" data-act="muster-done">End Muster ▶</button></div>`}stagedSummary(){let J=[];for(let[Q]of this.mPlan.recruits)J.push(rJ[Q]);for(let Q of this.mPlan.unlocks)J.push(`unlock ${rJ[Q]}`);for(let Q of this.mBuild)J.push(Q[0]==="field"?`${Q[2]} field`:"palisade");for(let Q of this.mPlan.repositions)J.push("reposition");if(this.mPlan.tribute_spend)J.push(`+${this.mPlan.tribute_spend} supply`);return J.length?J.join(", "):"<i>nothing yet — pick an action, then click the board</i>"}clashPanel(){let J=this.g,Q=this.clashPlayer,$=J.onBoard(Q),Z=[...this.cOrders.keys()],W="<i>Click one of your units to give it an order.</i>";if(this.cSel!==null){let K=J.units.get(this.cSel),Y=U7(J,K),X=[];if(Y.moves.size)X.push("\uD83D\uDFE2 move (green)");if(Y.meleeTargets.length)X.push("\uD83D\uDD34 attack (red)");if(Y.shootTargets.length)X.push("\uD83D\uDFE0 shoot (orange)");if(Y.chargeTargets.length)X.push("\uD83D\uDFE3 charge (purple)");W=`<b>${rJ[K.arch]}</b> selected — ${X.join(" · ")||"no targets in range"} ·
      ...
      <div class="prow staged">Orders: <b>${Z.length}/${$.length}</b> units ·
        ${Z.map((K)=>`${rJ[J.units.get(K).arch]}:${this.cOrders.get(K)[0]}`).join(", ")||"<i>none</i>"}</div>
    ...
    <div class="setup">
      ...
      <div class="srow"><span class="slabel">Opponent</span>
        <div class="seg">
          <button class="segbtn${r0.mode==="bot"?" on":""}" data-mode="bot">vs Bot</button>
          <button class="segbtn${r0.mode==="hotseat"?" on":""}" data-mode="hotseat">Hotseat (2P)</button>
        </div></div>

      <div id="botrow" class="srow"${r0.mode==="bot"?"":" hidden"}>
        <span class="slabel">Bot</span>
        <select id="bot">${fN.map((J)=>`<option value="${J}"${J===r0.botName?" selected":""}>${J} — ${vN[J]}</option>`).join("")}</select>
      </div>

      <div id="seatrow" class="srow"${r0.mode==="bot"?"":" hidden"}>
        <span class="slabel">Your seat</span>
        <div class="seg">
          <button class="segbtn${r0.humanSeat===0?" on":""}" data-seat="0">P1 · bottom</button>
          <button class="segbtn${r0.humanSeat===1?" on":""}" data-seat="1">P2 · top</button>
        </div></div>

      <div class="srow"><span class="slabel">P1 tribe</span>
        <select id="p0t">${FY(r0.p0tribe)}</select></div>
      <div class="srow"><span class="slabel">P2 tribe</span>
        <select id="p1t">${FY(r0.p1tribe)}</select></div>

      <div class="srow"><span class="slabel">Seed</span>
        <input id="seed" type="number" value="${r0.seed}">
    ...
    </div>`,dJ.querySelectorAll("[data-mode]").forEach((J)=>J.onclick=()=>{r0.mode=J.dataset.mode,XQ()}),dJ.querySelectorAll("[data-seat]").forEach((J)=>J.onclick=()=>{r0.humanSeat=Number(J.dataset.seat),XQ()}),dJ.querySelector("#bot").onchange=(J)=>r0.botName=J.target.value,dJ.querySelector("#p0t").onchange=(J)=>r0.p0tribe=J.target.value,dJ.querySelector("#p1t").onchange=(J)=>r0.p1tribe=J.target.value,dJ.querySelector("#seed").onchange=(J)=>r0.seed=Number(J.target.value)|0,dJ.querySelector("#rnd").onclick=()=>{r0.seed=Math.floor(Math.random()*1e6),XQ()},dJ.querySelector("#start").onclick=()=>{if(r0.p0tribe===r0.p1tribe)r0.p1tribe=G7.find((J)=>J!==r0.p0tribe);new s7(dJ).start({...r0})},dJ.querySelector("#demo").onclick=()=>{let J=r0.p1tribe===r0.p0tribe?G7.find((Q)=>Q!==r0.p0tribe):r0.p1tribe;new s7(dJ).start({...r0,p1tribe:J,demo:!0})},dJ.querySelector("#guide").onclick=N7,dJ.querySelector("#tut").onclick=()=>{new jZ(new s7(dJ)).start({mode:"bot",humanSeat:0,botName:"TURTLE",p0tribe:r0.p0tribe,p1tribe:r0.p1tribe===r0.p0tribe?G7.find((J)=>J!==r0.p0tribe):r0.p1tribe,seed:4242})}}XQ();})();
