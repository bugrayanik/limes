...
const STEPS: Step[] = [
  ...
  { text: `When you <b>lose</b> a row you gain ◆ <b>Tribute</b> — spend it during Clash on a <b>Surge</b> (slip one of your own units one tile to an empty square) or <b>Shieldbearer</b> (save your Hero from a death blow), or bank it and convert to Supply. Losing ground isn't all bad.`, manual: true },
